...
class PropertyCache {
    constructor() {
        _PropertyCache_cache.set(this, new Map());
        const clear = () => __classPrivateFieldGet(this, _PropertyCache_cache, "f").clear();
    ...
    get(expression) {
        return __classPrivateFieldGet(this, _PropertyCache_cache, "f").get(expression);
    }
    set(expression, value) {
        __classPrivateFieldGet(this, _PropertyCache_cache, "f").set(expression, value);
        window.setTimeout(() => {
            if (__classPrivateFieldGet(this, _PropertyCache_cache, "f").get(expression) === value) {
                __classPrivateFieldGet(this, _PropertyCache_cache, "f").delete(expression);
            }
        }, maxCacheAge);
    }
    static instance() {
...
_PropertyCache_cache = new WeakMap();
