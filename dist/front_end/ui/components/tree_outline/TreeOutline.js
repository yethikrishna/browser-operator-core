...
ItemSelectedEvent.eventName = 'itemselected';
...
ItemMouseOverEvent.eventName = 'itemmouseover';
...
ItemMouseOutEvent.eventName = 'itemmouseout';
/**
 *
...
export class TreeOutline extends HTMLElement {
    ...
    async expandToAndSelectTreeNodeId(targetTreeNodeId) {
        const pathToTreeNode = await getPathToTreeNode(__classPrivateFieldGet(this, _TreeOutline_treeData, "f"), targetTreeNodeId);
...
_TreeOutline_shadow = new WeakMap(), _TreeOutline_treeData = new WeakMap(), _TreeOutline_nodeExpandedMap = new WeakMap(), _TreeOutline_domNodeToTreeNodeMap = new WeakMap(), _TreeOutline_hasRenderedAtLeastOnce = new WeakMap(), _TreeOutline_nodeIdPendingFocus = new WeakMap(), _TreeOutline_selectedTreeNode = new WeakMap(), _TreeOutline_defaultRenderer = new WeakMap(), _TreeOutline_nodeFilter = new WeakMap(), _TreeOutline_compact = new WeakMap(), _TreeOutline_scheduledRender = new WeakMap(), _TreeOutline_enqueuedRender = new WeakMap(), _TreeOutline_instances = new WeakSet(), _TreeOutline_setNodeKeyNoWrapCSSVariable = function _TreeOutline_setNodeKeyNoWrapCSSVariable(attributeValue) {
    ...
    if (!isExpandableNode(treeNode) || !__classPrivateFieldGet(this, _TreeOutline_instances, "m", _TreeOutline_nodeIsExpanded).call(this, treeNode)) {
        return;
    }
    ...
    return html `
      <li role="treeitem"
        ...
        track-dom-node-to-tree-node=${trackDOMNodeToTreeNode(__classPrivateFieldGet(this, _TreeOutline_domNodeToTreeNodeMap, "f"), node)}
      ...
      >
        ...
        >
          <span class="arrow-icon" @click=${__classPrivateFieldGet(this, _TreeOutline_instances, "m", _TreeOutline_onArrowClick).call(this, node)} jslog=${VisualLogging.expand().track({ click: true })}>
          </span>
    ...
    if (__classPrivateFieldGet(this, _TreeOutline_enqueuedRender, "f")) {
        ...
        return await __classPrivateFieldGet(this, _TreeOutline_instances, "m", _TreeOutline_render).call(this);
    }
};
