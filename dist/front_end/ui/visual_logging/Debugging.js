...
var _StateFlowElementsByArea_data;
...
class StateFlowElementsByArea {
    constructor() {
        _StateFlowElementsByArea_data.set(this, new Map());
    }
    add(e) {
        __classPrivateFieldGet(this, _StateFlowElementsByArea_data, "f").set(e.veid, e);
    }
    get(veid) {
        return __classPrivateFieldGet(this, _StateFlowElementsByArea_data, "f").get(veid);
    }
    getArea(e) {
        let area = (e.width || 0) * (e.height || 0);
        const parent = e.parent ? __classPrivateFieldGet(this, _StateFlowElementsByArea_data, "f").get(e.parent?.veid) : null;
        if (!parent) {
            return area;
        }
    ...
    get data() {
        return [...__classPrivateFieldGet(this, _StateFlowElementsByArea_data, "f").values()].filter(e => this.getArea(e)).sort((e1, e2) => this.getArea(e2) - this.getArea(e1));
    }
}
_StateFlowElementsByArea_data = new WeakMap();
