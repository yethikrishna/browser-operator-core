...
export class FormatPickerContextMenu {
    ...
    async show(e, onSelect) {
        ...
        if (!(__classPrivateFieldGet(this, _FormatPickerContextMenu_color, "f") instanceof Common.Color.Nickname)) {
        ...
        if (!(__classPrivateFieldGet(this, _FormatPickerContextMenu_color, "f") instanceof Common.Color.ShortHex)) {
            const shortHex = __classPrivateFieldGet(this, _FormatPickerContextMenu_color, "f").as((__classPrivateFieldGet(this, _FormatPickerContextMenu_color, "f").alpha ?? 1) === 1 ? "hex" /* Common.Color.Format.HEX */ : "hexa" /* Common.Color.Format.HEXA */)
                .shortHex();
            if (shortHex) {
