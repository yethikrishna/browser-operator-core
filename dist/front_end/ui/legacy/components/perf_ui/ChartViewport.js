...
export class ChartViewport extends UI.Widget.VBox {
    constructor(delegate, config) {
        super();
        _ChartViewport_config.set(this, void 0);
        __classPrivateFieldSet(this, _ChartViewport_config, config, "f");
    ...
    updateCursorPosition(e) {
        ...
        const shouldShowCursor = __classPrivateFieldGet(this, _ChartViewport_config, "f").enableCursorElement && mouseEvent.shiftKey && !mouseEvent.metaKey;
...
_ChartViewport_config = new WeakMap();
