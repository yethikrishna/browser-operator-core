...
NetworkTestRunner.waitForRequestResponse = function (request) {
    ...
    return TestRunner.waitForEvent(SDK.NetworkManager.Events.RequestUpdated, TestRunner.networkManager, updateRequest => updateRequest === request && request.responseReceivedTime !== -1);
};
...
`);
//# sourceMappingURL=network_test_runner.js.map