...
SDKTestRunner.PageMock = class {
    ...
    connectAsMainTarget(targetName) {
        ...
        const target = SDK.TargetManager.TargetManager.instance().createTarget(nextId('mock-target-'), targetName, this.type, null);
    ...
    connectAsChildTarget(targetName, parentMock) {
        ...
        const target = SDK.TargetManager.TargetManager.instance().createTarget(this.sessionId, targetName, this.type, parentMock.target, this.sessionId);
        this.target = target;
        return target;
    }
    disconnect() {
    ...
    dispatch(sessionId, id, methodName, params) {
        ...
        this.sendResponse(id, undefined, { message: 'Can\'t handle command ' + methodName, code: ProtocolClient.InspectorBackend.DevToolsStubErrorCode });
    }
...
//# sourceMappingURL=sdk_test_runner.js.map