...
ElementsTestRunner.doAddAttribute = function (testName, dataNodeId, attributeText, next) {
    ...
    function testBody(node, done) {
        ...
        function testContinuation() {
            const editorElement = ElementsTestRunner.firstElementsTreeOutline().shadowRoot.getSelection().anchorNode.parentElement;
...
//# sourceMappingURL=EditDOMTestRunner.js.map