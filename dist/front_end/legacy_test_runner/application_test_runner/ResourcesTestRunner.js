...
export const dumpCookieDomains = function () {
    const cookieListChildren = Application.ResourcesPanel.ResourcesPanel.instance().sidebar.cookieListTreeElement.children();
...
`);
//# sourceMappingURL=ResourcesTestRunner.js.map