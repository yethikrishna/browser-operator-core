...
TestRunner.addSniffer(Bindings.CompilerScriptMapping.CompilerScriptMapping.prototype, 'sourceMapAttachedForTest', onSourceMap, true);
TestRunner.addSniffer(Bindings.SASSSourceMapping.SASSSourceMapping.prototype, 'sourceMapAttachedForTest', onSourceMap, true);
...
export const createDebuggerLiveLocation = function (name, urlSuffix, lineNumber, columnNumber, dumpOnUpdate = true) {
    ...
    return Bindings.DebuggerWorkspaceBinding.DebuggerWorkspaceBinding.instance().createLiveLocation(rawLocation, updateDelegate.bind(null, name, dumpOnUpdate), locationPool);
};
export const createCSSLiveLocation = function (name, urlSuffix, lineNumber, columnNumber, dumpOnUpdate = true) {
    ...
    return Bindings.CSSWorkspaceBinding.CSSWorkspaceBinding.instance().createLiveLocation(rawLocation, updateDelegate.bind(null, name, dumpOnUpdate), locationPool);
};
...
//# sourceMappingURL=BindingsTestRunner.js.map