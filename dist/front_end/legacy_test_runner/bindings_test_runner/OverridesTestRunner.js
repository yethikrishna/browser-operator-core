...
export const createOverrideProject = async function (folderPath) {
    ...
    const project = Workspace.Workspace.WorkspaceImpl.instance().project(Persistence.FileSystemWorkspaceBinding.FileSystemWorkspaceBinding.projectId(isolatedFileSystem.path()));
...
//# sourceMappingURL=OverridesTestRunner.js.map