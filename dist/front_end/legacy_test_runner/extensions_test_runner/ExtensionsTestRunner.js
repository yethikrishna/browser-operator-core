...
ExtensionsTestRunner.runExtensionTests = async function (tests) {
    ...
    self.Extensions.extensionServer.addExtension({ startPage: extensionURL, name: 'test extension', exposeWebInspectorNamespace: true });
};
(function disableLogging() {
    // Suppress console warnings from ExtensionServer.js
    console.warn = () => undefined;
})();
//# sourceMappingURL=ExtensionsTestRunner.js.map