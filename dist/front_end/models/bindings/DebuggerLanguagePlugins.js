...
var _SourceScopeRemoteObject_callFrame, _SourceScopeRemoteObject_plugin, _SourceScope_callFrameInternal, _SourceScope_typeInternal, _SourceScope_typeNameInternal, _SourceScope_iconInternal, _SourceScope_objectInternal, _DebuggerLanguagePluginManager_workspace, _DebuggerLanguagePluginManager_debuggerWorkspaceBinding, _DebuggerLanguagePluginManager_plugins, _DebuggerLanguagePluginManager_debuggerModelToData, _DebuggerLanguagePluginManager_rawModuleHandles;
...
class SourceScopeRemoteObject extends SDK.RemoteObject.RemoteObjectImpl {
    constructor(callFrame, stopId, plugin) {
        ...
        _SourceScopeRemoteObject_callFrame.set(this, void 0);
        _SourceScopeRemoteObject_plugin.set(this, void 0);
        this.variables = [];
        __classPrivateFieldSet(this, _SourceScopeRemoteObject_callFrame, callFrame, "f");
        __classPrivateFieldSet(this, _SourceScopeRemoteObject_plugin, plugin, "f");
        this.stopId = stopId;
    }
    async doGetProperties(_ownProperties, accessorPropertiesOnly, _generatePreview) {
        ...
        for (const variable of this.variables) {
            let sourceVar;
            try {
                const evalResult = await __classPrivateFieldGet(this, _SourceScopeRemoteObject_plugin, "f").evaluate(variable.name, getRawLocation(__classPrivateFieldGet(this, _SourceScopeRemoteObject_callFrame, "f")), this.stopId);
                sourceVar = evalResult ? await wrapRemoteObject(__classPrivateFieldGet(this, _SourceScopeRemoteObject_callFrame, "f"), evalResult, __classPrivateFieldGet(this, _SourceScopeRemoteObject_plugin, "f")) :
...
_SourceScopeRemoteObject_callFrame = new WeakMap(), _SourceScopeRemoteObject_plugin = new WeakMap();
export class SourceScope {
    constructor(callFrame, stopId, type, typeName, icon, plugin) {
        _SourceScope_callFrameInternal.set(this, void 0);
        _SourceScope_typeInternal.set(this, void 0);
        _SourceScope_typeNameInternal.set(this, void 0);
        _SourceScope_iconInternal.set(this, void 0);
        _SourceScope_objectInternal.set(this, void 0);
        if (icon && new URL(icon).protocol !== 'data:') {
            throw new Error('The icon must be a data:-URL');
        }
        __classPrivateFieldSet(this, _SourceScope_callFrameInternal, callFrame, "f");
        __classPrivateFieldSet(this, _SourceScope_typeInternal, type, "f");
        __classPrivateFieldSet(this, _SourceScope_typeNameInternal, typeName, "f");
        __classPrivateFieldSet(this, _SourceScope_iconInternal, icon, "f");
        __classPrivateFieldSet(this, _SourceScope_objectInternal, new SourceScopeRemoteObject(callFrame, stopId, plugin), "f");
    }
    async getVariableValue(name) {
        for (let v = 0; v < __classPrivateFieldGet(this, _SourceScope_objectInternal, "f").variables.length; ++v) {
            if (__classPrivateFieldGet(this, _SourceScope_objectInternal, "f").variables[v].name !== name) {
                continue;
            }
            const properties = await __classPrivateFieldGet(this, _SourceScope_objectInternal, "f").getAllProperties(false, false);
    ...
    callFrame() {
        return __classPrivateFieldGet(this, _SourceScope_callFrameInternal, "f");
    }
    type() {
        return __classPrivateFieldGet(this, _SourceScope_typeInternal, "f");
    }
    typeName() {
        return __classPrivateFieldGet(this, _SourceScope_typeNameInternal, "f");
    }
    name() {
        return undefined;
    }
    ...
    object() {
        return __classPrivateFieldGet(this, _SourceScope_objectInternal, "f");
    }
    description() {
        return '';
    }
    icon() {
        return __classPrivateFieldGet(this, _SourceScope_iconInternal, "f");
    }
    extraProperties() {
        return [];
    }
}
_SourceScope_callFrameInternal = new WeakMap(), _SourceScope_typeInternal = new WeakMap(), _SourceScope_typeNameInternal = new WeakMap(), _SourceScope_iconInternal = new WeakMap(), _SourceScope_objectInternal = new WeakMap();
...
export class DebuggerLanguagePluginManager {
    constructor(targetManager, workspace, debuggerWorkspaceBinding) {
        _DebuggerLanguagePluginManager_workspace.set(this, void 0);
        _DebuggerLanguagePluginManager_debuggerWorkspaceBinding.set(this, void 0);
        _DebuggerLanguagePluginManager_plugins.set(this, void 0);
        _DebuggerLanguagePluginManager_debuggerModelToData.set(this, void 0);
        _DebuggerLanguagePluginManager_rawModuleHandles.set(this, void 0);
        this.callFrameByStopId = new Map();
        this.stopIdByCallFrame = new Map();
        this.nextStopId = 0n;
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_workspace, workspace, "f");
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_debuggerWorkspaceBinding, debuggerWorkspaceBinding, "f");
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_plugins, [], "f");
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_debuggerModelToData, new Map(), "f");
        targetManager.observeModels(SDK.DebuggerModel.DebuggerModel, this);
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_rawModuleHandles, new Map(), "f");
    }
    ...
    modelAdded(debuggerModel) {
        __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").set(debuggerModel, new ModelData(debuggerModel, __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_workspace, "f")));
    ...
    modelRemoved(debuggerModel) {
        ...
        const modelData = __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").get(debuggerModel);
        if (modelData) {
            modelData.dispose();
            __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").delete(debuggerModel);
        }
        __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").forEach((rawModuleHandle, rawModuleId) => {
            ...
            if (scripts.length === 0) {
                ...
                __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").delete(rawModuleId);
            }
            else {
    ...
    addPlugin(plugin) {
        __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_plugins, "f").push(plugin);
        for (const debuggerModel of __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").keys()) {
    ...
    removePlugin(plugin) {
        __classPrivateFieldSet(this, _DebuggerLanguagePluginManager_plugins, __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_plugins, "f").filter(p => p !== plugin), "f");
        ...
        for (const script of scripts) {
            const modelData = __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").get(script.debuggerModel);
    ...
    hasPluginForScript(script) {
        ...
        const rawModuleHandle = __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").get(rawModuleId);
    ...
    async rawModuleIdAndPluginForScript(script) {
        ...
        if (rawModuleHandle) {
            ...
            if (rawModuleHandle === __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").get(rawModuleId)) {
    ...
    scriptsForUISourceCode(uiSourceCode) {
        for (const modelData of __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerModelToData, "f").values()) {
    ...
    parsedScriptSource(event) {
        ...
        for (const plugin of __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_plugins, "f")) {
            if (!plugin.handleScript(script)) {
                continue;
            }
            const rawModuleId = rawModuleIdForScript(script);
            let rawModuleHandle = __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").get(rawModuleId);
            if (!rawModuleHandle) {
                ...
                __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_rawModuleHandles, "f").set(rawModuleId, rawModuleHandle);
            }
            else {
                ...
                if (!('missingSymbolFiles' in sourceFileURLs)) {
                    ...
                    if (script.debuggerModel.scriptForId(script.scriptId) === script) {
                        ...
                        if (modelData) { // The DebuggerModel could have disappeared meanwhile...
                            ...
                            void __classPrivateFieldGet(this, _DebuggerLanguagePluginManager_debuggerWorkspaceBinding, "f").updateLocations(script);
                        }
                    }
                }
            });
...
_DebuggerLanguagePluginManager_workspace = new WeakMap(), _DebuggerLanguagePluginManager_debuggerWorkspaceBinding = new WeakMap(), _DebuggerLanguagePluginManager_plugins = new WeakMap(), _DebuggerLanguagePluginManager_debuggerModelToData = new WeakMap(), _DebuggerLanguagePluginManager_rawModuleHandles = new WeakMap();
class ModelData {
