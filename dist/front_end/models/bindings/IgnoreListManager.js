...
var _IgnoreListManager_debuggerWorkspaceBinding, _IgnoreListManager_listeners, _IgnoreListManager_isIgnoreListedURLCache, _IgnoreListManager_contentScriptExecutionContexts;
...
export class IgnoreListManager {
    constructor(debuggerWorkspaceBinding) {
        _IgnoreListManager_debuggerWorkspaceBinding.set(this, void 0);
        _IgnoreListManager_listeners.set(this, void 0);
        _IgnoreListManager_isIgnoreListedURLCache.set(this, void 0);
        _IgnoreListManager_contentScriptExecutionContexts.set(this, void 0);
        __classPrivateFieldSet(this, _IgnoreListManager_debuggerWorkspaceBinding, debuggerWorkspaceBinding, "f");
        ...
        Common.Settings.Settings.instance()
            ...
            .addChangeListener(this.patternChanged.bind(this));
        __classPrivateFieldSet(this, _IgnoreListManager_listeners, new Set(), "f");
        __classPrivateFieldSet(this, _IgnoreListManager_isIgnoreListedURLCache, new Map(), "f");
        __classPrivateFieldSet(this, _IgnoreListManager_contentScriptExecutionContexts, new Set(), "f");
    ...
    addChangeListener(listener) {
        __classPrivateFieldGet(this, _IgnoreListManager_listeners, "f").add(listener);
    }
    removeChangeListener(listener) {
        __classPrivateFieldGet(this, _IgnoreListManager_listeners, "f").delete(listener);
    }
    ...
    onExecutionContextCreated(event) {
        if (this.isContentScript(event.data)) {
            __classPrivateFieldGet(this, _IgnoreListManager_contentScriptExecutionContexts, "f").add(event.data.uniqueId);
    ...
    onExecutionContextDestroyed(event) {
        if (this.isContentScript(event.data)) {
            __classPrivateFieldGet(this, _IgnoreListManager_contentScriptExecutionContexts, "f").delete(event.data.uniqueId);
            if (this.skipContentScripts) {
                for (const debuggerModel of SDK.TargetManager.TargetManager.instance().models(SDK.DebuggerModel.DebuggerModel)) {
                    void this.updateIgnoredExecutionContexts(debuggerModel);
                }
    ...
    clearCacheIfNeeded() {
        if (__classPrivateFieldGet(this, _IgnoreListManager_isIgnoreListedURLCache, "f").size > 1024) {
            __classPrivateFieldGet(this, _IgnoreListManager_isIgnoreListedURLCache, "f").clear();
        }
    }
    ...
    updateIgnoredExecutionContexts(debuggerModel) {
        return debuggerModel.setBlackboxExecutionContexts(this.skipContentScripts ? Array.from(__classPrivateFieldGet(this, _IgnoreListManager_contentScriptExecutionContexts, "f")) : []);
    }
    ...
    isUserIgnoreListedURL(url, options) {
        ...
        if (__classPrivateFieldGet(this, _IgnoreListManager_isIgnoreListedURLCache, "f").has(url)) {
            return Boolean(__classPrivateFieldGet(this, _IgnoreListManager_isIgnoreListedURLCache, "f").get(url));
        }
        const isIgnoreListed = this.getFirstMatchedRegex(url) !== null;
        __classPrivateFieldGet(this, _IgnoreListManager_isIgnoreListedURLCache, "f").set(url, isIgnoreListed);
    ...
    async updateScriptRanges(script, sourceMap) {
        ...
        if (!hasIgnoreListedMappings) {
            ...
            await __classPrivateFieldGet(this, _IgnoreListManager_debuggerWorkspaceBinding, "f").updateLocations(script);
            return;
        }
        if (!sourceMap) {
            return;
        ...
        void __classPrivateFieldGet(this, _IgnoreListManager_debuggerWorkspaceBinding, "f").updateLocations(script);
    ...
    async patternChanged() {
        ...
        const listeners = Array.from(__classPrivateFieldGet(this, _IgnoreListManager_listeners, "f"));
...
_IgnoreListManager_debuggerWorkspaceBinding = new WeakMap(), _IgnoreListManager_listeners = new WeakMap(), _IgnoreListManager_isIgnoreListedURLCache = new WeakMap(), _IgnoreListManager_contentScriptExecutionContexts = new WeakMap();
