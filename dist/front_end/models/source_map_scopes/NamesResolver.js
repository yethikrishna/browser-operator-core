...
var _ScopeWithSourceMappedVariables_debuggerScope, _ScopeWithSourceMappedVariables_thisObject;
...
class ScopeWithSourceMappedVariables {
    constructor(scope, thisObject) {
        _ScopeWithSourceMappedVariables_debuggerScope.set(this, void 0);
        /** The resolved `this` of the current call frame */
        _ScopeWithSourceMappedVariables_thisObject.set(this, void 0);
        __classPrivateFieldSet(this, _ScopeWithSourceMappedVariables_debuggerScope, scope, "f");
        __classPrivateFieldSet(this, _ScopeWithSourceMappedVariables_thisObject, thisObject, "f");
    }
    callFrame() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").callFrame();
    }
    type() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").type();
    }
    typeName() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").typeName();
    }
    name() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").name();
    }
    range() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").range();
    }
    object() {
        return resolveScopeInObject(__classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f"));
    }
    description() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").description();
    }
    icon() {
        return __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").icon();
    }
    extraProperties() {
        const extraProperties = __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_debuggerScope, "f").extraProperties();
        if (__classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_thisObject, "f") && this.type() === "local" /* Protocol.Debugger.ScopeType.Local */) {
            extraProperties.unshift(new SDK.RemoteObject.RemoteObjectProperty('this', __classPrivateFieldGet(this, _ScopeWithSourceMappedVariables_thisObject, "f"), undefined, undefined, undefined, undefined, undefined, /* synthetic */ true));
        }
        return extraProperties;
    }
}
_ScopeWithSourceMappedVariables_debuggerScope = new WeakMap(), _ScopeWithSourceMappedVariables_thisObject = new WeakMap();
