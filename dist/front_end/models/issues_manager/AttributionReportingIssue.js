...
(function (IssueCode) {
    IssueCode["PERMISSION_POLICY_DISABLED"] = "AttributionReportingIssue::PermissionPolicyDisabled";
    IssueCode["UNTRUSTWORTHY_REPORTING_ORIGIN"] = "AttributionReportingIssue::UntrustworthyReportingOrigin";
    IssueCode["INSECURE_CONTEXT"] = "AttributionReportingIssue::InsecureContext";
    IssueCode["INVALID_REGISTER_SOURCE_HEADER"] = "AttributionReportingIssue::InvalidRegisterSourceHeader";
    IssueCode["INVALID_REGISTER_TRIGGER_HEADER"] = "AttributionReportingIssue::InvalidRegisterTriggerHeader";
    IssueCode["SOURCE_AND_TRIGGER_HEADERS"] = "AttributionReportingIssue::SourceAndTriggerHeaders";
    IssueCode["SOURCE_IGNORED"] = "AttributionReportingIssue::SourceIgnored";
    IssueCode["TRIGGER_IGNORED"] = "AttributionReportingIssue::TriggerIgnored";
    IssueCode["OS_SOURCE_IGNORED"] = "AttributionReportingIssue::OsSourceIgnored";
    IssueCode["OS_TRIGGER_IGNORED"] = "AttributionReportingIssue::OsTriggerIgnored";
    IssueCode["INVALID_REGISTER_OS_SOURCE_HEADER"] = "AttributionReportingIssue::InvalidRegisterOsSourceHeader";
    IssueCode["INVALID_REGISTER_OS_TRIGGER_HEADER"] = "AttributionReportingIssue::InvalidRegisterOsTriggerHeader";
    IssueCode["WEB_AND_OS_HEADERS"] = "AttributionReportingIssue::WebAndOsHeaders";
    IssueCode["NO_WEB_OR_OS_SUPPORT"] = "AttributionReportingIssue::NoWebOrOsSupport";
    IssueCode["NAVIGATION_REGISTRATION_WITHOUT_TRANSIENT_USER_ACTIVATION"] = "AttributionReportingIssue::NavigationRegistrationWithoutTransientUserActivation";
    IssueCode["INVALID_INFO_HEADER"] = "AttributionReportingIssue::InvalidInfoHeader";
    IssueCode["NO_REGISTER_SOURCE_HEADER"] = "AttributionReportingIssue::NoRegisterSourceHeader";
    IssueCode["NO_REGISTER_TRIGGER_HEADER"] = "AttributionReportingIssue::NoRegisterTriggerHeader";
    IssueCode["NO_REGISTER_OS_SOURCE_HEADER"] = "AttributionReportingIssue::NoRegisterOsSourceHeader";
    IssueCode["NO_REGISTER_OS_TRIGGER_HEADER"] = "AttributionReportingIssue::NoRegisterOsTriggerHeader";
    IssueCode["NAVIGATION_REGISTRATION_UNIQUE_SCOPE_ALREADY_SET"] = "AttributionReportingIssue::NavigationRegistrationUniqueScopeAlreadySet";
    IssueCode["UNKNOWN"] = "AttributionReportingIssue::Unknown";
})(IssueCode || (IssueCode = {}));
