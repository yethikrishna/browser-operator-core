...
var _SharedArrayBufferIssue_issueDetails;
...
export class SharedArrayBufferIssue extends Issue {
    constructor(issueDetails, issuesModel) {
        ...
        _SharedArrayBufferIssue_issueDetails.set(this, void 0);
        __classPrivateFieldSet(this, _SharedArrayBufferIssue_issueDetails, issueDetails, "f");
    }
    getCategory() {
        return "Other" /* IssueCategory.OTHER */;
    }
    details() {
        return __classPrivateFieldGet(this, _SharedArrayBufferIssue_issueDetails, "f");
    }
    getDescription() {
        return {
    ...
    primaryKey() {
        return JSON.stringify(__classPrivateFieldGet(this, _SharedArrayBufferIssue_issueDetails, "f"));
    }
    getKind() {
        if (__classPrivateFieldGet(this, _SharedArrayBufferIssue_issueDetails, "f").isWarning) {
...
_SharedArrayBufferIssue_issueDetails = new WeakMap();
