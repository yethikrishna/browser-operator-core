...
export class RequestContext extends ConversationContext {
    constructor(request) {
        super();
        _RequestContext_request.set(this, void 0);
        __classPrivateFieldSet(this, _RequestContext_request, request, "f");
    }
    getOrigin() {
        return new URL(__classPrivateFieldGet(this, _RequestContext_request, "f").url()).origin;
    }
    getItem() {
        return __classPrivateFieldGet(this, _RequestContext_request, "f");
    }
    getIcon() {
        return PanelUtils.PanelUtils.getIconForNetworkRequest(__classPrivateFieldGet(this, _RequestContext_request, "f"));
    }
    getTitle() {
        return __classPrivateFieldGet(this, _RequestContext_request, "f").name();
    }
}
_RequestContext_request = new WeakMap();
/**
...
export class NetworkAgent extends AiAgent {
    constructor() {
        ...
        this.clientFeature = Host.AidaClient.ClientFeature.CHROME_NETWORK_AGENT;
    }
    get userTier() {
