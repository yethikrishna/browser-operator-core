...
var _InsightContext_insight, _PerformanceInsightsAgent_instances, _PerformanceInsightsAgent_insight, _PerformanceInsightsAgent_lastContextForEnhancedQuery, _PerformanceInsightsAgent_functionCallCache, _PerformanceInsightsAgent_isFunctionResponseTooLarge;
...
export class InsightContext extends ConversationContext {
    constructor(insight) {
        super();
        _InsightContext_insight.set(this, void 0);
        __classPrivateFieldSet(this, _InsightContext_insight, insight, "f");
    }
    getOrigin() {
        /**
         ...
         * pretty small...
         */
        const { min, max } = __classPrivateFieldGet(this, _InsightContext_insight, "f").parsedTrace.Meta.traceBounds;
        return `trace-${min}-${max}`;
    }
    getItem() {
        return __classPrivateFieldGet(this, _InsightContext_insight, "f");
    }
    getIcon() {
    ...
    getTitle() {
        return `Insight: ${__classPrivateFieldGet(this, _InsightContext_insight, "f").title()}`;
    }
    /**
    ...
    async getSuggestions() {
        switch (__classPrivateFieldGet(this, _InsightContext_insight, "f").insight.insightKey) {
            case 'CLSCulprits':
                return [
            ...
            default:
                Platform.assertNever(__classPrivateFieldGet(this, _InsightContext_insight, "f").insight.insightKey, 'Unknown insight key');
        }
    }
}
_InsightContext_insight = new WeakMap();
...
export class PerformanceInsightsAgent extends AiAgent {
    ...
    constructor(opts) {
        super(opts);
        _PerformanceInsightsAgent_instances.add(this);
        _PerformanceInsightsAgent_insight.set(this, void 0);
        _PerformanceInsightsAgent_lastContextForEnhancedQuery.set(this, void 0);
        /**
         ...
         */
        _PerformanceInsightsAgent_functionCallCache.set(this, new Map());
        this.preamble = preamble;
        this.clientFeature = Host.AidaClient.ClientFeature.CHROME_PERFORMANCE_INSIGHTS_AGENT;
        this.declareFunction('getNetworkActivitySummary', {
            ...
            handler: async () => {
                ...
                if (!__classPrivateFieldGet(this, _PerformanceInsightsAgent_insight, "f")) {
                    return { error: 'No insight available' };
                }
                const activeInsight = __classPrivateFieldGet(this, _PerformanceInsightsAgent_insight, "f").getItem();
                ...
                if (__classPrivateFieldGet(this, _PerformanceInsightsAgent_instances, "m", _PerformanceInsightsAgent_isFunctionResponseTooLarge).call(this, formatted)) {
                    return {
                ...
                const cacheForInsight = __classPrivateFieldGet(this, _PerformanceInsightsAgent_functionCallCache, "f").get(activeInsight) ?? {};
                cacheForInsight.getNetworkActivitySummary = summaryFact;
                __classPrivateFieldGet(this, _PerformanceInsightsAgent_functionCallCache, "f").set(activeInsight, cacheForInsight);
...
* S: **Optional marker.** The letter 'S' appears at the end of the line **only** for the single call frame selected by the user.`,
            ...
            handler: async () => {
                ...
                if (__classPrivateFieldGet(this, _PerformanceInsightsAgent_instances, "m", _PerformanceInsightsAgent_isFunctionResponseTooLarge).call(this, activity)) {
                    return {
    ...
    async enhanceQuery(query, selectedInsight) {
        ...
        const includeInsightInfo = selectedInsight !== __classPrivateFieldGet(this, _PerformanceInsightsAgent_lastContextForEnhancedQuery, "f");
        ...
        __classPrivateFieldSet(this, _PerformanceInsightsAgent_lastContextForEnhancedQuery, selectedInsight, "f");
        return finalQuery;
    }
    async *run(initialQuery, options) {
        __classPrivateFieldSet(this, _PerformanceInsightsAgent_insight, options.selected ?? undefined, "f");
        // Clear any previous facts in case the user changed the active context.
        this.clearFacts();
        const cachedFunctionCalls = __classPrivateFieldGet(this, _PerformanceInsightsAgent_insight, "f") ? __classPrivateFieldGet(this, _PerformanceInsightsAgent_functionCallCache, "f").get(__classPrivateFieldGet(this, _PerformanceInsightsAgent_insight, "f").getItem()) : null;
...
_PerformanceInsightsAgent_insight = new WeakMap(), _PerformanceInsightsAgent_lastContextForEnhancedQuery = new WeakMap(), _PerformanceInsightsAgent_functionCallCache = new WeakMap(), _PerformanceInsightsAgent_instances = new WeakSet(), _PerformanceInsightsAgent_isFunctionResponseTooLarge = function _PerformanceInsightsAgent_isFunctionResponseTooLarge(response) {
