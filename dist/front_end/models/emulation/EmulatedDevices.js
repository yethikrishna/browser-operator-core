...
var _EmulatedDevice_showInternal, _EmulatedDevice_showByDefault, _EmulatedDevicesList_standardSetting, _EmulatedDevicesList_standardInternal, _EmulatedDevicesList_customSetting, _EmulatedDevicesList_customInternal;
...
export class EmulatedDevice {
    constructor() {
        _EmulatedDevice_showInternal.set(this, void 0);
        _EmulatedDevice_showByDefault.set(this, void 0);
        this.title = '';
        ...
        __classPrivateFieldSet(this, _EmulatedDevice_showInternal, Show.Default, "f");
        __classPrivateFieldSet(this, _EmulatedDevice_showByDefault, true, "f");
    }
    static fromJSONV1(json) {
        try {
            ...
            __classPrivateFieldSet(result, _EmulatedDevice_showByDefault, parseValue(json, 'show-by-default', 'boolean', undefined), "f");
            ...
            __classPrivateFieldSet(result, _EmulatedDevice_showInternal, show, "f");
            return result;
        }
        catch {
            return null;
    ...
    toJSON() {
        ...
        json['show-by-default'] = __classPrivateFieldGet(this, _EmulatedDevice_showByDefault, "f");
        json['dual-screen'] = this.isDualScreen;
        json['foldable-screen'] = this.isFoldableScreen;
        json['show'] = __classPrivateFieldGet(this, _EmulatedDevice_showInternal, "f");
    ...
    show() {
        if (__classPrivateFieldGet(this, _EmulatedDevice_showInternal, "f") === Show.Default) {
            return __classPrivateFieldGet(this, _EmulatedDevice_showByDefault, "f");
        }
        return __classPrivateFieldGet(this, _EmulatedDevice_showInternal, "f") === Show.Always;
    }
    setShow(show) {
        __classPrivateFieldSet(this, _EmulatedDevice_showInternal, show ? Show.Always : Show.Never, "f");
    }
    copyShowFrom(other) {
        __classPrivateFieldSet(this, _EmulatedDevice_showInternal, __classPrivateFieldGet(other, _EmulatedDevice_showInternal, "f"), "f");
    }
    touch() {
...
_EmulatedDevice_showInternal = new WeakMap(), _EmulatedDevice_showByDefault = new WeakMap();
...
export class EmulatedDevicesList extends Common.ObjectWrapper.ObjectWrapper {
    constructor() {
        super();
        _EmulatedDevicesList_standardSetting.set(this, void 0);
        _EmulatedDevicesList_standardInternal.set(this, void 0);
        _EmulatedDevicesList_customSetting.set(this, void 0);
        _EmulatedDevicesList_customInternal.set(this, void 0);
        __classPrivateFieldSet(this, _EmulatedDevicesList_standardSetting, Common.Settings.Settings.instance().createSetting('standard-emulated-device-list', []), "f");
        __classPrivateFieldSet(this, _EmulatedDevicesList_standardInternal, new Set(), "f");
        this.listFromJSONV1(__classPrivateFieldGet(this, _EmulatedDevicesList_standardSetting, "f").get(), __classPrivateFieldGet(this, _EmulatedDevicesList_standardInternal, "f"));
        this.updateStandardDevices();
        __classPrivateFieldSet(this, _EmulatedDevicesList_customSetting, Common.Settings.Settings.instance().createSetting('custom-emulated-device-list', []), "f");
        __classPrivateFieldSet(this, _EmulatedDevicesList_customInternal, new Set(), "f");
        if (!this.listFromJSONV1(__classPrivateFieldGet(this, _EmulatedDevicesList_customSetting, "f").get(), __classPrivateFieldGet(this, _EmulatedDevicesList_customInternal, "f"))) {
    ...
    updateStandardDevices() {
        ...
        this.copyShowValues(__classPrivateFieldGet(this, _EmulatedDevicesList_standardInternal, "f"), devices);
        __classPrivateFieldSet(this, _EmulatedDevicesList_standardInternal, devices, "f");
    ...
    standard() {
        return [...__classPrivateFieldGet(this, _EmulatedDevicesList_standardInternal, "f")];
    }
    custom() {
        return [...__classPrivateFieldGet(this, _EmulatedDevicesList_customInternal, "f")];
    }
    revealCustomSetting() {
        void Common.Revealer.reveal(__classPrivateFieldGet(this, _EmulatedDevicesList_customSetting, "f"));
    }
    addCustomDevice(device) {
        __classPrivateFieldGet(this, _EmulatedDevicesList_customInternal, "f").add(device);
        this.saveCustomDevices();
    }
    removeCustomDevice(device) {
        __classPrivateFieldGet(this, _EmulatedDevicesList_customInternal, "f").delete(device);
        this.saveCustomDevices();
    }
    saveCustomDevices() {
        const json = [];
        __classPrivateFieldGet(this, _EmulatedDevicesList_customInternal, "f").forEach(device => json.push(device.toJSON()));
        __classPrivateFieldGet(this, _EmulatedDevicesList_customSetting, "f").set(json);
        this.dispatchEventToListeners("CustomDevicesUpdated" /* Events.CUSTOM_DEVICES_UPDATED */);
    }
    saveStandardDevices() {
        const json = [];
        __classPrivateFieldGet(this, _EmulatedDevicesList_standardInternal, "f").forEach(device => json.push(device.toJSON()));
        __classPrivateFieldGet(this, _EmulatedDevicesList_standardSetting, "f").set(json);
...
_EmulatedDevicesList_standardSetting = new WeakMap(), _EmulatedDevicesList_standardInternal = new WeakMap(), _EmulatedDevicesList_customSetting = new WeakMap(), _EmulatedDevicesList_customInternal = new WeakMap();
export var Events;
(function (Events) {
