...
var _CPUProfileDataModel_idToParsedNode, _CPUProfileDataModel_stackStartTimes, _CPUProfileDataModel_stackChildrenDuration;
...
export class CPUProfileDataModel extends ProfileTreeModel {
    constructor(profile) {
         ...
         */
        _CPUProfileDataModel_idToParsedNode.set(this, void 0);
        _CPUProfileDataModel_stackStartTimes.set(this, void 0);
        _CPUProfileDataModel_stackChildrenDuration.set(this, void 0);
    ...
    translateProfileTree(nodes) {
        ...
        __classPrivateFieldSet(this, _CPUProfileDataModel_idToParsedNode, new Map(), "f");
        const resultRoot = new CPUProfileNode(root, sampleTime);
        __classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f").set(root.id, resultRoot);
        if (!root.children) {
        ...
        while (sourceNodeStack.length) {
            ...
            __classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f").set(sourceNode.id, targetNode);
        }
        if (this.samples) {
    ...
    fixMissingSamples() {
        ...
        const idToNode = __classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f");
    ...
    forEachFrame(openFrameCallback, closeFrameCallback, startTime, stopTime) {
        ...
        if (!__classPrivateFieldGet(this, _CPUProfileDataModel_stackStartTimes, "f")) {
            __classPrivateFieldSet(this, _CPUProfileDataModel_stackStartTimes, new Array(stackDepth), "f");
        }
        const stackStartTimes = __classPrivateFieldGet(this, _CPUProfileDataModel_stackStartTimes, "f");
        if (!__classPrivateFieldGet(this, _CPUProfileDataModel_stackChildrenDuration, "f")) {
            __classPrivateFieldSet(this, _CPUProfileDataModel_stackChildrenDuration, new Array(stackDepth), "f");
        }
        const stackChildrenDuration = __classPrivateFieldGet(this, _CPUProfileDataModel_stackChildrenDuration, "f");
        let node;
        let sampleIndex;
     ...
     */
    nodeByIndex(index) {
        return this.samples && __classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f").get(this.samples[index]) || null;
    }
    /**
     * Returns the node that corresponds to a given node id.
     */
    nodeById(nodeId) {
        return __classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f").get(nodeId) || null;
    }
    nodes() {
        if (!__classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f")) {
            return null;
        }
        return [...__classPrivateFieldGet(this, _CPUProfileDataModel_idToParsedNode, "f").values()];
    }
}
_CPUProfileDataModel_idToParsedNode = new WeakMap(), _CPUProfileDataModel_stackStartTimes = new WeakMap(), _CPUProfileDataModel_stackChildrenDuration = new WeakMap();
