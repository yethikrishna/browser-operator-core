...
export class OriginalScopeBuilder {
    ...
    start(line, column, options) {
        ...
        if (options?.name) {
            ...
            nameIdxAndKindIdx.push(__classPrivateFieldGet(this, _OriginalScopeBuilder_instances, "m", _OriginalScopeBuilder_nameIdx).call(this, options.name));
        }
        if (options?.kind) {
            flags |= 2 /* SDK.SourceMapScopes.EncodedOriginalScopeFlag.HAS_KIND */;
            nameIdxAndKindIdx.push(__classPrivateFieldGet(this, _OriginalScopeBuilder_instances, "m", _OriginalScopeBuilder_encodeKind).call(this, options?.kind));
        }
        if (options?.isStackFrame) {
            flags |= 4 /* SDK.SourceMapScopes.EncodedOriginalScopeFlag.IS_STACK_FRAME */;
        }
        __classPrivateFieldSet(this, _OriginalScopeBuilder_encodedScope, __classPrivateFieldGet(this, _OriginalScopeBuilder_encodedScope, "f") + encodeVlqList([lineDiff, column, flags, ...nameIdxAndKindIdx]), "f");
        if (options?.variables) {
            __classPrivateFieldSet(this, _OriginalScopeBuilder_encodedScope, __classPrivateFieldGet(this, _OriginalScopeBuilder_encodedScope, "f") + encodeVlqList(options.variables.map(variable => __classPrivateFieldGet(this, _OriginalScopeBuilder_instances, "m", _OriginalScopeBuilder_nameIdx).call(this, variable))), "f");
        }
        return this;
    }
    end(line, column) {
