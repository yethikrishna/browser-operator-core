...
export class MockProtocolBackend {
    constructor() {
        ...
        setMockConnectionResponseHandler('Debugger.getScriptSource', __classPrivateFieldGet(this, _MockProtocolBackend_instances, "m", _MockProtocolBackend_getScriptSourceHandler).bind(this));
        setMockConnectionResponseHandler('Runtime.getProperties', __classPrivateFieldGet(this, _MockProtocolBackend_instances, "m", _MockProtocolBackend_getPropertiesHandler).bind(this));
        setMockConnectionResponseHandler('Debugger.setBreakpointByUrl', __classPrivateFieldGet(this, _MockProtocolBackend_instances, "m", _MockProtocolBackend_setBreakpointByUrlHandler).bind(this));
        setMockConnectionResponseHandler('Storage.getStorageKeyForFrame', () => ({ storageKey: 'test-key' }));
        setMockConnectionResponseHandler('Debugger.removeBreakpoint', __classPrivateFieldGet(this, _MockProtocolBackend_instances, "m", _MockProtocolBackend_removeBreakpointHandler).bind(this));
    ...
    async createCallFrame(target, script, scopeDescriptor, sourceMap, scopeObjects = []) {
        ...
        const scopeChain = parsedScopes.map(s => __classPrivateFieldGet(this, _MockProtocolBackend_instances, "m", _MockProtocolBackend_createProtocolScope).call(this, s.type, { type: "object" /* Protocol.Runtime.RemoteObjectType.Object */ }, scriptObject.scriptId, s.startLine, s.startColumn, s.endLine, s.endColumn));
