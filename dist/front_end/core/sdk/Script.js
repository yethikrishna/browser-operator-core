...
var _Script_isContentScriptInternal, _Script_isLiveEditInternal, _Script_codeOffsetInternal, _Script_language, _Script_contentPromise, _Script_embedderNameInternal;
...
export class Script {
    constructor(debuggerModel, scriptId, sourceURL, startLine, startColumn, endLine, endColumn, executionContextId, hash, isContentScript, isLiveEdit, sourceMapURL, hasSourceURL, length, isModule, originStackTrace, codeOffset, scriptLanguage, debugSymbols, embedderName, buildId) {
        _Script_isContentScriptInternal.set(this, void 0);
        _Script_isLiveEditInternal.set(this, void 0);
        _Script_codeOffsetInternal.set(this, void 0);
        _Script_language.set(this, void 0);
        _Script_contentPromise.set(this, void 0);
        _Script_embedderNameInternal.set(this, void 0);
        ...
        this.hash = hash;
        __classPrivateFieldSet(this, _Script_isContentScriptInternal, isContentScript, "f");
        __classPrivateFieldSet(this, _Script_isLiveEditInternal, isLiveEdit, "f");
        this.sourceMapURL = sourceMapURL;
        this.debugSymbols = debugSymbols;
        this.hasSourceURL = hasSourceURL;
        this.contentLength = length;
        this.originStackTrace = originStackTrace;
        __classPrivateFieldSet(this, _Script_codeOffsetInternal, codeOffset, "f");
        __classPrivateFieldSet(this, _Script_language, scriptLanguage, "f");
        __classPrivateFieldSet(this, _Script_contentPromise, null, "f");
        __classPrivateFieldSet(this, _Script_embedderNameInternal, embedderName, "f");
    }
    embedderName() {
        return __classPrivateFieldGet(this, _Script_embedderNameInternal, "f");
    }
    target() {
    ...
    isContentScript() {
        return __classPrivateFieldGet(this, _Script_isContentScriptInternal, "f");
    }
    codeOffset() {
        return __classPrivateFieldGet(this, _Script_codeOffsetInternal, "f");
    }
    isJavaScript() {
        return __classPrivateFieldGet(this, _Script_language, "f") === "JavaScript" /* Protocol.Debugger.ScriptLanguage.JavaScript */;
    }
    isWasm() {
        return __classPrivateFieldGet(this, _Script_language, "f") === "WebAssembly" /* Protocol.Debugger.ScriptLanguage.WebAssembly */;
    }
    scriptLanguage() {
    ...
    isLiveEdit() {
        return __classPrivateFieldGet(this, _Script_isLiveEditInternal, "f");
    }
    contentURL() {
    ...
    requestContentData() {
        if (!__classPrivateFieldGet(this, _Script_contentPromise, "f")) {
            const fileSizeToCache = 65535; // We won't bother cacheing files under 64K
            if (this.hash && !__classPrivateFieldGet(this, _Script_isLiveEditInternal, "f") && this.contentLength > fileSizeToCache) {
                ...
                const fullHash = [
                    __classPrivateFieldGet(this, _Script_language, "f"),
                    this.contentLength,
                    this.lineOffset,
                    this.columnOffset,
                    this.endLine,
                    this.endColumn,
                    __classPrivateFieldGet(this, _Script_codeOffsetInternal, "f"),
                    this.hash,
                ].join(':');
                const cachedContentPromise = scriptCacheInstance.cache.get(fullHash)?.deref();
                if (cachedContentPromise) {
                    __classPrivateFieldSet(this, _Script_contentPromise, cachedContentPromise, "f");
                }
                else {
                    __classPrivateFieldSet(this, _Script_contentPromise, this.requestContentInternal(), "f");
                    scriptCacheInstance.cache.set(fullHash, new WeakRef(__classPrivateFieldGet(this, _Script_contentPromise, "f")));
                    scriptCacheInstance.registry.register(__classPrivateFieldGet(this, _Script_contentPromise, "f"), fullHash);
                }
            }
            else {
                __classPrivateFieldSet(this, _Script_contentPromise, this.requestContentInternal(), "f");
        ...
        return __classPrivateFieldGet(this, _Script_contentPromise, "f");
    }
    ...
    async editSource(newSource) {
        ...
        if (!response.getError() && response.status === "Ok" /* Protocol.Debugger.SetScriptSourceResponseStatus.Ok */) {
            __classPrivateFieldSet(this, _Script_contentPromise, Promise.resolve(new TextUtils.ContentData.ContentData(newSource, /* isBase64 */ false, 'text/javascript')), "f");
        }
...
_Script_isContentScriptInternal = new WeakMap(), _Script_isLiveEditInternal = new WeakMap(), _Script_codeOffsetInternal = new WeakMap(), _Script_language = new WeakMap(), _Script_contentPromise = new WeakMap(), _Script_embedderNameInternal = new WeakMap();
