...
var _BaseVariableMatcher_computedTextCallback;
...
export class BaseVariableMatcher extends matcherBase(BaseVariableMatch) {
    constructor(computedTextCallback) {
        super();
        // clang-format on
        _BaseVariableMatcher_computedTextCallback.set(this, void 0);
        __classPrivateFieldSet(this, _BaseVariableMatcher_computedTextCallback, computedTextCallback, "f");
    }
    matches(node, matching) {
        ...
        return new BaseVariableMatch(matching.ast.text(node), node, varName, fallback, matching, __classPrivateFieldGet(this, _BaseVariableMatcher_computedTextCallback, "f"));
    }
}
_BaseVariableMatcher_computedTextCallback = new WeakMap();
...
(function (LinkableNameProperties) {
    ...
    LinkableNameProperties["FUNCTION"] = "function";
...
LinkableNameMatcher.identifierAnimationLonghandMap = new Map(Object.entries({
...
// clang-format on
LengthMatcher.LENGTH_UNITS = new Set([
...
// clang-format on
FlexGridMatcher.FLEX = ['flex', 'inline-flex', 'block flex', 'inline flex'];
FlexGridMatcher.GRID = ['grid', 'inline-grid', 'block grid', 'inline grid'];
