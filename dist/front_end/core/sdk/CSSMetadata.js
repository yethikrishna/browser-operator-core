...
var _CSSMetadata_values, _CSSMetadata_longhands, _CSSMetadata_shorthands, _CSSMetadata_inherited, _CSSMetadata_svgProperties, _CSSMetadata_propertyValues, _CSSMetadata_aliasesFor, _CSSMetadata_nameValuePresets, _CSSMetadata_nameValuePresetsIncludingSVG, _CSSMetadata_valuesSet;
...
export class CSSMetadata {
    constructor(properties, aliasesFor) {
        _CSSMetadata_values.set(this, []);
        _CSSMetadata_longhands.set(this, new Map());
        _CSSMetadata_shorthands.set(this, new Map());
        _CSSMetadata_inherited.set(this, new Set());
        _CSSMetadata_svgProperties.set(this, new Set());
        _CSSMetadata_propertyValues.set(this, new Map());
        _CSSMetadata_aliasesFor.set(this, new Map());
        _CSSMetadata_nameValuePresets.set(this, []);
        _CSSMetadata_nameValuePresetsIncludingSVG.set(this, []);
        _CSSMetadata_valuesSet.set(this, void 0);
        __classPrivateFieldSet(this, _CSSMetadata_aliasesFor, aliasesFor, "f");
        for (let i = 0; i < properties.length; ++i) {
            ...
            __classPrivateFieldGet(this, _CSSMetadata_values, "f").push(propertyName);
            if (property.inherited) {
                __classPrivateFieldGet(this, _CSSMetadata_inherited, "f").add(propertyName);
            }
            if (property.svg) {
                __classPrivateFieldGet(this, _CSSMetadata_svgProperties, "f").add(propertyName);
            }
            const longhands = properties[i].longhands;
            if (longhands) {
                __classPrivateFieldGet(this, _CSSMetadata_longhands, "f").set(propertyName, longhands);
                for (let j = 0; j < longhands.length; ++j) {
                    const longhandName = longhands[j];
                    let shorthands = __classPrivateFieldGet(this, _CSSMetadata_shorthands, "f").get(longhandName);
                    if (!shorthands) {
                        shorthands = [];
                        __classPrivateFieldGet(this, _CSSMetadata_shorthands, "f").set(longhandName, shorthands);
                    }
                    shorthands.push(propertyName);
                }
            }
        }
        __classPrivateFieldGet(this, _CSSMetadata_values, "f").sort(CSSMetadata.sortPrefixesAndCSSWideKeywordsToEnd);
        __classPrivateFieldSet(this, _CSSMetadata_valuesSet, new Set(__classPrivateFieldGet(this, _CSSMetadata_values, "f")), "f");
        ...
        for (const [propertyName, values] of propertyValueSets) {
            ...
            __classPrivateFieldGet(this, _CSSMetadata_propertyValues, "f").set(propertyName, [...values]);
        }
        for (const name of __classPrivateFieldGet(this, _CSSMetadata_valuesSet, "f")) {
            ...
            if (!this.isSVGProperty(name)) {
                __classPrivateFieldGet(this, _CSSMetadata_nameValuePresets, "f").push(...presets);
            }
            __classPrivateFieldGet(this, _CSSMetadata_nameValuePresetsIncludingSVG, "f").push(...presets);
        }
    }
    ...
    allProperties() {
        return __classPrivateFieldGet(this, _CSSMetadata_values, "f");
    }
    aliasesFor() {
        return __classPrivateFieldGet(this, _CSSMetadata_aliasesFor, "f");
    }
    nameValuePresets(includeSVG) {
        return includeSVG ? __classPrivateFieldGet(this, _CSSMetadata_nameValuePresetsIncludingSVG, "f") : __classPrivateFieldGet(this, _CSSMetadata_nameValuePresets, "f");
    }
    isSVGProperty(name) {
        name = name.toLowerCase();
        return __classPrivateFieldGet(this, _CSSMetadata_svgProperties, "f").has(name);
    }
    getLonghands(shorthand) {
        return __classPrivateFieldGet(this, _CSSMetadata_longhands, "f").get(shorthand) || null;
    }
    getShorthands(longhand) {
        return __classPrivateFieldGet(this, _CSSMetadata_shorthands, "f").get(longhand) || null;
    }
    ...
    canonicalPropertyName(name) {
        ...
        name = name.toLowerCase();
        const aliasFor = __classPrivateFieldGet(this, _CSSMetadata_aliasesFor, "f").get(name);
        if (aliasFor) {
            return aliasFor;
        }
        ...
        if (!match || !__classPrivateFieldGet(this, _CSSMetadata_valuesSet, "f").has(match[1])) {
            return name;
        }
        return match[1];
    }
    isCSSPropertyName(propertyName) {
        ...
        return __classPrivateFieldGet(this, _CSSMetadata_valuesSet, "f").has(propertyName);
    }
    isPropertyInherited(propertyName) {
        propertyName = propertyName.toLowerCase();
        return propertyName.startsWith('--') || __classPrivateFieldGet(this, _CSSMetadata_inherited, "f").has(this.canonicalPropertyName(propertyName)) ||
            __classPrivateFieldGet(this, _CSSMetadata_inherited, "f").has(propertyName);
    }
    specificPropertyValues(propertyName) {
        const unprefixedName = propertyName.replace(/^-webkit-/, '');
        const propertyValues = __classPrivateFieldGet(this, _CSSMetadata_propertyValues, "f");
...
_CSSMetadata_values = new WeakMap(), _CSSMetadata_longhands = new WeakMap(), _CSSMetadata_shorthands = new WeakMap(), _CSSMetadata_inherited = new WeakMap(), _CSSMetadata_svgProperties = new WeakMap(), _CSSMetadata_propertyValues = new WeakMap(), _CSSMetadata_aliasesFor = new WeakMap(), _CSSMetadata_nameValuePresets = new WeakMap(), _CSSMetadata_nameValuePresetsIncludingSVG = new WeakMap(), _CSSMetadata_valuesSet = new WeakMap();
