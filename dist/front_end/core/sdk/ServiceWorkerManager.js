...
var _ServiceWorkerManager_agent, _ServiceWorkerManager_registrationsInternal, _ServiceWorkerManager_enabled, _ServiceWorkerManager_forceUpdateSetting, _ServiceWorkerDispatcher_manager, _ServiceWorkerRegistration_fingerprintInternal, _ServiceWorkerContextNamer_target, _ServiceWorkerContextNamer_serviceWorkerManager, _ServiceWorkerContextNamer_versionByTargetId;
...
export class ServiceWorkerManager extends SDKModel {
    constructor(target) {
        super(target);
        _ServiceWorkerManager_agent.set(this, void 0);
        _ServiceWorkerManager_registrationsInternal.set(this, new Map());
        _ServiceWorkerManager_enabled.set(this, false);
        _ServiceWorkerManager_forceUpdateSetting.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _ServiceWorkerManager_agent, target.serviceWorkerAgent(), "f");
        void this.enable();
        __classPrivateFieldSet(this, _ServiceWorkerManager_forceUpdateSetting, Common.Settings.Settings.instance().createSetting('service-worker-update-on-reload', false), "f");
        if (__classPrivateFieldGet(this, _ServiceWorkerManager_forceUpdateSetting, "f").get()) {
            this.forceUpdateSettingChanged();
        }
        __classPrivateFieldGet(this, _ServiceWorkerManager_forceUpdateSetting, "f").addChangeListener(this.forceUpdateSettingChanged, this);
        new ServiceWorkerContextNamer(target, this);
    }
    async enable() {
        if (__classPrivateFieldGet(this, _ServiceWorkerManager_enabled, "f")) {
            return;
        }
        __classPrivateFieldSet(this, _ServiceWorkerManager_enabled, true, "f");
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_enable();
    }
    async disable() {
        if (!__classPrivateFieldGet(this, _ServiceWorkerManager_enabled, "f")) {
            return;
        }
        __classPrivateFieldSet(this, _ServiceWorkerManager_enabled, false, "f");
        __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").clear();
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_enable();
    }
    registrations() {
        return __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f");
    }
    ...
    deleteRegistration(registrationId) {
        const registration = __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").get(registrationId);
        if (!registration) {
            return;
        }
        if (registration.isRedundant()) {
            __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").delete(registrationId);
    ...
    async updateRegistration(registrationId) {
        ...
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_updateRegistration({ scopeURL: registration.scopeURL });
    }
    async deliverPushMessage(registrationId, data) {
        ...
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_deliverPushMessage({ origin, registrationId, data });
    }
    async dispatchSyncEvent(registrationId, tag, lastChance) {
        ...
        const origin = Common.ParsedURL.ParsedURL.extractOrigin(registration.scopeURL);
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_dispatchSyncEvent({ origin, registrationId, tag, lastChance });
    }
    async dispatchPeriodicSyncEvent(registrationId, tag) {
        ...
        const origin = Common.ParsedURL.ParsedURL.extractOrigin(registration.scopeURL);
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_dispatchPeriodicSyncEvent({ origin, registrationId, tag });
    }
    async unregister(scopeURL) {
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_unregister({ scopeURL });
    }
    async startWorker(scopeURL) {
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_startWorker({ scopeURL });
    }
    async skipWaiting(scopeURL) {
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_skipWaiting({ scopeURL });
    }
    async stopWorker(versionId) {
        await __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_stopWorker({ versionId });
    }
    workerRegistrationUpdated(registrations) {
        for (const payload of registrations) {
            let registration = __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").get(payload.registrationId);
            if (!registration) {
                registration = new ServiceWorkerRegistration(payload);
                __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").set(payload.registrationId, registration);
            ...
            if (registration.shouldBeRemoved()) {
                __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").delete(registration.id);
                this.dispatchEventToListeners("RegistrationDeleted" /* Events.REGISTRATION_DELETED */, registration);
            }
            else {
                this.dispatchEventToListeners("RegistrationUpdated" /* Events.REGISTRATION_UPDATED */, registration);
    ...
    workerVersionUpdated(versions) {
        ...
        for (const payload of versions) {
            const registration = __classPrivateFieldGet(this, _ServiceWorkerManager_registrationsInternal, "f").get(payload.registrationId);
            if (!registration) {
                continue;
            }
    ...
    forceUpdateSettingChanged() {
        const forceUpdateOnPageLoad = __classPrivateFieldGet(this, _ServiceWorkerManager_forceUpdateSetting, "f").get();
        void __classPrivateFieldGet(this, _ServiceWorkerManager_agent, "f").invoke_setForceUpdateOnPageLoad({ forceUpdateOnPageLoad });
    }
}
_ServiceWorkerManager_agent = new WeakMap(), _ServiceWorkerManager_registrationsInternal = new WeakMap(), _ServiceWorkerManager_enabled = new WeakMap(), _ServiceWorkerManager_forceUpdateSetting = new WeakMap();
export var Events;
(function (Events) {
...
class ServiceWorkerDispatcher {
    constructor(manager) {
        _ServiceWorkerDispatcher_manager.set(this, void 0);
        __classPrivateFieldSet(this, _ServiceWorkerDispatcher_manager, manager, "f");
    }
    workerRegistrationUpdated({ registrations }) {
        __classPrivateFieldGet(this, _ServiceWorkerDispatcher_manager, "f").workerRegistrationUpdated(registrations);
    }
    workerVersionUpdated({ versions }) {
        __classPrivateFieldGet(this, _ServiceWorkerDispatcher_manager, "f").workerVersionUpdated(versions);
    }
    workerErrorReported({ errorMessage }) {
        __classPrivateFieldGet(this, _ServiceWorkerDispatcher_manager, "f").workerErrorReported(errorMessage);
    }
}
_ServiceWorkerDispatcher_manager = new WeakMap();
/**
...
export class ServiceWorkerRegistration {
    constructor(payload) {
        _ServiceWorkerRegistration_fingerprintInternal.set(this, void 0);
    ...
    update(payload) {
        __classPrivateFieldSet(this, _ServiceWorkerRegistration_fingerprintInternal, Symbol('fingerprint'), "f");
    ...
    fingerprint() {
        return __classPrivateFieldGet(this, _ServiceWorkerRegistration_fingerprintInternal, "f");
    }
    versionsByMode() {
...
_ServiceWorkerRegistration_fingerprintInternal = new WeakMap();
class ServiceWorkerContextNamer {
    constructor(target, serviceWorkerManager) {
        _ServiceWorkerContextNamer_target.set(this, void 0);
        _ServiceWorkerContextNamer_serviceWorkerManager.set(this, void 0);
        _ServiceWorkerContextNamer_versionByTargetId.set(this, new Map());
        __classPrivateFieldSet(this, _ServiceWorkerContextNamer_target, target, "f");
        __classPrivateFieldSet(this, _ServiceWorkerContextNamer_serviceWorkerManager, serviceWorkerManager, "f");
    ...
    registrationsUpdated() {
        __classPrivateFieldGet(this, _ServiceWorkerContextNamer_versionByTargetId, "f").clear();
        const registrations = __classPrivateFieldGet(this, _ServiceWorkerContextNamer_serviceWorkerManager, "f").registrations().values();
        for (const registration of registrations) {
            for (const version of registration.versions.values()) {
                if (version.targetId) {
                    __classPrivateFieldGet(this, _ServiceWorkerContextNamer_versionByTargetId, "f").set(version.targetId, version);
                }
            }
        }
    ...
    executionContextCreated(event) {
        ...
        this.updateContextLabel(executionContext, __classPrivateFieldGet(this, _ServiceWorkerContextNamer_versionByTargetId, "f").get(serviceWorkerTargetId) || null);
    }
    serviceWorkerTargetId(target) {
        if (target.parentTarget() !== __classPrivateFieldGet(this, _ServiceWorkerContextNamer_target, "f") || target.type() !== Type.ServiceWorker) {
            return null;
        }
        return target.id();
    }
    updateAllContextLabels() {
        for (const target of TargetManager.instance().targets()) {
            ...
            const version = __classPrivateFieldGet(this, _ServiceWorkerContextNamer_versionByTargetId, "f").get(serviceWorkerTargetId) || null;
...
_ServiceWorkerContextNamer_target = new WeakMap(), _ServiceWorkerContextNamer_serviceWorkerManager = new WeakMap(), _ServiceWorkerContextNamer_versionByTargetId = new WeakMap();
