...
export var EncodedOriginalScopeFlag;
(function (EncodedOriginalScopeFlag) {
    EncodedOriginalScopeFlag[EncodedOriginalScopeFlag["HAS_NAME"] = 1] = "HAS_NAME";
    EncodedOriginalScopeFlag[EncodedOriginalScopeFlag["HAS_KIND"] = 2] = "HAS_KIND";
    EncodedOriginalScopeFlag[EncodedOriginalScopeFlag["IS_STACK_FRAME"] = 4] = "IS_STACK_FRAME";
...
export var EncodedGeneratedRangeFlag;
(function (EncodedGeneratedRangeFlag) {
    EncodedGeneratedRangeFlag[EncodedGeneratedRangeFlag["HAS_DEFINITION"] = 1] = "HAS_DEFINITION";
    EncodedGeneratedRangeFlag[EncodedGeneratedRangeFlag["HAS_CALLSITE"] = 2] = "HAS_CALLSITE";
    EncodedGeneratedRangeFlag[EncodedGeneratedRangeFlag["IS_STACK_FRAME"] = 4] = "IS_STACK_FRAME";
    EncodedGeneratedRangeFlag[EncodedGeneratedRangeFlag["IS_HIDDEN"] = 8] = "IS_HIDDEN";
