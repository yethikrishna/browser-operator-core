...
var _HostConfigTracker_pollTimer, _HostConfigTracker_aidaAvailability;
...
export class HostConfigTracker extends Common.ObjectWrapper.ObjectWrapper {
    constructor() {
        super();
        _HostConfigTracker_pollTimer.set(this, void 0);
        _HostConfigTracker_aidaAvailability.set(this, void 0);
    }
    static instance() {
    ...
    addEventListener(eventType, listener) {
        ...
        if (isFirst) {
            window.clearTimeout(__classPrivateFieldGet(this, _HostConfigTracker_pollTimer, "f"));
    ...
    async pollAidaAvailability() {
        __classPrivateFieldSet(this, _HostConfigTracker_pollTimer, window.setTimeout(() => this.pollAidaAvailability(), 2000), "f");
        const currentAidaAvailability = await AidaClient.checkAccessPreconditions();
        if (currentAidaAvailability !== __classPrivateFieldGet(this, _HostConfigTracker_aidaAvailability, "f")) {
            __classPrivateFieldSet(this, _HostConfigTracker_aidaAvailability, currentAidaAvailability, "f");
...
_HostConfigTracker_pollTimer = new WeakMap(), _HostConfigTracker_aidaAvailability = new WeakMap();
export var Events;
(function (Events) {
