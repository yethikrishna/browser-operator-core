...
var _InMemoryLineWriter_indentation, _InMemoryLineWriter_currentIndentation, _InMemoryLineWriter_lines, _PuppeteerStringifyExtension_instances, _PuppeteerStringifyExtension_shouldAppendWaitForElementHelper, _PuppeteerStringifyExtension_targetBrowser, _PuppeteerStringifyExtension_appendTarget, _PuppeteerStringifyExtension_appendFrame, _PuppeteerStringifyExtension_appendContext, _PuppeteerStringifyExtension_appendLocators, _PuppeteerStringifyExtension_appendClickStep, _PuppeteerStringifyExtension_appendDoubleClickStep, _PuppeteerStringifyExtension_appendHoverStep, _PuppeteerStringifyExtension_appendChangeStep, _PuppeteerStringifyExtension_appendEmulateNetworkConditionsStep, _PuppeteerStringifyExtension_appendKeyDownStep, _PuppeteerStringifyExtension_appendKeyUpStep, _PuppeteerStringifyExtension_appendCloseStep, _PuppeteerStringifyExtension_appendViewportStep, _PuppeteerStringifyExtension_appendScrollStep, _PuppeteerStringifyExtension_appendStepType, _PuppeteerStringifyExtension_appendNavigationStep, _PuppeteerStringifyExtension_appendWaitExpressionStep, _PuppeteerStringifyExtension_appendWaitForElementStep, _PuppeteerRunnerExtension_instances, _PuppeteerRunnerExtension_ensureAutomationEmulatation, _PuppeteerRunnerExtension_getTimeoutForStep, _Runner_flow, _Runner_extension, _Runner_aborted, _LighthouseStringifyExtension_isProcessingTimespan, _LighthouseRunnerExtension_isTimespanRunning, _LighthouseRunnerExtension_isNavigationRunning, _LighthouseRunnerExtension_lhFlow;
/**
...
class PuppeteerStringifyExtension extends StringifyExtension {
    constructor(targetBrowser = 'chrome') {
        ...
        _PuppeteerStringifyExtension_targetBrowser.set(this, void 0);
        __classPrivateFieldSet(this, _PuppeteerStringifyExtension_targetBrowser, targetBrowser, "f");
    }
    async beforeAllSteps(out, flow) {
        out.appendLine("const puppeteer = require('puppeteer'); // v23.0.0 or later");
        out.appendLine('');
        out.appendLine('(async () => {').startBlock();
        if (__classPrivateFieldGet(this, _PuppeteerStringifyExtension_targetBrowser, "f") === 'firefox') {
...
_PuppeteerStringifyExtension_shouldAppendWaitForElementHelper = new WeakMap(), _PuppeteerStringifyExtension_targetBrowser = new WeakMap(), _PuppeteerStringifyExtension_instances = new WeakSet(), _PuppeteerStringifyExtension_appendTarget = function _PuppeteerStringifyExtension_appendTarget(out, target) {
    if (target === 'main') {
...
class Runner {
    ...
    async runBeforeAllSteps(flow) {
        await __classPrivateFieldGet(this, _Runner_extension, "f").beforeAllSteps?.(flow);
    }
    async runAfterAllSteps(flow) {
        await __classPrivateFieldGet(this, _Runner_extension, "f").afterAllSteps?.(flow);
    }
    /**
