...
export class Type {
    constructor(kind, index = -1, depth = -1) {
        ...
        if ((index === -16 /* TypeKind.funcref */ && kind === -20 /* TypeKind.optref */) ||
            (index === -17 /* TypeKind.externref */ && kind === -20 /* TypeKind.optref */) ||
            (index === -18 /* TypeKind.anyref */ && kind === -20 /* TypeKind.optref */) ||
            (index === -19 /* TypeKind.eqref */ && kind === -20 /* TypeKind.optref */) ||
            (index === -22 /* TypeKind.i31ref */ && kind === -21 /* TypeKind.ref */) ||
            (index === -25 /* TypeKind.dataref */ && kind === -21 /* TypeKind.ref */)) {
            this.kind = index;
            this.index = -1;
        }
    }
...
export class BinaryReader {
    ...
    readTypeInternal(kind) {
        if (kind === -21 /* TypeKind.ref */ ||
            kind === -20 /* TypeKind.optref */ ||
            kind === -24 /* TypeKind.rtt */) {
            var index = this.readHeapType();
            return new Type(kind, index);
        }
        if (kind === -23 /* TypeKind.rtt_d */) {
            var index = this.readHeapType();
    ...
    readBlockType() {
        ...
        return new Type(0 /* TypeKind.unspecified */, func_index);
    }
    readStringBytes() {
    ...
    readFuncSubtype() {
        ...
        result.form = -35 /* TypeKind.func_subtype */;
    ...
    readStructSubtype() {
        ...
        result.form = -36 /* TypeKind.struct_subtype */;
        result.supertype = this.readHeapType();
        return result;
    }
    readArrayType() {
    ...
    readArraySubtype() {
        ...
        result.form = -37 /* TypeKind.array_subtype */;
        result.supertype = this.readHeapType();
        return result;
    }
    ...
    readEventEntry() {
        ...
        this.state = 23 /* BinaryReaderState.EVENT_SECTION_ENTRY */;
    ...
    readCodeOperator_0xfb() {
        ...
        switch (code) {
            ...
            case 64282 /* OperatorCode.array_init_static */:
                ...
                brDepth = this.readVarUint32();
                break;
            case 64336 /* OperatorCode.ref_is_func */:
            case 64337 /* OperatorCode.ref_is_data */:
            case 64338 /* OperatorCode.ref_is_i31 */:
            case 64344 /* OperatorCode.ref_as_func */:
            case 64345 /* OperatorCode.ref_as_data */:
            case 64346 /* OperatorCode.ref_as_i31 */:
