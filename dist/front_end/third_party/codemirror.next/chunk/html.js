import { a as o, b as i, C as e, E as t, e as p, g as n, h as d, i as s, j as c, L as a, N as l, p as r, s as u, t as O } from "./codemirror.js";
import { css as m, cssLanguage as f } from "./css.js";
import { javascript as k, javascriptLanguage as g } from "./javascript.js";
...
function x(e) { return 9 == e || 10 == e || 13 == e || 32 == e; }
let R = null, v = null, w = 0;
function T(e, t) { let a = e.pos + t; if (w == a && v == e)
    return R; let l = e.peek(t); for (; x(l);)
    l = e.peek(++t); let r = ""; for (; 45 == (n = l) || 46 == n || 58 == n || n >= 65 && n <= 90 || 95 == n || n >= 97 && n <= 122 || n >= 161;)
    r += String.fromCharCode(l), l = e.peek(++t); var n; return v = e, w = a, R = r || (l == P || l == y ? void 0 : null); }
const P = 63, y = 33;
function Q(e, t) { this.name = e, this.parent = t, this.hash = t ? t.hash : 0; for (let t = 0; t < e.length; t++)
    this.hash += (this.hash << 4) + e.charCodeAt(t) + (e.charCodeAt(t) << 8); }
const q = [4, 5, 6, 7], C = new e({ start: null, shift: (e, t, a, l) => q.indexOf(t) > -1 ? new Q(T(l, 1) || "", e) : e, reduce: (e, t) => 18 == t && e ? e.parent : e, reuse(e, t, a, l) { let r = t.type.id; return 4 == r || 35 == r ? new Q(T(l, 1) || "", e) : e; }, hash: e => e ? e.hash : 0, strict: !1 }), X = new t(((e, t) => { if (60 != e.next)
    return void (e.next < 0 && t.context && e.acceptToken(56)); e.advance(); let a = 47 == e.next; a && e.advance(); let l = T(e, 0); if (void 0 === l)
    return; if (!l)
    return e.acceptToken(a ? 11 : 4); let r = t.context ? t.context.name : null; if (a) {
    if (l == r)
        return e.acceptToken(8);
    if (r && h[r])
        return e.acceptToken(56, -2);
    ...
    if ("style" == l)
        return e.acceptToken(6);
    if ("textarea" == l)
        return e.acceptToken(7);
    r && $[r] && $[r][l] ? e.acceptToken(56, -1) : e.acceptToken(4);
} }), { contextual: !0 }), _ = new t(((e, t) => { let a = 1; if (47 == e.next) {
    if (62 != e.peek(1))
        return;
    a = 2;
}
else if (62 != e.next)
    return; t.context && b[t.context.name] && e.acceptToken(12, a); })), W = new t((e => { for (let t = 0, a = 0;; a++) {
    if (e.next < 0) {
        a && e.acceptToken(57);
        break;
    }
...
function S(e, a, l) { let r = 2 + e.length; return new t((t => { for (let n = 0, o = 0, s = 0;; s++) {
    if (t.next < 0) {
        s && t.acceptToken(a);
        break;
    }
    if (0 == n && 60 == t.next || 1 == n && 47 == t.next || n >= 2 && n < r && t.next == e.charCodeAt(n - 2))
        n++, o++;
    else if (2 != n && n != r || !x(t.next)) {
        if (n == r && 62 == t.next) {
            s > o ? t.acceptToken(a, -o) : t.acceptToken(l, -(o - 2));
            break;
        }
        if ((10 == t.next || 13 == t.next) && s) {
            t.acceptToken(a, 1);
            break;
        }
        n = o = 0;
