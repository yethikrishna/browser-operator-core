...
export class NetworkEventManager {
    ...
    printState() {
        ...
        console.log('httpRequestsMap', JSON.stringify(__classPrivateFieldGet(this, _NetworkEventManager_httpRequestsMap, "f"), replacer, 2));
        console.log('requestWillBeSentMap', JSON.stringify(__classPrivateFieldGet(this, _NetworkEventManager_requestWillBeSentMap, "f"), replacer, 2));
        console.log('requestWillBeSentMap', JSON.stringify(__classPrivateFieldGet(this, _NetworkEventManager_responseReceivedExtraInfoMap, "f"), replacer, 2));
        console.log('requestWillBeSentMap', JSON.stringify(__classPrivateFieldGet(this, _NetworkEventManager_requestPausedMap, "f"), replacer, 2));
    }
}
