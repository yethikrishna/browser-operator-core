...
export class DeviceRequestPromptManager {
    ...
    constructor(client, timeoutSettings) {
        ...
        _DeviceRequestPromptManager_deviceRequestPromptDeferreds.set(this, new Set());
    ...
    async waitForDevicePrompt(options = {}) {
        ...
        const needsEnable = __classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f").size === 0;
        let enablePromise;
        if (needsEnable) {
        ...
        __classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f").add(deferred);
        try {
            ...
            __classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f").delete(deferred);
        }
    }
}
_DeviceRequestPromptManager_client = new WeakMap(), _DeviceRequestPromptManager_timeoutSettings = new WeakMap(), _DeviceRequestPromptManager_deviceRequestPromptDeferreds = new WeakMap(), _DeviceRequestPromptManager_instances = new WeakSet(), _DeviceRequestPromptManager_onDeviceRequestPrompted = function _DeviceRequestPromptManager_onDeviceRequestPrompted(event) {
    if (!__classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f").size) {
        return;
    }
    ...
    for (const promise of __classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f")) {
        promise.resolve(devicePrompt);
    }
    __classPrivateFieldGet(this, _DeviceRequestPromptManager_deviceRequestPromptDeferreds, "f").clear();
};
