...
export class LifecycleWatcher {
    constructor(networkManager, frame, waitUntil, timeout, signal) {
        ...
        _LifecycleWatcher_subscriptions.set(this, new DisposableStack());
        ...
        const frameManagerEmitter = __classPrivateFieldGet(this, _LifecycleWatcher_subscriptions, "f").use(new EventEmitter(frame._frameManager));
        frameManagerEmitter.on(FrameManagerEvent.LifecycleEvent, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).bind(this));
        const frameEmitter = __classPrivateFieldGet(this, _LifecycleWatcher_subscriptions, "f").use(new EventEmitter(frame));
        frameEmitter.on(FrameEvent.FrameNavigatedWithinDocument, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_navigatedWithinDocument).bind(this));
        frameEmitter.on(FrameEvent.FrameNavigated, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_navigated).bind(this));
        frameEmitter.on(FrameEvent.FrameSwapped, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_frameSwapped).bind(this));
        frameEmitter.on(FrameEvent.FrameSwappedByActivation, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_frameSwapped).bind(this));
        frameEmitter.on(FrameEvent.FrameDetached, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_onFrameDetached).bind(this));
        const networkManagerEmitter = __classPrivateFieldGet(this, _LifecycleWatcher_subscriptions, "f").use(new EventEmitter(networkManager));
        networkManagerEmitter.on(NetworkManagerEvent.Request, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_onRequest).bind(this));
        networkManagerEmitter.on(NetworkManagerEvent.Response, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_onResponse).bind(this));
        networkManagerEmitter.on(NetworkManagerEvent.RequestFailed, __classPrivateFieldGet(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_onRequestFailed).bind(this));
