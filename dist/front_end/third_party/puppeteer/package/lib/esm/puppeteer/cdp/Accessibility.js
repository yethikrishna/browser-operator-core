...
var _Accessibility_realm, _Accessibility_frameId, _AXNode_instances, _AXNode_richlyEditable, _AXNode_editable, _AXNode_focusable, _AXNode_hidden, _AXNode_name, _AXNode_role, _AXNode_ignored, _AXNode_cachedHasFocusableChild, _AXNode_realm, _AXNode_isPlainTextField, _AXNode_isTextOnlyObject, _AXNode_hasFocusableChild;
/**
 * @license
...
export class Accessibility {
    ...
    constructor(realm, frameId = '') {
        ...
        _Accessibility_frameId.set(this, void 0);
        __classPrivateFieldSet(this, _Accessibility_realm, realm, "f");
        __classPrivateFieldSet(this, _Accessibility_frameId, frameId, "f");
    }
    /**
    ...
    async snapshot(options = {}) {
        ...
        const { nodes } = await __classPrivateFieldGet(this, _Accessibility_realm, "f").environment.client.send('Accessibility.getFullAXTree', {
            frameId: __classPrivateFieldGet(this, _Accessibility_frameId, "f"),
        });
        let backendNodeId;
        if (root) {
        ...
        const populateIframes = async (root) => {
            if (root.payload.role?.value === 'Iframe') {
                ...
                try {
                    ...
                    const handle = __addDisposableResource(env_1, (await __classPrivateFieldGet(this, _Accessibility_realm, "f").adoptBackendNode(root.payload.backendDOMNodeId)), false);
...
_Accessibility_realm = new WeakMap(), _Accessibility_frameId = new WeakMap();
class AXNode {
