...
class FrameManager extends EventEmitter_js_1.EventEmitter {
    ...
    constructor(client, page, timeoutSettings) {
        ...
        __classPrivateFieldSet(this, _FrameManager_networkManager, new NetworkManager_js_1.NetworkManager(this, page.browser().isNetworkEnabled()), "f");
        ...
        client.once(CDPSession_js_1.CDPSessionEvent.Disconnected, () => {
            __classPrivateFieldGet(this, _FrameManager_instances, "m", _FrameManager_onClientDisconnect).call(this).catch(util_js_1.debugError);
        });
    }
    /**
    ...
    async swapFrameTree(client) {
        ...
        if (frame) {
            __classPrivateFieldGet(this, _FrameManager_frameNavigatedReceived, "f").add(__classPrivateFieldGet(this, _FrameManager_client, "f").target()._targetId);
            this._frameTree.removeFrame(frame);
            frame.updateId(__classPrivateFieldGet(this, _FrameManager_client, "f").target()._targetId);
    ...
    async initialize(client, frame) {
        try {
            ...
            __classPrivateFieldSet(this, _FrameManager_frameTreeHandled, Deferred_js_1.Deferred.create(), "f");
            ...
            await Promise.all([
                ...
                client.send('Runtime.enable').then(() => {
                    return __classPrivateFieldGet(this, _FrameManager_instances, "m", _FrameManager_createIsolatedWorld).call(this, client, util_js_1.UTILITY_WORLD_NAME);
                }),
                ...(frame
...
async function _FrameManager_onClientDisconnect() {
    ...
    if (!__classPrivateFieldGet(this, _FrameManager_page, "f").browser().connected) {
    ...
    if (isMainFrame) {
        if (frame) {
            ...
            frame = new Frame_js_2.CdpFrame(this, frameId, undefined, __classPrivateFieldGet(this, _FrameManager_client, "f"));
        }
        this._frameTree.addFrame(frame);
    }
    ...
    const context = new ExecutionContext_js_1.ExecutionContext(frame?.client || __classPrivateFieldGet(this, _FrameManager_client, "f"), contextPayload, world);
