...
let ElementHandle = (() => {
    ...
    return _a = class ElementHandle extends _classSuper {
            ...
            constructor(handle) {
                 ...
                 */
                this.isolatedHandle = __runInitializers(this, _instanceExtraInitializers);
                this.handle = handle;
          ...
          @keyframes colorChange {
            ...
            async isIntersectingViewport(options = {}) {
                ...
                try {
                    ...
                    const target = __addDisposableResource(env_5, handle && (await __classPrivateFieldGet(handle, _ElementHandle_instances, "m", _ElementHandle_getOwnerSVGElement).call(handle)), false);
