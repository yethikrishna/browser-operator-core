...
let UserPrompt = (() => {
    ...
    return _a = class UserPrompt extends _classSuper {
            ...
            constructor(context, info) {
                ...
                _UserPrompt_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            [(_UserPrompt_reason = new WeakMap(), _UserPrompt_result = new WeakMap(), _UserPrompt_disposables = new WeakMap(), _UserPrompt_instances = new WeakSet(), _UserPrompt_initialize = function _UserPrompt_initialize() {
                const browserContextEmitter = __classPrivateFieldGet(this, _UserPrompt_disposables, "f").use(new EventEmitter_js_1.EventEmitter(this.browsingContext));
                browserContextEmitter.once('closed', ({ reason }) => {
                    this.dispose(`User prompt already closed: ${reason}`);
                });
                const sessionEmitter = __classPrivateFieldGet(this, _UserPrompt_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _UserPrompt_instances, "a", _UserPrompt_session_get)));
