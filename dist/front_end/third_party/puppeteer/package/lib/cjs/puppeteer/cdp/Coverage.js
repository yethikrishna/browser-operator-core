...
class JSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _JSCoverage_subscriptions, new disposable_js_1.DisposableStack(), "f");
        const clientEmitter = __classPrivateFieldGet(this, _JSCoverage_subscriptions, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _JSCoverage_client, "f")));
...
class CSSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _CSSCoverage_eventListeners, new disposable_js_1.DisposableStack(), "f");
        const clientEmitter = __classPrivateFieldGet(this, _CSSCoverage_eventListeners, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _CSSCoverage_client, "f")));
