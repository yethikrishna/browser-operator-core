...
var _WindowRealm_instances, _WindowRealm_workers, _WindowRealm_initialize, _DedicatedWorkerRealm_instances, _DedicatedWorkerRealm_workers, _DedicatedWorkerRealm_initialize, _SharedWorkerRealm_instances, _SharedWorkerRealm_workers, _SharedWorkerRealm_initialize;
/**
 * @license
...
let Realm = (() => {
    ...
    return _b = class Realm extends _classSuper {
            constructor(id, origin) {
                ...
                this.disposables = new disposable_js_1.DisposableStack();
                this.id = id;
                this.origin = origin;
            }
            get disposed() {
            ...
            [(_Realm_reason = new WeakMap(), _dispose_decorators = [decorators_js_1.inertIfDisposed], _disown_decorators = [(0, decorators_js_1.throwIfDisposed)(realm => {
...
_DedicatedWorkerRealm_workers = new WeakMap(), _DedicatedWorkerRealm_instances = new WeakSet(), _DedicatedWorkerRealm_initialize = function _DedicatedWorkerRealm_initialize() {
    const sessionEmitter = this.disposables.use(new EventEmitter_js_1.EventEmitter(this.session));
