...
let Navigation = (() => {
    ...
    return _b = class Navigation extends _classSuper {
            ...
            constructor(context) {
                ...
                _Navigation_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            [(_Navigation_request = new WeakMap(), _Navigation_navigation = new WeakMap(), _Navigation_browsingContext = new WeakMap(), _Navigation_disposables = new WeakMap(), _Navigation_id = new WeakMap(), _Navigation_instances = new WeakSet(), _Navigation_initialize = function _Navigation_initialize() {
                const browsingContextEmitter = __classPrivateFieldGet(this, _Navigation_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _Navigation_browsingContext, "f")));
                ...
                browsingContextEmitter.on('request', ({ request }) => {
                    ...
                    const requestEmitter = __classPrivateFieldGet(this, _Navigation_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _Navigation_request, "f")));
                    requestEmitter.on('redirect', request => {
                        __classPrivateFieldSet(this, _Navigation_request, request, "f");
                    });
                });
                const sessionEmitter = __classPrivateFieldGet(this, _Navigation_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _Navigation_instances, "a", _Navigation_session_get)));
