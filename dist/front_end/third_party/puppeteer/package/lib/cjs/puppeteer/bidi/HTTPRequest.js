...
class BidiHTTPRequest extends HTTPRequest_js_1.HTTPRequest {
    ...
    initiator() {
        return {
            ...__classPrivateFieldGet(this, _BidiHTTPRequest_request, "f").initiator,
            type: __classPrivateFieldGet(this, _BidiHTTPRequest_request, "f").initiator?.type ?? 'other',
        };
    }
    redirectChain() {
    ...
    timing() {
        return __classPrivateFieldGet(this, _BidiHTTPRequest_request, "f").timing();
    }
    getResponseContent() {
        return __classPrivateFieldGet(this, _BidiHTTPRequest_request, "f").getResponseContent();
    }
}
_BidiHTTPRequest_redirectChain = new WeakMap(), _BidiHTTPRequest_response = new WeakMap(), _BidiHTTPRequest_frame = new WeakMap(), _BidiHTTPRequest_request = new WeakMap(), _BidiHTTPRequest_authenticationHandled = new WeakMap(), _BidiHTTPRequest_handleAuthentication = new WeakMap(), _BidiHTTPRequest_instances = new WeakSet(), _BidiHTTPRequest_initialize = function _BidiHTTPRequest_initialize() {
    ...
    __classPrivateFieldGet(this, _BidiHTTPRequest_request, "f").once('success', data => {
        __classPrivateFieldSet(this, _BidiHTTPRequest_response, HTTPResponse_js_1.BidiHTTPResponse.from(data, this, __classPrivateFieldGet(this, _BidiHTTPRequest_frame, "f").page().browser().cdpSupported), "f");
    });
    ...
    __classPrivateFieldGet(this, _BidiHTTPRequest_frame, "f").page().trustedEmitter.emit("request" /* PageEvent.Request */, this);
