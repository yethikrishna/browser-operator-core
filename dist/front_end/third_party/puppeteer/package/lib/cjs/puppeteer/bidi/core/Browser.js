...
let Browser = (() => {
    ...
    return _a = class Browser extends _classSuper {
            ...
            constructor(session) {
                ...
                _Browser_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            get defaultUserContext() {
                ...
                return __classPrivateFieldGet(this, _Browser_userContexts, "f").get(UserContext_js_1.UserContext.DEFAULT);
            }
            get disconnected() {
            ...
            [(_Browser_closed = new WeakMap(), _Browser_reason = new WeakMap(), _Browser_disposables = new WeakMap(), _Browser_userContexts = new WeakMap(), _Browser_sharedWorkers = new WeakMap(), _Browser_instances = new WeakSet(), _Browser_initialize = async function _Browser_initialize() {
                const sessionEmitter = __classPrivateFieldGet(this, _Browser_disposables, "f").use(new EventEmitter_js_1.EventEmitter(this.session));
                ...
                sessionEmitter.on('script.realmCreated', info => {
                    ...
                    __classPrivateFieldGet(this, _Browser_sharedWorkers, "f").set(info.realm, Realm_js_1.SharedWorkerRealm.from(this, info.realm, info.origin));
                });
                ...
                const userContextEmitter = __classPrivateFieldGet(this, _Browser_disposables, "f").use(new EventEmitter_js_1.EventEmitter(userContext));
