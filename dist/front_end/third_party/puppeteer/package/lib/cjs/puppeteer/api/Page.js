...
let Page = (() => {
    ...
    return _a = class Page extends _classSuper {
            ...
            constructor() {
                 ...
                 * @internal
                 */
                this._isDragging = (__runInitializers(this, _instanceExtraInitializers), false);
                /**
                 * @internal
                 */
                this._timeoutSettings = new TimeoutSettings_js_1.TimeoutSettings();
                _Page_requestHandlers.set(this, new WeakMap());
                _Page_inflight$.set(this, new rxjs_js_1.ReplaySubject(1));
            ...
            waitForNetworkIdle$(options = {}) {
                ...
                return __classPrivateFieldGet(this, _Page_inflight$, "f").pipe((0, rxjs_js_1.map)(inflight => {
