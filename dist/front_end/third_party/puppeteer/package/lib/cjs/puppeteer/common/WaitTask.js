...
var _WaitTask_world, _WaitTask_polling, _WaitTask_root, _WaitTask_fn, _WaitTask_args, _WaitTask_timeout, _WaitTask_timeoutError, _WaitTask_result, _WaitTask_poller, _WaitTask_signal, _WaitTask_reruns, _WaitTask_onAbortSignal, _TaskManager_tasks;
/**
 * @license
...
class WaitTask {
    constructor(world, options, fn, ...args) {
        ...
        _WaitTask_onAbortSignal.set(this, () => {
        ...
        __classPrivateFieldGet(this, _WaitTask_signal, "f")?.addEventListener('abort', __classPrivateFieldGet(this, _WaitTask_onAbortSignal, "f"), {
            once: true,
        });
        switch (typeof fn) {
            case 'string':
        ...
        if (options.timeout) {
            __classPrivateFieldSet(this, _WaitTask_timeoutError, new Errors_js_1.TimeoutError(`Waiting failed: ${options.timeout}ms exceeded`), "f");
    ...
    async terminate(error) {
        ...
        __classPrivateFieldGet(this, _WaitTask_signal, "f")?.removeEventListener('abort', __classPrivateFieldGet(this, _WaitTask_onAbortSignal, "f"));
        ...
        if (__classPrivateFieldGet(this, _WaitTask_poller, "f")) {
            try {
                await __classPrivateFieldGet(this, _WaitTask_poller, "f").evaluate(async (poller) => {
                    await poller.stop();
                });
                if (__classPrivateFieldGet(this, _WaitTask_poller, "f")) {
