...
class ExecutionContext extends EventEmitter_js_1.EventEmitter {
    constructor(client, contextPayload, world) {
        ...
        _ExecutionContext_disposables.set(this, new disposable_js_1.DisposableStack());
        // Contains mapping from functions that should be bound to Puppeteer functions.
        _ExecutionContext_bindings.set(this, new Map());
        // If multiple waitFor are set up asynchronously, we need to wait for the
        // first one to set up the binding in the page before running the others.
        _ExecutionContext_mutex.set(this, new Mutex_js_1.Mutex());
        ...
        const clientEmitter = __classPrivateFieldGet(this, _ExecutionContext_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _ExecutionContext_client, "f")));
