...
let CdpFrame = (() => {
    ...
    return _a = class CdpFrame extends _classSuper {
            constructor(frameManager, frameId, parentFrameId, client) {
                ...
                this.worlds[IsolatedWorlds_js_1.MAIN_WORLD].emitter.on('consoleapicalled', __classPrivateFieldGet(this, _CdpFrame_instances, "m", _CdpFrame_onMainWorldConsoleApiCalled).bind(this));
                this.worlds[IsolatedWorlds_js_1.MAIN_WORLD].emitter.on('bindingcalled', __classPrivateFieldGet(this, _CdpFrame_instances, "m", _CdpFrame_onMainWorldBindingCalled).bind(this));
            }
            /**
