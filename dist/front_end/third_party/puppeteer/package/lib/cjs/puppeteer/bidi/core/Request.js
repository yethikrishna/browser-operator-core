...
let Request = (() => {
    ...
    return _b = class Request extends _classSuper {
            ...
            constructor(browsingContext, event) {
                ...
                _Request_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            [(_Request_responseContentPromise = new WeakMap(), _Request_error = new WeakMap(), _Request_redirect = new WeakMap(), _Request_response = new WeakMap(), _Request_browsingContext = new WeakMap(), _Request_disposables = new WeakMap(), _Request_event = new WeakMap(), _Request_instances = new WeakSet(), _Request_initialize = function _Request_initialize() {
                const browsingContextEmitter = __classPrivateFieldGet(this, _Request_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _Request_browsingContext, "f")));
                ...
                const sessionEmitter = __classPrivateFieldGet(this, _Request_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _Request_instances, "a", _Request_session_get)));
