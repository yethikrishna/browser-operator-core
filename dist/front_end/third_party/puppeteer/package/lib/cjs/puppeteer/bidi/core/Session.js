 ...
 */
let Session = (() => {
    var _Session_instances, _a, _Session_reason, _Session_disposables, _Session_info, _Session_connection_accessor_storage, _Session_initialize;
    ...
    return _a = class Session extends _classSuper {
            ...
            constructor(connection, info) {
                ...
                _Session_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            [(_Session_reason = new WeakMap(), _Session_disposables = new WeakMap(), _Session_info = new WeakMap(), _Session_connection_accessor_storage = new WeakMap(), _Session_instances = new WeakSet(), _Session_initialize = async function _Session_initialize() {
