...
class CdpJSHandle extends JSHandle_js_1.JSHandle {
    ...
    async jsonValue() {
        if (!__classPrivateFieldGet(this, _CdpJSHandle_remoteObject, "f").objectId) {
            return (0, utils_js_1.valueFromRemoteObject)(__classPrivateFieldGet(this, _CdpJSHandle_remoteObject, "f"));
        }
    ...
    toString() {
        if (!__classPrivateFieldGet(this, _CdpJSHandle_remoteObject, "f").objectId) {
            return 'JSHandle:' + (0, utils_js_1.valueFromRemoteObject)(__classPrivateFieldGet(this, _CdpJSHandle_remoteObject, "f"));
        }
