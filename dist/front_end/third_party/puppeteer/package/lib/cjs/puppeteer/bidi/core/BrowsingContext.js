...
let BrowsingContext = (() => {
    ...
    return _b = class BrowsingContext extends _classSuper {
            ...
            constructor(context, parent, id, url, originalOpener) {
                ...
                _BrowsingContext_disposables.set(this, new disposable_js_1.DisposableStack());
            ...
            [(_BrowsingContext_navigation = new WeakMap(), _BrowsingContext_reason = new WeakMap(), _BrowsingContext_url = new WeakMap(), _BrowsingContext_children = new WeakMap(), _BrowsingContext_disposables = new WeakMap(), _BrowsingContext_realms = new WeakMap(), _BrowsingContext_requests = new WeakMap(), _BrowsingContext_instances = new WeakSet(), _BrowsingContext_initialize = function _BrowsingContext_initialize() {
                const userContextEmitter = __classPrivateFieldGet(this, _BrowsingContext_disposables, "f").use(new EventEmitter_js_1.EventEmitter(this.userContext));
                userContextEmitter.once('closed', ({ reason }) => {
                    this.dispose(`Browsing context already closed: ${reason}`);
                });
                const sessionEmitter = __classPrivateFieldGet(this, _BrowsingContext_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _BrowsingContext_instances, "a", _BrowsingContext_session_get)));
                ...
                sessionEmitter.on('browsingContext.contextCreated', info => {
                    ...
                    const browsingContextEmitter = __classPrivateFieldGet(this, _BrowsingContext_disposables, "f").use(new EventEmitter_js_1.EventEmitter(browsingContext));
                ...
                sessionEmitter.on('browsingContext.navigationStarted', info => {
                    ...
                    __classPrivateFieldSet(this, _BrowsingContext_navigation, Navigation_js_1.Navigation.from(this), "f");
                    const navigationEmitter = __classPrivateFieldGet(this, _BrowsingContext_disposables, "f").use(new EventEmitter_js_1.EventEmitter(__classPrivateFieldGet(this, _BrowsingContext_navigation, "f")));
