...
let BidiFrame = (() => {
    var _BidiFrame_instances, _b, _BidiFrame_parent, _BidiFrame_frames, _BidiFrame_initialize, _BidiFrame_createFrameTarget, _BidiFrame_detached$, _BidiFrame_exposedFunctions, _BidiFrame_waitForLoad$_get, _BidiFrame_waitForNetworkIdle$_get;
    var _a;
    ...
    return _b = class BidiFrame extends _classSuper {
            static from(parent, browsingContext) {
                const frame = new _b(parent, browsingContext);
            ...
            parentFrame() {
                if (__classPrivateFieldGet(this, _BidiFrame_parent, "f") instanceof _b) {
            ...
            async waitForNavigation(options = {}) {
                ...
                return await (0, rxjs_js_1.firstValueFrom)((0, rxjs_js_1.combineLatest)([
                    (0, rxjs_js_1.race)((0, util_js_1.fromEmitterEvent)(this.browsingContext, 'navigation'), (0, util_js_1.fromEmitterEvent)(this.browsingContext, 'historyUpdated').pipe((0, rxjs_js_1.map)(() => {
                        ...
                        return __classPrivateFieldGet(this, _BidiFrame_instances, "a", _BidiFrame_waitForLoad$_get).call(this, options).pipe((0, rxjs_js_1.delayWhen)(() => {
                            if (frames.length === 0) {
                ...
                }), (0, rxjs_js_1.raceWith)((0, util_js_1.timeout)(ms), (0, util_js_1.fromAbortSignal)(signal), __classPrivateFieldGet(this, _BidiFrame_instances, "m", _BidiFrame_detached$).call(this).pipe((0, rxjs_js_1.map)(() => {
        ...
        _BidiFrame_createFrameTarget = function _BidiFrame_createFrameTarget(browsingContext) {
            const frame = _b.from(this, browsingContext);
        ...
        (() => {
            ...
            __esDecorate(_b, null, _goto_decorators, { kind: "method", name: "goto", static: false, private: false, access: { has: obj => "goto" in obj, get: obj => obj.goto }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_b, null, _setContent_decorators, { kind: "method", name: "setContent", static: false, private: false, access: { has: obj => "setContent" in obj, get: obj => obj.setContent }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_b, null, _waitForNavigation_decorators, { kind: "method", name: "waitForNavigation", static: false, private: false, access: { has: obj => "waitForNavigation" in obj, get: obj => obj.waitForNavigation }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_b, _private_waitForLoad$_descriptor = { value: __setFunctionName(function (options = {}) {
                    ...
                    })).pipe((0, rxjs_js_1.map)(() => { }), (0, rxjs_js_1.first)(), (0, rxjs_js_1.raceWith)((0, util_js_1.timeout)(ms), __classPrivateFieldGet(this, _BidiFrame_instances, "m", _BidiFrame_detached$).call(this).pipe((0, rxjs_js_1.map)(() => {
            ...
            __esDecorate(_b, _private_waitForNetworkIdle$_descriptor = { value: __setFunctionName(function (options = {}) {
                    let { waitUntil = 'load' } = options;
                    if (!Array.isArray(waitUntil)) {
                        waitUntil = [waitUntil];
                    }
