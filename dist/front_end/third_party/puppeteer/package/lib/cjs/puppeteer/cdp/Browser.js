...
class CdpBrowser extends Browser_js_1.Browser {
    ...
    constructor(connection, contextIds, defaultViewport, process, closeCallback, targetFilterCallback, isPageTargetCallback, waitForInitiallyDiscoveredTargets = true, networkEnabled = true) {
        ...
        _CdpBrowser_createTarget.set(this, (targetInfo, session) => {
            ...
            const otherTarget = new Target_js_1.OtherTarget(targetInfo, session, context, __classPrivateFieldGet(this, _CdpBrowser_targetManager, "f"), createSession);
            if (targetInfo.url?.startsWith('devtools://')) {
                return new Target_js_1.DevToolsTarget(targetInfo, session, context, __classPrivateFieldGet(this, _CdpBrowser_targetManager, "f"), createSession, __classPrivateFieldGet(this, _CdpBrowser_defaultViewport, "f") ?? null);
            }
            if (__classPrivateFieldGet(this, _CdpBrowser_isPageTargetCallback, "f").call(this, otherTarget)) {
                return new Target_js_1.PageTarget(targetInfo, session, context, __classPrivateFieldGet(this, _CdpBrowser_targetManager, "f"), createSession, __classPrivateFieldGet(this, _CdpBrowser_defaultViewport, "f") ?? null);
            }
        ...
        __classPrivateFieldSet(this, _CdpBrowser_targetManager, new TargetManager_js_1.TargetManager(connection, __classPrivateFieldGet(this, _CdpBrowser_createTarget, "f"), __classPrivateFieldGet(this, _CdpBrowser_targetFilterCallback, "f"), waitForInitiallyDiscoveredTargets), "f");
        __classPrivateFieldSet(this, _CdpBrowser_defaultContext, new BrowserContext_js_1.CdpBrowserContext(__classPrivateFieldGet(this, _CdpBrowser_connection, "f"), this), "f");
        for (const contextId of contextIds) {
            __classPrivateFieldGet(this, _CdpBrowser_contexts, "f").set(contextId, new BrowserContext_js_1.CdpBrowserContext(__classPrivateFieldGet(this, _CdpBrowser_connection, "f"), this, contextId));
        }
    }
    async _attach(downloadBehavior) {
        __classPrivateFieldGet(this, _CdpBrowser_connection, "f").on(CDPSession_js_1.CDPSessionEvent.Disconnected, __classPrivateFieldGet(this, _CdpBrowser_emitDisconnected, "f"));
        if (downloadBehavior) {
    ...
    _detach() {
        __classPrivateFieldGet(this, _CdpBrowser_connection, "f").off(CDPSession_js_1.CDPSessionEvent.Disconnected, __classPrivateFieldGet(this, _CdpBrowser_emitDisconnected, "f"));
    ...
    async createBrowserContext(options = {}) {
        ...
        const context = new BrowserContext_js_1.CdpBrowserContext(__classPrivateFieldGet(this, _CdpBrowser_connection, "f"), this, browserContextId);
        if (downloadBehavior) {
