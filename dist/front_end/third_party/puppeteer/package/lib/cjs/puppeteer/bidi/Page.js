 ...
 */
let BidiPage = (() => {
    var _BidiPage_instances, _a, _BidiPage_trustedEmitter_accessor_storage, _BidiPage_browserContext, _BidiPage_frame, _BidiPage_viewport, _BidiPage_workers, _BidiPage_cdpEmulationManager, _BidiPage_emulatedNetworkConditions, _BidiPage_fileChooserDeferreds, _BidiPage_initialize, _BidiPage_userAgentInterception, _BidiPage_userAgentPreloadScript, _BidiPage_userInterception, _BidiPage_extraHeadersInterception, _BidiPage_authInterception, _BidiPage_toggleInterception, _BidiPage_applyNetworkConditions, _BidiPage_go;
    ...
    return _a = class BidiPage extends _classSuper {
            ...
            constructor(browserContext, browsingContext) {
                ...
                _BidiPage_trustedEmitter_accessor_storage.set(this, __runInitializers(this, _trustedEmitter_initializers, new EventEmitter_js_1.EventEmitter()));
                ...
                __classPrivateFieldSet(this, _BidiPage_frame, Frame_js_1.BidiFrame.from(this, browsingContext), "f");
                __classPrivateFieldSet(this, _BidiPage_cdpEmulationManager, new EmulationManager_js_1.EmulationManager(__classPrivateFieldGet(this, _BidiPage_frame, "f").client), "f");
                this.tracing = new Tracing_js_1.Tracing(__classPrivateFieldGet(this, _BidiPage_frame, "f").client);
                this.coverage = new Coverage_js_1.Coverage(__classPrivateFieldGet(this, _BidiPage_frame, "f").client);
            ...
            async pdf(options = {}) {
                ...
                const data = await (0, rxjs_js_1.firstValueFrom)((0, rxjs_js_1.from)(__classPrivateFieldGet(this, _BidiPage_frame, "f").browsingContext.print({
                    background,
                    margin,
        ...
        _BidiPage_fileChooserDeferreds = new WeakMap(),
