...
var _HTTPRequest_instances, _HTTPRequest_canBeIntercepted;
...
class HTTPRequest {
    ...
    async continue(overrides = {}, priority) {
        if (!__classPrivateFieldGet(this, _HTTPRequest_instances, "m", _HTTPRequest_canBeIntercepted).call(this)) {
            return;
        }
        (0, assert_js_1.assert)(this.interception.enabled, 'Request Interception is not enabled!');
...
_HTTPRequest_instances = new WeakSet(), _HTTPRequest_canBeIntercepted = function _HTTPRequest_canBeIntercepted() {
