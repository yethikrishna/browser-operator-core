...
class Connection extends EventEmitter_js_1.EventEmitter {
    constructor(url, transport, delay = 0, timeout, rawErrors = false) {
        ...
        __classPrivateFieldSet(this, _Connection_callbacks, new CallbackRegistry_js_1.CallbackRegistry(), "f");
    ...
    async onMessage(message) {
        ...
        if (object.method === 'Target.attachedToTarget') {
            ...
            const session = new CdpSession_js_1.CdpCDPSession(this, object.params.targetInfo.type, sessionId, object.sessionId, __classPrivateFieldGet(this, _Connection_rawErrors, "f"));
        ...
        if (object.sessionId) {
            ...
            if (object.error) {
                if (__classPrivateFieldGet(this, _Connection_rawErrors, "f")) {
                    ...
                    __classPrivateFieldGet(this, _Connection_callbacks, "f").reject(object.id, (0, ErrorLike_js_1.createProtocolErrorMessage)(object), object.error.message);
                }
            }
            else {
