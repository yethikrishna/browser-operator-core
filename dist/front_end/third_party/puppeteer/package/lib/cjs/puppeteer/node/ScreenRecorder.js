...
let ScreenRecorder = (() => {
    ...
    return _a = class ScreenRecorder extends _classSuper {
            ...
            constructor(page, width, height, { ffmpegPath, speed, scale, crop, format, fps, loop, delay, quality, colors, path, overwrite, } = {}) {
                ...
                __classPrivateFieldSet(this, _ScreenRecorder_process, (0, node_child_process_1.spawn)(ffmpegPath, 
                ...
                __classPrivateFieldSet(this, _ScreenRecorder_lastFrame, (0, rxjs_js_1.lastValueFrom)((0, util_js_1.fromEmitterEvent)(client, 'Page.screencastFrame').pipe((0, rxjs_js_1.tap)(event => {
                ...
                }), (0, rxjs_js_1.takeUntil)((0, rxjs_js_1.fromEvent)(__classPrivateFieldGet(this, _ScreenRecorder_controller, "f").signal, 'abort'))), { defaultValue: [Buffer.from([]), performance.now()] }), "f");
            }
            /**
             * Stops the recorder.
             *
            ...
            async stop() {
                ...
                await __classPrivateFieldGet(this, _ScreenRecorder_page, "f")._stopScreencast().catch(util_js_1.debugError);
            ...
            }, _ScreenRecorder_writeFrame_get = function _ScreenRecorder_writeFrame_get() { return _private_writeFrame_descriptor.value; }, _private_writeFrame_decorators = [(0, decorators_js_1.guarded)()], _stop_decorators = [(0, decorators_js_1.guarded)()], disposable_js_1.asyncDisposeSymbol)]() {
                await this.stop();
            }
        },
        (() => {
