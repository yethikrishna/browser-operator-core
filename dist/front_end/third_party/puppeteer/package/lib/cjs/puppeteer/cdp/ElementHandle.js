...
let CdpElementHandle = (() => {
    var _CdpElementHandle_instances, _a, _CdpElementHandle_backendNodeId, _CdpElementHandle_frameManager_get;
    ...
    return _a = class CdpElementHandle extends _classSuper {
            constructor(world, remoteObject) {
                ...
                _CdpElementHandle_backendNodeId.set(this, __runInitializers(this, _instanceExtraInitializers));
            }
            get realm() {
        ...
        _CdpElementHandle_backendNodeId = new WeakMap(),
