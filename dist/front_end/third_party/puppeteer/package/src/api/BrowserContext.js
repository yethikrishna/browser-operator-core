 ...
 * @public
 */
export var BrowserContextEvent;
...
export class BrowserContext extends EventEmitter {
    ...
    startScreenshot() {
        var _a;
        const mutex = __classPrivateFieldGet(this, _BrowserContext_pageScreenshotMutex, "f") || new Mutex();
    ...
    /** @internal */
    [(_BrowserContext_pageScreenshotMutex = new WeakMap(), _BrowserContext_screenshotOperationsCount = new WeakMap(), disposeSymbol)]() {
