...
export class Locator extends EventEmitter {
     ...
     */
    click(options) {
        return firstValueFrom(__classPrivateFieldGet(this, _Locator_instances, "m", _Locator_click).call(this, options));
    }
    /**
     ...
     */
    fill(value, options) {
        return firstValueFrom(__classPrivateFieldGet(this, _Locator_instances, "m", _Locator_fill).call(this, value, options));
    }
    /**
     * Hovers over the located element.
     */
    hover(options) {
        return firstValueFrom(__classPrivateFieldGet(this, _Locator_instances, "m", _Locator_hover).call(this, options));
    }
    /**
     * Scrolls the located element.
     */
    scroll(options) {
        return firstValueFrom(__classPrivateFieldGet(this, _Locator_instances, "m", _Locator_scroll).call(this, options));
    }
}
...
export class FunctionLocator extends Locator {
    ...
    _wait(options) {
        const signal = options?.signal;
        return defer(() => {
            return from(__classPrivateFieldGet(this, _FunctionLocator_pageOrFrame, "f").waitForFunction(__classPrivateFieldGet(this, _FunctionLocator_func, "f"), {
...
export class FilteredLocator extends DelegatedLocator {
    ...
    _wait(options) {
        return this.delegate._wait(options).pipe(mergeMap(handle => {
            return from(Promise.resolve(__classPrivateFieldGet(this, _FilteredLocator_predicate, "f").call(this, handle, options?.signal))).pipe(filter(value => {
                return value;
            }), map(() => {
...
export class MappedLocator extends DelegatedLocator {
    ...
    _wait(options) {
        return this.delegate._wait(options).pipe(mergeMap(handle => {
            return from(Promise.resolve(__classPrivateFieldGet(this, _MappedLocator_mapper, "f").call(this, handle, options?.signal)));
        }));
    }
}
...
export class NodeLocator extends Locator {
    ...
    _wait(options) {
        const signal = options?.signal;
        return defer(() => {
            return from(__classPrivateFieldGet(this, _NodeLocator_pageOrFrame, "f").waitForSelector(__classPrivateFieldGet(this, _NodeLocator_selector, "f"), {
                visible: false,
                timeout: this._timeout,
                signal,
            }));
            ...
            return value !== null;
        }), throwIfEmpty(), this.operators.conditions([__classPrivateFieldGet(this, _NodeLocator_waitForVisibilityIfNeeded, "f")], signal));
    }
}
...
export class RaceLocator extends Locator {
    ...
    _wait(options) {
        return race(...__classPrivateFieldGet(this, _RaceLocator_locators, "f").map(locator => {
