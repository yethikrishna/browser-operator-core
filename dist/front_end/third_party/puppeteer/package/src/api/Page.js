...
var _Page_instances, _Page_requestHandlers, _Page_inflight$, _Page_screencastSessionCount, _Page_startScreencastPromise, _Page_getNativePixelDimensions;
...
export class Page extends EventEmitter {
    ...
    constructor() {
        ...
        _Page_inflight$.set(this, new ReplaySubject(1));
    ...
    waitForNetworkIdle$(options = {}) {
        ...
        return __classPrivateFieldGet(this, _Page_inflight$, "f").pipe(map(inflight => {
    ...
    async screencast(options = {}) {
        ...
        const [width, height, devicePixelRatio] = await __classPrivateFieldGet(this, _Page_instances, "m", _Page_getNativePixelDimensions).call(this);
        let crop;
        if (options.crop) {
    ...
    async _startScreencast() {
        var _a;
        __classPrivateFieldSet(this, _Page_screencastSessionCount, (_a = __classPrivateFieldGet(this, _Page_screencastSessionCount, "f"), ++_a), "f");
...
], Page.prototype, "screenshot", null);
/**
 * @internal
 */
