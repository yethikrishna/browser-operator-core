...
var _PuppeteerNode_instances, _PuppeteerNode_launcher, _PuppeteerNode_lastLaunchedBrowser, _PuppeteerNode_getLauncher;
...
export class PuppeteerNode extends Puppeteer {
    ...
    constructor(settings) {
        ...
        _PuppeteerNode_lastLaunchedBrowser.set(this, void 0);
        /**
         * @internal
         */
        this.configuration = {};
    ...
    launch(options = {}) {
        ...
        __classPrivateFieldSet(this, _PuppeteerNode_lastLaunchedBrowser, browser, "f");
        switch (browser) {
            case 'chrome':
                this.defaultBrowserRevision = PUPPETEER_REVISIONS.chrome;
                break;
        ...
        __classPrivateFieldSet(this, _PuppeteerNode_launcher, __classPrivateFieldGet(this, _PuppeteerNode_instances, "m", _PuppeteerNode_getLauncher).call(this, browser), "f");
        return __classPrivateFieldGet(this, _PuppeteerNode_launcher, "f").launch(options);
    }
    executablePath(optsOrChannel) {
        if (optsOrChannel === undefined) {
            return __classPrivateFieldGet(this, _PuppeteerNode_instances, "m", _PuppeteerNode_getLauncher).call(this, this.lastLaunchedBrowser).executablePath(undefined, 
            /* validatePath= */ false);
        }
        if (typeof optsOrChannel === 'string') {
            return __classPrivateFieldGet(this, _PuppeteerNode_instances, "m", _PuppeteerNode_getLauncher).call(this, 'chrome').executablePath(optsOrChannel, 
            /* validatePath= */ false);
        }
        return __classPrivateFieldGet(this, _PuppeteerNode_instances, "m", _PuppeteerNode_getLauncher).call(this, optsOrChannel.browser ?? this.lastLaunchedBrowser).resolveExecutablePath(optsOrChannel.headless, /* validatePath= */ false);
    }
    /**
     * @internal
     */
    ...
    get lastLaunchedBrowser() {
        return __classPrivateFieldGet(this, _PuppeteerNode_lastLaunchedBrowser, "f") ?? this.defaultBrowser;
    }
    /**
     ...
     */
    defaultArgs(options = {}) {
        return __classPrivateFieldGet(this, _PuppeteerNode_instances, "m", _PuppeteerNode_getLauncher).call(this, options.browser ?? this.lastLaunchedBrowser).defaultArgs(options);
    }
    /**
...
_PuppeteerNode_launcher = new WeakMap(), _PuppeteerNode_lastLaunchedBrowser = new WeakMap(), _PuppeteerNode_instances = new WeakSet(), _PuppeteerNode_getLauncher = function _PuppeteerNode_getLauncher(browser) {
    if (__classPrivateFieldGet(this, _PuppeteerNode_launcher, "f") && __classPrivateFieldGet(this, _PuppeteerNode_launcher, "f").browser === browser) {
