...
var _ScreenRecorder_instances, _ScreenRecorder_page, _ScreenRecorder_process, _ScreenRecorder_controller, _ScreenRecorder_lastFrame, _ScreenRecorder_fps, _ScreenRecorder_getFormatArgs, _ScreenRecorder_writeFrame;
...
export class ScreenRecorder extends PassThrough {
    ...
    constructor(page, width, height, { ffmpegPath, speed, scale, crop, format, fps, loop, delay, quality, colors, path, overwrite, } = {}) {
        ...
        _ScreenRecorder_page.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _ScreenRecorder_lastFrame, lastValueFrom(fromEmitterEvent(client, 'Page.screencastFrame').pipe(tap(event => {
            ...
            void __classPrivateFieldGet(this, _ScreenRecorder_instances, "m", _ScreenRecorder_writeFrame).call(this, buffer);
    ...
    async stop() {
        ...
        await Promise.all(Array(Math.max(1, Math.round((__classPrivateFieldGet(this, _ScreenRecorder_fps, "f") * (performance.now() - timestamp)) / 1000)))
            .fill(buffer)
            .map(__classPrivateFieldGet(this, _ScreenRecorder_instances, "m", _ScreenRecorder_writeFrame).bind(this)));
    ...
    }, _ScreenRecorder_writeFrame = async function _ScreenRecorder_writeFrame(buffer) {
...
], ScreenRecorder.prototype, "stop", null);
