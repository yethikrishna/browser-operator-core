...
export class JSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _JSCoverage_subscriptions, new DisposableStack(), "f");
        const clientEmitter = __classPrivateFieldGet(this, _JSCoverage_subscriptions, "f").use(new EventEmitter(__classPrivateFieldGet(this, _JSCoverage_client, "f")));
...
export class CSSCoverage {
    ...
    async start(options = {}) {
        ...
        __classPrivateFieldSet(this, _CSSCoverage_eventListeners, new DisposableStack(), "f");
        const clientEmitter = __classPrivateFieldGet(this, _CSSCoverage_eventListeners, "f").use(new EventEmitter(__classPrivateFieldGet(this, _CSSCoverage_client, "f")));
