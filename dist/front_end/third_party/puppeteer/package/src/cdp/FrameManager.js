...
export class FrameManager extends EventEmitter {
    ...
    constructor(client, page, timeoutSettings) {
        ...
        __classPrivateFieldSet(this, _FrameManager_networkManager, new NetworkManager(this, page.browser().isNetworkEnabled()), "f");
        ...
        client.once(CDPSessionEvent.Disconnected, () => {
            __classPrivateFieldGet(this, _FrameManager_instances, "m", _FrameManager_onClientDisconnect).call(this).catch(debugError);
        });
    }
    /**
    ...
    async initialize(client, frame) {
        try {
            ...
            __classPrivateFieldSet(this, _FrameManager_frameTreeHandled, Deferred.create(), "f");
...
async function _FrameManager_onClientDisconnect() {
    ...
    const context = new ExecutionContext(frame?.client || __classPrivateFieldGet(this, _FrameManager_client, "f"), contextPayload, world);
