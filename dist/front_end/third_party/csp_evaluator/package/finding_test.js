...
describe('Test finding', () => {
    ...
    it('GetHighestSeverity', () => {
        const finding1 = new Finding(Type.MISSING_SEMICOLON, 'description', Severity.HIGH, Directive.SCRIPT_SRC);
        const finding2 = new Finding(Type.MISSING_SEMICOLON, 'description', Severity.MEDIUM, Directive.SCRIPT_SRC);
        const finding3 = new Finding(Type.MISSING_SEMICOLON, 'description', Severity.INFO, Directive.SCRIPT_SRC);
