    ...
    async render() {
      ...
      <devtools-data-grid striped>
        <table>
          ...
          ${__classPrivateFieldGet(this, _WebBundleInfoView_webBundleInfo, "f").resourceUrls?.map(url => {
      ...
      </devtools-data-grid>`, __classPrivateFieldGet(this, _WebBundleInfoView_shadow, "f"), { host: this });
        // clang-format on
    }
}
