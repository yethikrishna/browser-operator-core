...
export class RecordingStorage {
    constructor() {
        ...
        _RecordingStorage_mutex.set(this, new Common.Mutex.Mutex());
        _RecordingStorage_idGenerator.set(this, new UUIDGenerator());
        __classPrivateFieldSet(this, _RecordingStorage_recordingsSetting, Common.Settings.Settings.instance().createSetting('recorder-recordings-ng', []), "f");
    }
    clearForTest() {
