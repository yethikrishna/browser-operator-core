...
var _CSSOverviewCompletedView_instances, _a, _CSSOverviewCompletedView_selectedSection, _CSSOverviewCompletedView_cssModel, _CSSOverviewCompletedView_domModel, _CSSOverviewCompletedView_linkifier, _CSSOverviewCompletedView_viewMap, _CSSOverviewCompletedView_data, _CSSOverviewCompletedView_view, _CSSOverviewCompletedView_viewOutput, _CSSOverviewCompletedView_onSectionSelected, _CSSOverviewCompletedView_onReset, _CSSOverviewCompletedView_reset, _CSSOverviewCompletedView_onClick, _CSSOverviewCompletedView_createElementsView, _CSSOverviewCompletedView_sortColorsByLuminance, _CSSOverviewCompletedView_sortFontInfo, _CSSOverviewCompletedView_sortGroupBySize, _ElementDetailsView_domModel, _ElementDetailsView_cssModel, _ElementDetailsView_linkifier, _ElementDetailsView_data, _ElementDetailsView_view;
...
export class CSSOverviewCompletedView extends UI.Widget.VBox {
    constructor(element, view = DEFAULT_VIEW) {
        ...
        this.onReset = () => { };
        _CSSOverviewCompletedView_selectedSection.set(this, 'summary');
        ...
        _CSSOverviewCompletedView_view.set(this, void 0);
        _CSSOverviewCompletedView_viewOutput.set(this, {
            revealSection: new Map(),
            closeAllTabs: () => { },
            addTab: (_id, _tabTitle, _view, _jslogContext) => { }
        });
        __classPrivateFieldSet(this, _CSSOverviewCompletedView_view, view, "f");
        this.registerRequiredCSS(cssOverviewCompletedViewStyles);
        __classPrivateFieldSet(this, _CSSOverviewCompletedView_linkifier, new Components.Linkifier.Linkifier(/* maxLinkLength */ 20, /* useLinkDecorator */ true), "f");
    ...
    performUpdate() {
        if (!__classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f") || !('backgroundColors' in __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f")) || !('textColors' in __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f"))) {
            return;
        }
        const viewInput = {
            elementCount: __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").elementCount,
            backgroundColors: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortColorsByLuminance).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").backgroundColors),
            textColors: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortColorsByLuminance).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").textColors),
            textColorContrastIssues: __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").textColorContrastIssues,
            fillColors: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortColorsByLuminance).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").fillColors),
            borderColors: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortColorsByLuminance).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").borderColors),
            globalStyleStats: __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").globalStyleStats,
            mediaQueries: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortGroupBySize).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").mediaQueries),
            unusedDeclarations: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortGroupBySize).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").unusedDeclarations),
            fontInfo: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortFontInfo).call(this, __classPrivateFieldGet(this, _CSSOverviewCompletedView_data, "f").fontInfo),
            selectedSection: __classPrivateFieldGet(this, _CSSOverviewCompletedView_selectedSection, "f"),
            onClick: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_onClick).bind(this),
            onSectionSelected: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_onSectionSelected).bind(this),
            onReset: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_onReset).bind(this),
        };
        __classPrivateFieldGet(this, _CSSOverviewCompletedView_view, "f").call(this, viewInput, __classPrivateFieldGet(this, _CSSOverviewCompletedView_viewOutput, "f"), this.element);
    }
...
_a = CSSOverviewCompletedView, _CSSOverviewCompletedView_selectedSection = new WeakMap(), _CSSOverviewCompletedView_cssModel = new WeakMap(), _CSSOverviewCompletedView_domModel = new WeakMap(), _CSSOverviewCompletedView_linkifier = new WeakMap(), _CSSOverviewCompletedView_viewMap = new WeakMap(), _CSSOverviewCompletedView_data = new WeakMap(), _CSSOverviewCompletedView_view = new WeakMap(), _CSSOverviewCompletedView_viewOutput = new WeakMap(), _CSSOverviewCompletedView_instances = new WeakSet(), _CSSOverviewCompletedView_onSectionSelected = function _CSSOverviewCompletedView_onSectionSelected(sectionId, withKeyboard) {
    const revealSection = __classPrivateFieldGet(this, _CSSOverviewCompletedView_viewOutput, "f").revealSection.get(sectionId);
    if (!revealSection) {
        return;
    }
    revealSection(withKeyboard);
}, _CSSOverviewCompletedView_onReset = function _CSSOverviewCompletedView_onReset() {
    __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_reset).call(this);
    this.onReset();
}, _CSSOverviewCompletedView_reset = function _CSSOverviewCompletedView_reset() {
    __classPrivateFieldGet(this, _CSSOverviewCompletedView_viewOutput, "f").closeAllTabs();
    __classPrivateFieldSet(this, _CSSOverviewCompletedView_viewMap, new Map(), "f");
    _a.pushedNodes.clear();
    __classPrivateFieldSet(this, _CSSOverviewCompletedView_selectedSection, 'summary', "f");
    this.requestUpdate();
    ...
    evt.consume();
    __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_createElementsView).call(this, payload);
    this.requestUpdate();
}, _CSSOverviewCompletedView_createElementsView = function _CSSOverviewCompletedView_createElementsView(payload) {
    let id = '';
    let tabTitle = '';
    switch (payload.type) {
        case 'contrast': {
    ...
    if (!view) {
        ...
        view = new ElementDetailsView(__classPrivateFieldGet(this, _CSSOverviewCompletedView_domModel, "f"), __classPrivateFieldGet(this, _CSSOverviewCompletedView_cssModel, "f"), __classPrivateFieldGet(this, _CSSOverviewCompletedView_linkifier, "f"));
        view.data = payload.nodes;
        __classPrivateFieldGet(this, _CSSOverviewCompletedView_viewMap, "f").set(id, view);
    }
    __classPrivateFieldGet(this, _CSSOverviewCompletedView_viewOutput, "f").addTab(id, tabTitle, view, payload.type);
...
}, _CSSOverviewCompletedView_sortFontInfo = function _CSSOverviewCompletedView_sortFontInfo(fontInfo) {
    ...
    return fonts.map(([font, fontMetrics]) => {
        ...
        return {
            ...
            fontMetrics: fontMetricInfo.map(([label, values]) => {
                return { label, values: __classPrivateFieldGet(this, _CSSOverviewCompletedView_instances, "m", _CSSOverviewCompletedView_sortGroupBySize).call(this, values) };
            })
        };
    });
}, _CSSOverviewCompletedView_sortGroupBySize = function _CSSOverviewCompletedView_sortGroupBySize(items) {
...
export class ElementDetailsView extends UI.Widget.Widget {
    constructor(domModel, cssModel, linkifier, view = ELEMENT_DETAILS_DEFAULT_VIEW) {
        ...
        _ElementDetailsView_data.set(this, void 0);
        _ElementDetailsView_view.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _ElementDetailsView_view, view, "f");
        __classPrivateFieldSet(this, _ElementDetailsView_data, [], "f");
    }
    set data(data) {
        __classPrivateFieldSet(this, _ElementDetailsView_data, data, "f");
        this.requestUpdate();
    }
    async performUpdate() {
        const visibility = new Set();
        if (!__classPrivateFieldGet(this, _ElementDetailsView_data, "f").length) {
            __classPrivateFieldGet(this, _ElementDetailsView_view, "f").call(this, { items: [], visibility }, {}, this.element);
            return;
        }
        const [firstItem] = __classPrivateFieldGet(this, _ElementDetailsView_data, "f");
        ...
        if ('nodeId' in firstItem && visibility.has('node-id')) {
            ...
            // retrieved already.
            const nodeIds = __classPrivateFieldGet(this, _ElementDetailsView_data, "f").reduce((prev, curr) => {
        ...
        const items = await Promise.all(__classPrivateFieldGet(this, _ElementDetailsView_data, "f").map(async (item) => {
            let link, showNode;
            ...
            if ('range' in item && item.range && item.styleSheetId && visibility.has('source-url')) {
                ...
                const styleSheetHeader = __classPrivateFieldGet(this, _ElementDetailsView_cssModel, "f").styleSheetHeaderForId(item.styleSheetId);
                if (styleSheetHeader) {
                    ...
                    link = __classPrivateFieldGet(this, _ElementDetailsView_linkifier, "f").linkifyCSSLocation(matchingSelectorLocation);
                }
            }
...
_ElementDetailsView_domModel = new WeakMap(), _ElementDetailsView_cssModel = new WeakMap(), _ElementDetailsView_linkifier = new WeakMap(), _ElementDetailsView_data = new WeakMap(), _ElementDetailsView_view = new WeakMap();
