...
var _SlowCSSSelector_selectorLocations;
import './Table.js';
...
export class SlowCSSSelector extends BaseInsightComponent {
    constructor() {
        super(...arguments);
        this.internalName = 'slow-css-selector';
        _SlowCSSSelector_selectorLocations.set(this, new Map());
    }
    async toSourceFileLocation(cssModel, selector) {
        ...
        let ranges = __classPrivateFieldGet(this, _SlowCSSSelector_selectorLocations, "f").get(key);
        if (!ranges) {
            ...
            __classPrivateFieldGet(this, _SlowCSSSelector_selectorLocations, "f").set(key, ranges);
        }
...
_SlowCSSSelector_selectorLocations = new WeakMap();
SlowCSSSelector.litTagName = Lit.StaticHtml.literal `devtools-performance-slow-css-selector`;
