...
var _LCPBreakdown_instances, _LCPBreakdown_overlay, _LCPBreakdown_renderFieldSubparts;
import './Table.js';
...
export class LCPBreakdown extends BaseInsightComponent {
    constructor() {
        super(...arguments);
        _LCPBreakdown_instances.add(this);
        this.internalName = 'lcp-by-phase';
        _LCPBreakdown_overlay.set(this, null);
    }
    hasAskAiSupport() {
        return true;
    }
    createOverlays() {
        __classPrivateFieldSet(this, _LCPBreakdown_overlay, null, "f");
        ...
        __classPrivateFieldSet(this, _LCPBreakdown_overlay, overlays[0], "f");
        return overlays;
    }
    ...
    renderContent() {
        ...
        const rows = Object.values(subparts).map((subpart) => {
            const section = __classPrivateFieldGet(this, _LCPBreakdown_overlay, "f")?.sections.find(section => subpart.label === section.label);
      ...
      <div class="insight-section">
        ...
        // clang-format on
        const fieldDataSection = __classPrivateFieldGet(this, _LCPBreakdown_instances, "m", _LCPBreakdown_renderFieldSubparts).call(this);
        if (fieldDataSection) {
...
_LCPBreakdown_overlay = new WeakMap(), _LCPBreakdown_instances = new WeakSet(), _LCPBreakdown_renderFieldSubparts = function _LCPBreakdown_renderFieldSubparts() {
...
LCPBreakdown.litTagName = Lit.StaticHtml.literal `devtools-performance-lcp-breakdown`;
