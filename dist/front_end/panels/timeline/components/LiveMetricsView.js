...
var _LiveMetricsView_instances, _LiveMetricsView_shadow, _LiveMetricsView_isNode, _LiveMetricsView_lcpValue, _LiveMetricsView_clsValue, _LiveMetricsView_inpValue, _LiveMetricsView_interactions, _LiveMetricsView_layoutShifts, _LiveMetricsView_cruxManager, _LiveMetricsView_toggleRecordAction, _LiveMetricsView_recordReloadAction, _LiveMetricsView_logsEl, _LiveMetricsView_tooltipContainerEl, _LiveMetricsView_interactionsListEl, _LiveMetricsView_layoutShiftsListEl, _LiveMetricsView_listIsScrolling, _LiveMetricsView_deviceModeModel, _LiveMetricsView_onMetricStatus, _LiveMetricsView_keepScrolledToBottom, _LiveMetricsView_onFieldDataChanged, _LiveMetricsView_onEmulationChanged, _LiveMetricsView_refreshFieldDataForCurrentPage, _LiveMetricsView_getLcpFieldPhases, _LiveMetricsView_renderLcpCard, _LiveMetricsView_renderClsCard, _LiveMetricsView_renderInpCard, _LiveMetricsView_renderRecordAction, _LiveMetricsView_getNetworkRecTitle, _LiveMetricsView_getDeviceRec, _LiveMetricsView_renderRecordingSettings, _LiveMetricsView_getPageScopeLabel, _LiveMetricsView_onPageScopeMenuItemSelected, _LiveMetricsView_renderPageScopeSetting, _LiveMetricsView_getDeviceScopeDisplayName, _LiveMetricsView_getLabelForDeviceOption, _LiveMetricsView_onDeviceOptionMenuItemSelected, _LiveMetricsView_renderDeviceScopeSetting, _LiveMetricsView_getCollectionPeriodRange, _LiveMetricsView_renderCollectionPeriod, _LiveMetricsView_renderFieldDataMessage, _LiveMetricsView_renderLogSection, _LiveMetricsView_revealInteraction, _LiveMetricsView_logExtraInteractionDetails, _LiveMetricsView_renderInteractionsLog, _LiveMetricsView_revealLayoutShiftCluster, _LiveMetricsView_renderLayoutShiftsLog, _LiveMetricsView_renderNodeView, _LiveMetricsView_render, _LiveMetricsLogs_instances, _LiveMetricsLogs_tabbedPane, _LiveMetricsLogs_clearCurrentLog;
...
export class LiveMetricsView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
    constructor() {
        super();
        _LiveMetricsView_instances.add(this);
        _LiveMetricsView_shadow.set(this, this.attachShadow({ mode: 'open' }));
        _LiveMetricsView_isNode.set(this, false);
        _LiveMetricsView_lcpValue.set(this, void 0);
        _LiveMetricsView_clsValue.set(this, void 0);
        _LiveMetricsView_inpValue.set(this, void 0);
        _LiveMetricsView_interactions.set(this, new Map());
        _LiveMetricsView_layoutShifts.set(this, []);
        _LiveMetricsView_cruxManager.set(this, CrUXManager.CrUXManager.instance());
        _LiveMetricsView_toggleRecordAction.set(this, void 0);
        _LiveMetricsView_recordReloadAction.set(this, void 0);
        _LiveMetricsView_logsEl.set(this, void 0);
        _LiveMetricsView_tooltipContainerEl.set(this, void 0);
        _LiveMetricsView_interactionsListEl.set(this, void 0);
        _LiveMetricsView_layoutShiftsListEl.set(this, void 0);
        _LiveMetricsView_listIsScrolling.set(this, false);
        _LiveMetricsView_deviceModeModel.set(this, EmulationModel.DeviceModeModel.DeviceModeModel.tryInstance());
        _LiveMetricsView_render.set(this, () => {
            if (__classPrivateFieldGet(this, _LiveMetricsView_isNode, "f")) {
                Lit.render(__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderNodeView).call(this), __classPrivateFieldGet(this, _LiveMetricsView_shadow, "f"), { host: this });
                return;
            }
            const fieldEnabled = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getConfigSetting().get().enabled;
        ...
        <div class="live-metrics-view">
          <main class="live-metrics">
            ...
            <div class="metric-cards"
              on-render=${ComponentHelpers.Directives.nodeRenderedCallback(node => {
                __classPrivateFieldSet(this, _LiveMetricsView_tooltipContainerEl, node, "f");
            })}
            >
              <div id="lcp">
                ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderLcpCard).call(this)}
              </div>
              <div id="cls">
                ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderClsCard).call(this)}
              </div>
              <div id="inp">
                ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderInpCard).call(this)}
              </div>
            </div>
            <x-link
              href=${helpLink}
            ...
            ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderLogSection).call(this)}
          </main>
          <aside class="next-steps" aria-labelledby="next-steps-section-title">
            ...
            <div id="field-setup" class="settings-card">
              ...
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderFieldDataMessage).call(this)}
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderPageScopeSetting).call(this)}
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderDeviceScopeSetting).call(this)}
            ...
            <div id="recording-settings" class="settings-card">
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderRecordingSettings).call(this)}
            </div>
            <div id="record" class="record-action-card">
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderRecordAction).call(this, __classPrivateFieldGet(this, _LiveMetricsView_toggleRecordAction, "f"))}
            </div>
            <div id="record-page-load" class="record-action-card">
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderRecordAction).call(this, __classPrivateFieldGet(this, _LiveMetricsView_recordReloadAction, "f"))}
            </div>
          </aside>
        </div>
      </div>
    `;
            Lit.render(output, __classPrivateFieldGet(this, _LiveMetricsView_shadow, "f"), { host: this });
        });
        __classPrivateFieldSet(this, _LiveMetricsView_toggleRecordAction, UI.ActionRegistry.ActionRegistry.instance().getAction('timeline.toggle-recording'), "f");
        __classPrivateFieldSet(this, _LiveMetricsView_recordReloadAction, UI.ActionRegistry.ActionRegistry.instance().getAction('timeline.record-reload'), "f");
    }
    set isNode(isNode) {
        __classPrivateFieldSet(this, _LiveMetricsView_isNode, isNode, "f");
        void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
    }
    connectedCallback() {
        const liveMetrics = LiveMetrics.LiveMetrics.instance();
        liveMetrics.addEventListener("status" /* LiveMetrics.Events.STATUS */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onMetricStatus), this);
        const cruxManager = CrUXManager.CrUXManager.instance();
        cruxManager.addEventListener("field-data-changed" /* CrUXManager.Events.FIELD_DATA_CHANGED */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onFieldDataChanged), this);
        __classPrivateFieldGet(this, _LiveMetricsView_deviceModeModel, "f")?.addEventListener("Updated" /* EmulationModel.DeviceModeModel.Events.UPDATED */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onEmulationChanged), this);
        if (cruxManager.getConfigSetting().get().enabled) {
            void __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_refreshFieldDataForCurrentPage).call(this);
        }
        __classPrivateFieldSet(this, _LiveMetricsView_lcpValue, liveMetrics.lcpValue, "f");
        __classPrivateFieldSet(this, _LiveMetricsView_clsValue, liveMetrics.clsValue, "f");
        __classPrivateFieldSet(this, _LiveMetricsView_inpValue, liveMetrics.inpValue, "f");
        __classPrivateFieldSet(this, _LiveMetricsView_interactions, liveMetrics.interactions, "f");
        __classPrivateFieldSet(this, _LiveMetricsView_layoutShifts, liveMetrics.layoutShifts, "f");
        void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
    }
    disconnectedCallback() {
        LiveMetrics.LiveMetrics.instance().removeEventListener("status" /* LiveMetrics.Events.STATUS */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onMetricStatus), this);
        const cruxManager = CrUXManager.CrUXManager.instance();
        cruxManager.removeEventListener("field-data-changed" /* CrUXManager.Events.FIELD_DATA_CHANGED */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onFieldDataChanged), this);
        __classPrivateFieldGet(this, _LiveMetricsView_deviceModeModel, "f")?.removeEventListener("Updated" /* EmulationModel.DeviceModeModel.Events.UPDATED */, __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onEmulationChanged), this);
    }
}
_LiveMetricsView_shadow = new WeakMap(), _LiveMetricsView_isNode = new WeakMap(), _LiveMetricsView_lcpValue = new WeakMap(), _LiveMetricsView_clsValue = new WeakMap(), _LiveMetricsView_inpValue = new WeakMap(), _LiveMetricsView_interactions = new WeakMap(), _LiveMetricsView_layoutShifts = new WeakMap(), _LiveMetricsView_cruxManager = new WeakMap(), _LiveMetricsView_toggleRecordAction = new WeakMap(), _LiveMetricsView_recordReloadAction = new WeakMap(), _LiveMetricsView_logsEl = new WeakMap(), _LiveMetricsView_tooltipContainerEl = new WeakMap(), _LiveMetricsView_interactionsListEl = new WeakMap(), _LiveMetricsView_layoutShiftsListEl = new WeakMap(), _LiveMetricsView_listIsScrolling = new WeakMap(), _LiveMetricsView_deviceModeModel = new WeakMap(), _LiveMetricsView_render = new WeakMap(), _LiveMetricsView_instances = new WeakSet(), _LiveMetricsView_onMetricStatus = function _LiveMetricsView_onMetricStatus(event) {
    __classPrivateFieldSet(this, _LiveMetricsView_lcpValue, event.data.lcp, "f");
    __classPrivateFieldSet(this, _LiveMetricsView_clsValue, event.data.cls, "f");
    __classPrivateFieldSet(this, _LiveMetricsView_inpValue, event.data.inp, "f");
    const hasNewLS = __classPrivateFieldGet(this, _LiveMetricsView_layoutShifts, "f").length < event.data.layoutShifts.length;
    __classPrivateFieldSet(this, _LiveMetricsView_layoutShifts, [...event.data.layoutShifts], "f");
    const hasNewInteraction = __classPrivateFieldGet(this, _LiveMetricsView_interactions, "f").size < event.data.interactions.size;
    __classPrivateFieldSet(this, _LiveMetricsView_interactions, new Map(event.data.interactions), "f");
    const renderPromise = ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
    if (hasNewInteraction && __classPrivateFieldGet(this, _LiveMetricsView_interactionsListEl, "f")) {
        __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_keepScrolledToBottom).call(this, renderPromise, __classPrivateFieldGet(this, _LiveMetricsView_interactionsListEl, "f"));
    }
    if (hasNewLS && __classPrivateFieldGet(this, _LiveMetricsView_layoutShiftsListEl, "f")) {
        __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_keepScrolledToBottom).call(this, renderPromise, __classPrivateFieldGet(this, _LiveMetricsView_layoutShiftsListEl, "f"));
    }
}, _LiveMetricsView_keepScrolledToBottom = function _LiveMetricsView_keepScrolledToBottom(renderPromise, listEl) {
    ...
    if (!isAtBottom && !__classPrivateFieldGet(this, _LiveMetricsView_listIsScrolling, "f")) {
        return;
    }
    void renderPromise.then(() => {
        requestAnimationFrame(() => {
            __classPrivateFieldSet(this, _LiveMetricsView_listIsScrolling, true, "f");
            listEl.addEventListener('scrollend', () => {
                __classPrivateFieldSet(this, _LiveMetricsView_listIsScrolling, false, "f");
            }, { once: true });
            listEl.scrollTo({ top: listEl.scrollHeight, behavior: 'smooth' });
        });
    });
}, _LiveMetricsView_onFieldDataChanged = function _LiveMetricsView_onFieldDataChanged() {
    void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
}, _LiveMetricsView_onEmulationChanged = function _LiveMetricsView_onEmulationChanged() {
    void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
}, _LiveMetricsView_refreshFieldDataForCurrentPage = async function _LiveMetricsView_refreshFieldDataForCurrentPage() {
    await __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").refresh();
    void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
}, _LiveMetricsView_getLcpFieldPhases = function _LiveMetricsView_getLcpFieldPhases() {
    const ttfb = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('largest_contentful_paint_image_time_to_first_byte')
        ?.percentiles?.p75;
    const loadDelay = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('largest_contentful_paint_image_resource_load_delay')
        ?.percentiles?.p75;
    const loadDuration = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('largest_contentful_paint_image_resource_load_duration')
        ?.percentiles?.p75;
    const renderDelay = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('largest_contentful_paint_image_element_render_delay')
        ?.percentiles?.p75;
...
}, _LiveMetricsView_renderLcpCard = function _LiveMetricsView_renderLcpCard() {
    const fieldData = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('largest_contentful_paint');
    const nodeLink = __classPrivateFieldGet(this, _LiveMetricsView_lcpValue, "f")?.nodeRef?.link;
    const phases = __classPrivateFieldGet(this, _LiveMetricsView_lcpValue, "f")?.phases;
    const fieldPhases = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getLcpFieldPhases).call(this);
    // clang-format off
    return html `
      <devtools-metric-card .data=${{
        metric: 'LCP',
        localValue: __classPrivateFieldGet(this, _LiveMetricsView_lcpValue, "f")?.value,
        fieldValue: fieldData?.percentiles?.p75,
        histogram: fieldData?.histogram,
        tooltipContainer: __classPrivateFieldGet(this, _LiveMetricsView_tooltipContainerEl, "f"),
        warnings: __classPrivateFieldGet(this, _LiveMetricsView_lcpValue, "f")?.warnings,
        phases: phases && [
    ...
    `;
    // clang-format on
}, _LiveMetricsView_renderClsCard = function _LiveMetricsView_renderClsCard() {
    const fieldData = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('cumulative_layout_shift');
    const clusterIds = new Set(__classPrivateFieldGet(this, _LiveMetricsView_clsValue, "f")?.clusterShiftIds || []);
    const clusterIsVisible = clusterIds.size > 0 && __classPrivateFieldGet(this, _LiveMetricsView_layoutShifts, "f").some(layoutShift => clusterIds.has(layoutShift.uniqueLayoutShiftId));
    // clang-format off
    return html `
      <devtools-metric-card .data=${{
        metric: 'CLS',
        localValue: __classPrivateFieldGet(this, _LiveMetricsView_clsValue, "f")?.value,
        fieldValue: fieldData?.percentiles?.p75,
        histogram: fieldData?.histogram,
        tooltipContainer: __classPrivateFieldGet(this, _LiveMetricsView_tooltipContainerEl, "f"),
        warnings: __classPrivateFieldGet(this, _LiveMetricsView_clsValue, "f")?.warnings,
    }}>
        ${clusterIsVisible ? html `
          <div class="related-info" slot="extra-info">
            ...
            <button
              ...
              @click=${() => __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_revealLayoutShiftCluster).call(this, clusterIds)}
    ...
    `;
    // clang-format on
}, _LiveMetricsView_renderInpCard = function _LiveMetricsView_renderInpCard() {
    const fieldData = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('interaction_to_next_paint');
    const phases = __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f")?.phases;
    const interaction = __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f") && __classPrivateFieldGet(this, _LiveMetricsView_interactions, "f").get(__classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f").interactionId);
    // clang-format off
    return html `
      <devtools-metric-card .data=${{
        metric: 'INP',
        localValue: __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f")?.value,
        fieldValue: fieldData?.percentiles?.p75,
        histogram: fieldData?.histogram,
        tooltipContainer: __classPrivateFieldGet(this, _LiveMetricsView_tooltipContainerEl, "f"),
        warnings: __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f")?.warnings,
        phases: phases && [
        ...
        ${interaction ? html `
          <div class="related-info" slot="extra-info">
            ...
            <button
              ...
              @click=${() => __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_revealInteraction).call(this, interaction)}
    ...
    `;
    // clang-format on
}, _LiveMetricsView_renderRecordAction = function _LiveMetricsView_renderRecordAction(action) {
    function onClick() {
        void action.execute();
    }
    // clang-format off
    ...
    `;
    // clang-format on
}, _LiveMetricsView_getNetworkRecTitle = function _LiveMetricsView_getNetworkRecTitle() {
    const response = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldMetricData('round_trip_time');
...
}, _LiveMetricsView_getDeviceRec = function _LiveMetricsView_getDeviceRec() {
    // `form_factors` metric is only populated if CrUX data is fetched for all devices.
    const fractions = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getFieldResponse(__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope, 'ALL')
...
}, _LiveMetricsView_renderRecordingSettings = function _LiveMetricsView_renderRecordingSettings() {
    const fieldEnabled = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getConfigSetting().get().enabled;
    const deviceRecEl = document.createElement('span');
    deviceRecEl.classList.add('environment-rec');
    deviceRecEl.textContent = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getDeviceRec).call(this) || i18nString(UIStrings.notEnoughData);
    const networkRecEl = document.createElement('span');
    networkRecEl.classList.add('environment-rec');
    networkRecEl.textContent = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getNetworkRecTitle).call(this) || i18nString(UIStrings.notEnoughData);
    ...
    `;
    // clang-format on
}, _LiveMetricsView_getPageScopeLabel = function _LiveMetricsView_getPageScopeLabel(pageScope) {
    const key = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").pageResult?.[`${pageScope}-ALL`]?.record.key[pageScope];
    if (key) {
...
}, _LiveMetricsView_onPageScopeMenuItemSelected = function _LiveMetricsView_onPageScopeMenuItemSelected(event) {
    if (event.itemValue === 'url') {
        __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope = 'url';
    }
    else {
        __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope = 'origin';
    }
    void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
}, _LiveMetricsView_renderPageScopeSetting = function _LiveMetricsView_renderPageScopeSetting() {
    if (!__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getConfigSetting().get().enabled) {
        return Lit.nothing;
    }
    const urlLabel = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getPageScopeLabel).call(this, 'url');
    const originLabel = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getPageScopeLabel).call(this, 'origin');
    const buttonTitle = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope === 'url' ? urlLabel : originLabel;
    ...
    const shouldDisable = !__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").pageResult?.['url-ALL'] && !__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").pageResult?.['origin-ALL'];
    /* eslint-disable rulesdir/no-deprecated-component-usages */
    return html `
      <devtools-select-menu
        id="page-scope-select"
        class="field-data-option"
        @selectmenuselected=${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onPageScopeMenuItemSelected)}
        .showDivider=${true}
        .showArrow=${true}
        .sideButton=${false}
      ...
      >
        <devtools-menu-item
          .value=${'url'}
          .selected=${__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope === 'url'}
        >
          ${urlLabel}
        </devtools-menu-item>
        <devtools-menu-item
          .value=${'origin'}
          .selected=${__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope === 'origin'}
        >
          ${originLabel}
        </devtools-menu-item>
      </devtools-select-menu>
...
}, _LiveMetricsView_getDeviceScopeDisplayName = function _LiveMetricsView_getDeviceScopeDisplayName(deviceScope) {
    switch (deviceScope) {
        case 'ALL':
...
}, _LiveMetricsView_getLabelForDeviceOption = function _LiveMetricsView_getLabelForDeviceOption(deviceOption) {
    let baseLabel;
    if (deviceOption === 'AUTO') {
        const deviceScope = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").resolveDeviceOptionToScope(deviceOption);
        const deviceScopeLabel = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getDeviceScopeDisplayName).call(this, deviceScope);
        baseLabel = i18nString(UIStrings.auto, { PH1: deviceScopeLabel });
    }
    else {
        baseLabel = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getDeviceScopeDisplayName).call(this, deviceOption);
    }
    if (!__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").pageResult) {
        return i18nString(UIStrings.loadingOption, { PH1: baseLabel });
    }
    const result = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldResponse();
    if (!result) {
        return i18nString(UIStrings.needsDataOption, { PH1: baseLabel });
    }
    return baseLabel;
}, _LiveMetricsView_onDeviceOptionMenuItemSelected = function _LiveMetricsView_onDeviceOptionMenuItemSelected(event) {
    __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldDeviceOption = event.itemValue;
    void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _LiveMetricsView_render, "f"));
}, _LiveMetricsView_renderDeviceScopeSetting = function _LiveMetricsView_renderDeviceScopeSetting() {
    if (!__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getConfigSetting().get().enabled) {
        return Lit.nothing;
    }
    // If there is no data at all we should force users to try adjusting the page scope
    // before coming back to this option.
    const shouldDisable = !__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getFieldResponse(__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldPageScope, 'ALL');
    const currentDeviceLabel = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getLabelForDeviceOption).call(this, __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldDeviceOption);
    // clang-format off
    /* eslint-disable rulesdir/no-deprecated-component-usages */
    return html `
      <devtools-select-menu
        ...
        class="field-data-option"
        @selectmenuselected=${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_onDeviceOptionMenuItemSelected)}
        .showDivider=${true}
        .showArrow=${true}
        .sideButton=${false}
        .showSelectedItem=${true}
      ...
      >
        ...
        return html `
            <devtools-menu-item
              .value=${deviceOption}
              .selected=${__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").fieldDeviceOption === deviceOption}
            >
              ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getLabelForDeviceOption).call(this, deviceOption)}
            </devtools-menu-item>
          `;
    })}
      </devtools-select-menu>
    ...
    /* eslint-enable rulesdir/no-deprecated-component-usages */
    // clang-format on
}, _LiveMetricsView_getCollectionPeriodRange = function _LiveMetricsView_getCollectionPeriodRange() {
    const selectedResponse = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getSelectedFieldResponse();
    if (!selectedResponse) {
        return null;
    }
...
}, _LiveMetricsView_renderCollectionPeriod = function _LiveMetricsView_renderCollectionPeriod() {
    const range = __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_getCollectionPeriodRange).call(this);
    ...
    const warnings = __classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").pageResult?.warnings || [];
    return html `
    ...
    `;
}, _LiveMetricsView_renderFieldDataMessage = function _LiveMetricsView_renderFieldDataMessage() {
    if (__classPrivateFieldGet(this, _LiveMetricsView_cruxManager, "f").getConfigSetting().get().enabled) {
        return __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderCollectionPeriod).call(this);
    }
    ...
    `;
}, _LiveMetricsView_renderLogSection = function _LiveMetricsView_renderLogSection() {
    // clang-format off
    return html `
      <section class="logs-section" aria-label=${i18nString(UIStrings.eventLogs)}>
        <devtools-live-metrics-logs
          on-render=${ComponentHelpers.Directives.nodeRenderedCallback(node => {
        __classPrivateFieldSet(this, _LiveMetricsView_logsEl, node, "f");
    })}
        >
          ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderInteractionsLog).call(this)}
          ${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderLayoutShiftsLog).call(this)}
        </devtools-live-metrics-logs>
      </section>
    `;
    // clang-format on
}, _LiveMetricsView_revealInteraction = async function _LiveMetricsView_revealInteraction(interaction) {
    const interactionEl = __classPrivateFieldGet(this, _LiveMetricsView_shadow, "f").getElementById(interaction.interactionId);
    if (!interactionEl || !__classPrivateFieldGet(this, _LiveMetricsView_logsEl, "f")) {
        return;
    }
    const success = __classPrivateFieldGet(this, _LiveMetricsView_logsEl, "f").selectTab('interactions');
    if (!success) {
        return;
    }
...
}, _LiveMetricsView_logExtraInteractionDetails = async function _LiveMetricsView_logExtraInteractionDetails(interaction) {
...
}, _LiveMetricsView_renderInteractionsLog = function _LiveMetricsView_renderInteractionsLog() {
    if (!__classPrivateFieldGet(this, _LiveMetricsView_interactions, "f").size) {
        return Lit.nothing;
    }
    // clang-format off
    return html `
      <ol class="log"
        ...
        on-render=${ComponentHelpers.Directives.nodeRenderedCallback(node => {
        __classPrivateFieldSet(this, _LiveMetricsView_interactionsListEl, node, "f");
    })}
      >
        ${__classPrivateFieldGet(this, _LiveMetricsView_interactions, "f").values().map(interaction => {
        ...
        const isP98Excluded = __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f") && __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f").value < interaction.duration;
        const isInp = __classPrivateFieldGet(this, _LiveMetricsView_inpValue, "f")?.interactionId === interaction.interactionId;
        return html `
                    ...
                    <div role="columnheader">
                      ${interaction.longAnimationFrameTimings.length ? html `
                        <button
                          ...
                          @click=${() => __classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_logExtraInteractionDetails).call(this, interaction)}
    ...
    `;
    // clang-format on
}, _LiveMetricsView_revealLayoutShiftCluster = async function _LiveMetricsView_revealLayoutShiftCluster(clusterIds) {
    if (!__classPrivateFieldGet(this, _LiveMetricsView_logsEl, "f")) {
        return;
    }
    const layoutShiftEls = [];
    for (const shiftId of clusterIds) {
        const layoutShiftEl = __classPrivateFieldGet(this, _LiveMetricsView_shadow, "f").getElementById(shiftId);
        if (layoutShiftEl) {
    ...
    const success = __classPrivateFieldGet(this, _LiveMetricsView_logsEl, "f").selectTab('layout-shifts');
    if (!success) {
        return;
    }
    await RenderCoordinator.write(() => {
...
}, _LiveMetricsView_renderLayoutShiftsLog = function _LiveMetricsView_renderLayoutShiftsLog() {
    if (!__classPrivateFieldGet(this, _LiveMetricsView_layoutShifts, "f").length) {
        return Lit.nothing;
    }
    // clang-format off
    return html `
      <ol class="log"
        ...
        on-render=${ComponentHelpers.Directives.nodeRenderedCallback(node => {
        __classPrivateFieldSet(this, _LiveMetricsView_layoutShiftsListEl, node, "f");
    })}
      >
        ${__classPrivateFieldGet(this, _LiveMetricsView_layoutShifts, "f").map(layoutShift => {
    ...
    `;
    // clang-format on
}, _LiveMetricsView_renderNodeView = function _LiveMetricsView_renderNodeView() {
    return html `
      <style>${liveMetricsViewStyles}</style>
      <style>${metricValueStyles}</style>
      <div class="node-view">
        <main>
          ...
          <div class="record-action-card">${__classPrivateFieldGet(this, _LiveMetricsView_instances, "m", _LiveMetricsView_renderRecordAction).call(this, __classPrivateFieldGet(this, _LiveMetricsView_toggleRecordAction, "f"))}</div>
        </main>
      </div>
    `;
};
class LiveMetricsLogs extends UI.Widget.WidgetElement {
    constructor() {
        super();
        _LiveMetricsLogs_instances.add(this);
        _LiveMetricsLogs_tabbedPane.set(this, void 0);
     ...
     */
    selectTab(tabId) {
        if (!__classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f")) {
            return false;
        }
        return __classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f").selectTab(tabId);
    }
    createWidget() {
        ...
        __classPrivateFieldSet(this, _LiveMetricsLogs_tabbedPane, new UI.TabbedPane.TabbedPane(), "f");
        ...
        __classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f").appendTab('interactions', i18nString(UIStrings.interactions), interactionsTab, undefined, undefined, undefined, undefined, undefined, 'timeline.landing.interactions-log');
        ...
        __classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f").appendTab('layout-shifts', i18nString(UIStrings.layoutShifts), layoutShiftsTab, undefined, undefined, undefined, undefined, undefined, 'timeline.landing.layout-shifts-log');
        ...
        clearButton.addEventListener("Click" /* UI.Toolbar.ToolbarButton.Events.CLICK */, __classPrivateFieldGet(this, _LiveMetricsLogs_instances, "m", _LiveMetricsLogs_clearCurrentLog), this);
        __classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f").rightToolbar().appendToolbarItem(clearButton);
        __classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f").show(containerWidget.contentElement);
        return containerWidget;
    }
}
_LiveMetricsLogs_tabbedPane = new WeakMap(), _LiveMetricsLogs_instances = new WeakSet(), _LiveMetricsLogs_clearCurrentLog = function _LiveMetricsLogs_clearCurrentLog() {
    const liveMetrics = LiveMetrics.LiveMetrics.instance();
    switch (__classPrivateFieldGet(this, _LiveMetricsLogs_tabbedPane, "f")?.selectedTabId) {
        case 'interactions':
