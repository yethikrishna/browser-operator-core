...
var _SidebarAnnotationsTab_instances, _SidebarAnnotationsTab_annotations, _SidebarAnnotationsTab_annotationEntryToColorMap, _SidebarAnnotationsTab_annotationsHiddenSetting, _SidebarAnnotationsTab_view, _SidebarAnnotationsTab_processAnnotationsList, _SidebarAnnotationsTab_getAnnotationTimestamp, _SidebarAnnotationsTab_isAnnotationCreationStarted;
...
export class SidebarAnnotationsTab extends UI.Widget.Widget {
    constructor(view = DEFAULT_VIEW) {
        super();
        _SidebarAnnotationsTab_instances.add(this);
        _SidebarAnnotationsTab_annotations.set(this, []);
        ...
        _SidebarAnnotationsTab_annotationEntryToColorMap.set(this, new Map());
        _SidebarAnnotationsTab_annotationsHiddenSetting.set(this, void 0);
        _SidebarAnnotationsTab_view.set(this, void 0);
        __classPrivateFieldSet(this, _SidebarAnnotationsTab_view, view, "f");
        __classPrivateFieldSet(this, _SidebarAnnotationsTab_annotationsHiddenSetting, Common.Settings.Settings.instance().moduleSetting('annotations-hidden'), "f");
    }
    deduplicatedAnnotations() {
        return __classPrivateFieldGet(this, _SidebarAnnotationsTab_annotations, "f");
    }
    setData(data) {
        __classPrivateFieldSet(this, _SidebarAnnotationsTab_annotations, __classPrivateFieldGet(this, _SidebarAnnotationsTab_instances, "m", _SidebarAnnotationsTab_processAnnotationsList).call(this, data.annotations), "f");
        __classPrivateFieldSet(this, _SidebarAnnotationsTab_annotationEntryToColorMap, data.annotationEntryToColorMap, "f");
        this.requestUpdate();
    }
    performUpdate() {
        const input = {
            annotations: __classPrivateFieldGet(this, _SidebarAnnotationsTab_annotations, "f"),
            annotationsHiddenSetting: __classPrivateFieldGet(this, _SidebarAnnotationsTab_annotationsHiddenSetting, "f"),
            annotationEntryToColorMap: __classPrivateFieldGet(this, _SidebarAnnotationsTab_annotationEntryToColorMap, "f"),
        ...
        __classPrivateFieldGet(this, _SidebarAnnotationsTab_view, "f").call(this, input, {}, this.contentElement);
    }
}
_SidebarAnnotationsTab_annotations = new WeakMap(), _SidebarAnnotationsTab_annotationEntryToColorMap = new WeakMap(), _SidebarAnnotationsTab_annotationsHiddenSetting = new WeakMap(), _SidebarAnnotationsTab_view = new WeakMap(), _SidebarAnnotationsTab_instances = new WeakSet(), _SidebarAnnotationsTab_processAnnotationsList = function _SidebarAnnotationsTab_processAnnotationsList(annotations) {
    ...
    const processedAnnotations = annotations.filter(annotation => {
        if (__classPrivateFieldGet(this, _SidebarAnnotationsTab_instances, "m", _SidebarAnnotationsTab_isAnnotationCreationStarted).call(this, annotation)) {
            return true;
        }
    ...
    processedAnnotations.sort((firstAnnotation, secondAnnotation) => __classPrivateFieldGet(this, _SidebarAnnotationsTab_instances, "m", _SidebarAnnotationsTab_getAnnotationTimestamp).call(this, firstAnnotation) - __classPrivateFieldGet(this, _SidebarAnnotationsTab_instances, "m", _SidebarAnnotationsTab_getAnnotationTimestamp).call(this, secondAnnotation));
    return processedAnnotations;
}, _SidebarAnnotationsTab_getAnnotationTimestamp = function _SidebarAnnotationsTab_getAnnotationTimestamp(annotation) {
...
}, _SidebarAnnotationsTab_isAnnotationCreationStarted = function _SidebarAnnotationsTab_isAnnotationCreationStarted(annotation) {
