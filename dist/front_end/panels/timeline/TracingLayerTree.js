...
var _TracingFrameLayerTree_target, _TracingFrameLayerTree_snapshot, _TracingFrameLayerTree_paints;
...
export class TracingFrameLayerTree {
    constructor(target, data) {
        _TracingFrameLayerTree_target.set(this, void 0);
        _TracingFrameLayerTree_snapshot.set(this, void 0);
        _TracingFrameLayerTree_paints.set(this, []);
        __classPrivateFieldSet(this, _TracingFrameLayerTree_target, target, "f");
        __classPrivateFieldSet(this, _TracingFrameLayerTree_snapshot, data.entry, "f");
        __classPrivateFieldSet(this, _TracingFrameLayerTree_paints, data.paints, "f");
    }
    async layerTreePromise() {
        const data = __classPrivateFieldGet(this, _TracingFrameLayerTree_snapshot, "f").args.snapshot;
        ...
        const layerTree = new TracingLayerTree(__classPrivateFieldGet(this, _TracingFrameLayerTree_target, "f"));
        layerTree.setViewportSize(viewport);
        layerTree.setTiles(tiles);
        await layerTree.setLayers(rootLayer, layers, __classPrivateFieldGet(this, _TracingFrameLayerTree_paints, "f") || []);
        return layerTree;
    }
    paints() {
        return __classPrivateFieldGet(this, _TracingFrameLayerTree_paints, "f");
    }
}
_TracingFrameLayerTree_target = new WeakMap(), _TracingFrameLayerTree_snapshot = new WeakMap(), _TracingFrameLayerTree_paints = new WeakMap();
