...
var _TimelineController_instances, _TimelineController_collectedEvents, _TimelineController_navigationUrls, _TimelineController_fieldData, _TimelineController_recordingStartTime, _TimelineController_onFrameNavigated;
...
export class TimelineController {
    ...
    constructor(rootTarget, primaryPageTarget, client) {
        _TimelineController_instances.add(this);
        _TimelineController_collectedEvents.set(this, []);
        _TimelineController_navigationUrls.set(this, []);
        _TimelineController_fieldData.set(this, null);
        _TimelineController_recordingStartTime.set(this, null);
    ...
    async startRecording(options) {
        ...
        SDK.TargetManager.TargetManager.instance().addModelListener(SDK.ResourceTreeModel.ResourceTreeModel, SDK.ResourceTreeModel.Events.FrameNavigated, __classPrivateFieldGet(this, _TimelineController_instances, "m", _TimelineController_onFrameNavigated), this);
        __classPrivateFieldSet(this, _TimelineController_navigationUrls, [], "f");
        __classPrivateFieldSet(this, _TimelineController_fieldData, null, "f");
        __classPrivateFieldSet(this, _TimelineController_recordingStartTime, Date.now(), "f");
    ...
    async stopRecording() {
        ...
        SDK.TargetManager.TargetManager.instance().removeModelListener(SDK.ResourceTreeModel.ResourceTreeModel, SDK.ResourceTreeModel.Events.FrameNavigated, __classPrivateFieldGet(this, _TimelineController_instances, "m", _TimelineController_onFrameNavigated), this);
        ...
        __classPrivateFieldSet(this, _TimelineController_fieldData, fieldData, "f");
    ...
    async fetchFieldData() {
        ...
        const urls = [...new Set(__classPrivateFieldGet(this, _TimelineController_navigationUrls, "f"))];
    ...
    traceEventsCollected(events) {
        __classPrivateFieldGet(this, _TimelineController_collectedEvents, "f").push(...events);
    }
    tracingComplete() {
    ...
    async allSourcesFinished() {
        ...
        const metadata = await RecordingMetadata.forTrace({
            recordingStartTime: __classPrivateFieldGet(this, _TimelineController_recordingStartTime, "f") ?? undefined,
            cruxFieldData: __classPrivateFieldGet(this, _TimelineController_fieldData, "f") ?? undefined,
        });
        await this.client.loadingComplete(__classPrivateFieldGet(this, _TimelineController_collectedEvents, "f"), /* exclusiveFilter= */ null, metadata);
...
_TimelineController_collectedEvents = new WeakMap(), _TimelineController_navigationUrls = new WeakMap(), _TimelineController_fieldData = new WeakMap(), _TimelineController_recordingStartTime = new WeakMap(), _TimelineController_instances = new WeakSet(), _TimelineController_onFrameNavigated = async function _TimelineController_onFrameNavigated(event) {
    if (!event.data.isPrimaryFrame()) {
        return;
    }
    __classPrivateFieldGet(this, _TimelineController_navigationUrls, "f").push(event.data.url);
};
