...
var _LayoutShiftsTrackAppender_instances, _LayoutShiftsTrackAppender_compatibilityBuilder, _LayoutShiftsTrackAppender_parsedTrace, _LayoutShiftsTrackAppender_appendTrackHeaderAtLevel, _LayoutShiftsTrackAppender_appendLayoutShiftsAtLevel;
...
export const LAYOUT_SHIFT_SYNTHETIC_DURATION = Trace.Types.Timing.Micro(5000);
export class LayoutShiftsTrackAppender {
    constructor(compatibilityBuilder, parsedTrace) {
        _LayoutShiftsTrackAppender_instances.add(this);
        this.appenderName = 'LayoutShifts';
        _LayoutShiftsTrackAppender_compatibilityBuilder.set(this, void 0);
        _LayoutShiftsTrackAppender_parsedTrace.set(this, void 0);
        __classPrivateFieldSet(this, _LayoutShiftsTrackAppender_compatibilityBuilder, compatibilityBuilder, "f");
        __classPrivateFieldSet(this, _LayoutShiftsTrackAppender_parsedTrace, parsedTrace, "f");
    }
    /**
    ...
    appendTrackAtLevel(trackStartLevel, expanded) {
        if (__classPrivateFieldGet(this, _LayoutShiftsTrackAppender_parsedTrace, "f").LayoutShifts.clusters.length === 0) {
            return trackStartLevel;
        }
        __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_instances, "m", _LayoutShiftsTrackAppender_appendTrackHeaderAtLevel).call(this, trackStartLevel, expanded);
        return __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_instances, "m", _LayoutShiftsTrackAppender_appendLayoutShiftsAtLevel).call(this, trackStartLevel);
    }
    /*
      ------------------------------------------------------------------------------------
    ...
    */
    ...
    setPopoverInfo(event, info) {
        ...
        if (Trace.Types.Events.isSyntheticLayoutShift(event)) {
            ...
            const vizElem = LayoutShiftsTrackAppender.createShiftViz(event, __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_parsedTrace, "f"), maxSize);
            if (vizElem) {
...
_LayoutShiftsTrackAppender_compatibilityBuilder = new WeakMap(), _LayoutShiftsTrackAppender_parsedTrace = new WeakMap(), _LayoutShiftsTrackAppender_instances = new WeakSet(), _LayoutShiftsTrackAppender_appendTrackHeaderAtLevel = function _LayoutShiftsTrackAppender_appendTrackHeaderAtLevel(currentLevel, expanded) {
    ...
    __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_compatibilityBuilder, "f").registerTrackForGroup(group, this);
}, _LayoutShiftsTrackAppender_appendLayoutShiftsAtLevel = function _LayoutShiftsTrackAppender_appendLayoutShiftsAtLevel(currentLevel) {
    const allClusters = __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_parsedTrace, "f").LayoutShifts.clusters;
    __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_compatibilityBuilder, "f").appendEventsAtLevel(allClusters, currentLevel, this);
    const allLayoutShifts = __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_parsedTrace, "f").LayoutShifts.clusters.flatMap(cluster => cluster.events);
    void this.preloadScreenshots(allLayoutShifts);
    return __classPrivateFieldGet(this, _LayoutShiftsTrackAppender_compatibilityBuilder, "f").appendEventsAtLevel(allLayoutShifts, currentLevel, this);
};
