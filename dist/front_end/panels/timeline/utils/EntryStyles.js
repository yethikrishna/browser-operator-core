...
export class TimelineCategory {
    constructor(name, title, visible, childColor, color) {
        _TimelineCategory_hidden.set(this, void 0);
        this.name = name;
        this.title = title;
    ...
    get hidden() {
        return Boolean(__classPrivateFieldGet(this, _TimelineCategory_hidden, "f"));
    }
    get color() {
    ...
    set hidden(hidden) {
        __classPrivateFieldSet(this, _TimelineCategory_hidden, hidden, "f");
    }
}
_TimelineCategory_hidden = new WeakMap();
/**
