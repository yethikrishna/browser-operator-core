...
var _ExcludeCompileCodeFilter_selectedEvent, _SelectedEventDurationFilter_minDuration, _SelectedEventDurationFilter_selectedEvent, _MinDurationFilter_minDuration;
...
export class ExcludeCompileCodeFilter extends Trace.Extras.TraceFilter.TraceFilter {
    constructor(selectedEvent) {
        super();
        _ExcludeCompileCodeFilter_selectedEvent.set(this, null);
        __classPrivateFieldSet(this, _ExcludeCompileCodeFilter_selectedEvent, selectedEvent ?? null, "f");
    }
    accept(event) {
        if (__classPrivateFieldGet(this, _ExcludeCompileCodeFilter_selectedEvent, "f") && event === __classPrivateFieldGet(this, _ExcludeCompileCodeFilter_selectedEvent, "f")) {
...
_ExcludeCompileCodeFilter_selectedEvent = new WeakMap();
export class SelectedEventDurationFilter extends Trace.Extras.TraceFilter.TraceFilter {
    constructor(selectedEvent) {
        super();
        _SelectedEventDurationFilter_minDuration.set(this, void 0);
        _SelectedEventDurationFilter_selectedEvent.set(this, void 0);
        // The larger the selected event is, the less small ones matter. We'll exclude items under ½% of the selected event's size
        __classPrivateFieldSet(this, _SelectedEventDurationFilter_minDuration, Trace.Types.Timing.Micro((selectedEvent.dur ?? 1) * 0.005), "f");
        __classPrivateFieldSet(this, _SelectedEventDurationFilter_selectedEvent, selectedEvent, "f");
    }
    accept(event) {
        if (event === __classPrivateFieldGet(this, _SelectedEventDurationFilter_selectedEvent, "f")) {
            return true;
        }
        return event.dur ? event.dur >= __classPrivateFieldGet(this, _SelectedEventDurationFilter_minDuration, "f") : false;
    }
}
_SelectedEventDurationFilter_minDuration = new WeakMap(), _SelectedEventDurationFilter_selectedEvent = new WeakMap();
export class MinDurationFilter extends Trace.Extras.TraceFilter.TraceFilter {
    constructor(minDuration) {
        super();
        _MinDurationFilter_minDuration.set(this, void 0);
        __classPrivateFieldSet(this, _MinDurationFilter_minDuration, minDuration, "f");
    }
    accept(event) {
        return event.dur ? event.dur >= __classPrivateFieldGet(this, _MinDurationFilter_minDuration, "f") : false;
    }
}
_MinDurationFilter_minDuration = new WeakMap();
