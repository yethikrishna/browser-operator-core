...
var _TimelineHistoryManager_instances, _a, _TimelineHistoryManager_minimapComponent, _TimelineHistoryManager_landingPageTitle, _TimelineHistoryManager_getActiveTraceIndexForListControl, _TimelineHistoryManager_setActiveTrace, _TimelineHistoryManager_buildAndStorePreviewData, _TimelineHistoryManager_buildTextDetails, _TimelineHistoryManager_buildScreenshotThumbnail, _TimelineHistoryManager_buildOverview, _DropDown_instances, _DropDown_landingPageTitle, _DropDown_createLandingPageListItem;
...
export class TimelineHistoryManager {
    constructor(minimapComponent, isNode) {
        _TimelineHistoryManager_instances.add(this);
        this.lastActiveTrace = null;
        _TimelineHistoryManager_minimapComponent.set(this, void 0);
        _TimelineHistoryManager_landingPageTitle.set(this, void 0);
        this.recordings = [];
        __classPrivateFieldSet(this, _TimelineHistoryManager_minimapComponent, minimapComponent, "f");
        ...
        __classPrivateFieldSet(this, _TimelineHistoryManager_landingPageTitle, isNode ? i18nString(UIStrings.nodeLandingPageTitle) : i18nString(UIStrings.landingPageTitle), "f");
        ...
        this.allOverviews = [
            {
                constructor: parsedTrace => {
                    const responsivenessOverviewFromMinimap = __classPrivateFieldGet(this, _TimelineHistoryManager_minimapComponent, "f")?.getControls().find(control => control instanceof TimelineEventOverviewResponsiveness);
            ...
            {
                constructor: parsedTrace => {
                    const cpuOverviewFromMinimap = __classPrivateFieldGet(this, _TimelineHistoryManager_minimapComponent, "f")?.getControls().find(control => control instanceof TimelineEventOverviewCPUActivity);
            ...
            {
                constructor: parsedTrace => {
                    const networkOverviewFromMinimap = __classPrivateFieldGet(this, _TimelineHistoryManager_minimapComponent, "f")?.getControls().find(control => control instanceof TimelineEventOverviewNetwork);
    ...
    addRecording(newInput) {
        ...
        __classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_buildAndStorePreviewData).call(this, newInput.data.parsedTraceIndex, newInput.parsedTrace, newInput.metadata, filmStrip);
    ...
    clear() {
        ...
        this.lastActiveTrace = null;
        this.updateState();
        this.buttonInternal.setText(__classPrivateFieldGet(this, _TimelineHistoryManager_landingPageTitle, "f"));
    ...
    async showHistoryDropDown() {
        ...
        const activeTraceIndex = await DropDown.show(this.recordings.map(recording => recording.parsedTraceIndex), __classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_getActiveTraceIndexForListControl).call(this), this.buttonInternal.element, __classPrivateFieldGet(this, _TimelineHistoryManager_landingPageTitle, "f"));
        ...
        if (activeTraceIndex === LANDING_PAGE_INDEX_DROPDOWN_CHOICE) {
            __classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_setActiveTrace).call(this, { type: 'LANDING_PAGE' });
        ...
        __classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_setActiveTrace).call(this, this.recordings[index]);
    ...
    navigate(direction) {
        ...
        __classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_setActiveTrace).call(this, this.recordings[newIndex]);
    ...
    title(item) {
        if (item.type === 'LANDING_PAGE') {
            return __classPrivateFieldGet(this, _TimelineHistoryManager_landingPageTitle, "f");
        }
...
_a = TimelineHistoryManager, _TimelineHistoryManager_minimapComponent = new WeakMap(), _TimelineHistoryManager_landingPageTitle = new WeakMap(), _TimelineHistoryManager_instances = new WeakSet(), _TimelineHistoryManager_getActiveTraceIndexForListControl = function _TimelineHistoryManager_getActiveTraceIndexForListControl() {
...
}, _TimelineHistoryManager_setActiveTrace = function _TimelineHistoryManager_setActiveTrace(item) {
    ...
    this.buttonInternal.setText(modelTitle);
    UI.ARIAUtils.setLabel(this.buttonInternal.element, i18nString(UIStrings.currentSessionSS, { PH1: modelTitle, PH2: buttonTitle }));
}, _TimelineHistoryManager_buildAndStorePreviewData = function _TimelineHistoryManager_buildAndStorePreviewData(parsedTraceIndex, parsedTrace, metadata, filmStrip) {
    ...
    preview.appendChild(__classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_buildTextDetails).call(this, metadata, domain));
    const screenshotAndOverview = preview.createChild('div', 'hbox');
    screenshotAndOverview.appendChild(__classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_buildScreenshotThumbnail).call(this, filmStrip));
    screenshotAndOverview.appendChild(__classPrivateFieldGet(this, _TimelineHistoryManager_instances, "m", _TimelineHistoryManager_buildOverview).call(this, parsedTrace));
    return data.preview;
}, _TimelineHistoryManager_buildTextDetails = function _TimelineHistoryManager_buildTextDetails(metadata, title) {
    ...
    return container;
}, _TimelineHistoryManager_buildScreenshotThumbnail = function _TimelineHistoryManager_buildScreenshotThumbnail(filmStrip) {
    const container = document.createElement('div');
    ...
    return container;
}, _TimelineHistoryManager_buildOverview = function _TimelineHistoryManager_buildOverview(parsedTrace) {
    const container = document.createElement('div');
...
export class DropDown {
    constructor(availableparsedTraceIndexes, landingPageTitle) {
        ...
        _DropDown_landingPageTitle.set(this, void 0);
        __classPrivateFieldSet(this, _DropDown_landingPageTitle, landingPageTitle, "f");
    ...
    createElementForItem(parsedTraceIndex) {
        if (parsedTraceIndex === LANDING_PAGE_INDEX_DROPDOWN_CHOICE) {
            return __classPrivateFieldGet(this, _DropDown_instances, "m", _DropDown_createLandingPageListItem).call(this);
        }
...
_DropDown_landingPageTitle = new WeakMap(), _DropDown_instances = new WeakSet(), _DropDown_createLandingPageListItem = function _DropDown_createLandingPageListItem() {
    ...
    text.innerText = __classPrivateFieldGet(this, _DropDown_landingPageTitle, "f");
