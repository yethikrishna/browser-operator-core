...
export class StorageMetadataView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
    ...
    setStorageKey(storageKey) {
        __classPrivateFieldSet(this, _StorageMetadataView_storageKey, SDK.StorageKeyManager.parseStorageKey(storageKey), "f");
        void this.render();
    }
    ...
    render() {
        ...
        </devtools-report>`, __classPrivateFieldGet(this, _StorageMetadataView_shadow, "f"), { host: this });
            // clang-format on
        });
    }
    getTitle() {
    ...
    async renderReportContent() {
        ...
        const origin = __classPrivateFieldGet(this, _StorageMetadataView_storageKey, "f").origin;
        const ancestorChainHasCrossSite = Boolean(__classPrivateFieldGet(this, _StorageMetadataView_storageKey, "f").components.get("3" /* SDK.StorageKeyManager.StorageKeyComponent.ANCESTOR_CHAIN_BIT */));
        const hasNonce = Boolean(__classPrivateFieldGet(this, _StorageMetadataView_storageKey, "f").components.get("1" /* SDK.StorageKeyManager.StorageKeyComponent.NONCE_HIGH */));
        const topLevelSiteIsOpaque = Boolean(__classPrivateFieldGet(this, _StorageMetadataView_storageKey, "f").components.get("4" /* SDK.StorageKeyManager.StorageKeyComponent.TOP_LEVEL_SITE_OPAQUE_NONCE_HIGH */));
        const topLevelSite = __classPrivateFieldGet(this, _StorageMetadataView_storageKey, "f").components.get("0" /* SDK.StorageKeyManager.StorageKeyComponent.TOP_LEVEL_SITE */);
        ...
        ${__classPrivateFieldGet(this, _StorageMetadataView_storageBucket, "f") ? __classPrivateFieldGet(this, _StorageMetadataView_instances, "m", _StorageMetadataView_renderStorageBucketInfo).call(this) : Lit.nothing}
        ${__classPrivateFieldGet(this, _StorageMetadataView_storageBucketsModel, "f") ? __classPrivateFieldGet(this, _StorageMetadataView_instances, "m", _StorageMetadataView_renderBucketControls).call(this) : Lit.nothing}`;
        // clang-format on
    }
}
_StorageMetadataView_shadow = new WeakMap(), _StorageMetadataView_storageBucketsModel = new WeakMap(), _StorageMetadataView_storageKey = new WeakMap(), _StorageMetadataView_storageBucket = new WeakMap(), _StorageMetadataView_instances = new WeakSet(), _StorageMetadataView_renderStorageBucketInfo = function _StorageMetadataView_renderStorageBucketInfo() {
    ...
    const ok = await UI.UIUtils.ConfirmDialog.show(i18nString(UIStrings.bucketWillBeRemoved), i18nString(UIStrings.confirmBucketDeletion, { PH1: __classPrivateFieldGet(this, _StorageMetadataView_storageBucket, "f").bucket.name || '' }), this, { jslogContext: 'delete-bucket-confirmation' });
    if (ok) {
