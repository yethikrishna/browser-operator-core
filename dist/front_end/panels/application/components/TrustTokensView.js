...
var _TrustTokensView_instances, _TrustTokensView_shadow, _TrustTokensView_deleteClickHandler, _TrustTokensView_renderGridOrNoDataMessage;
                ...
                <tr>
                  ...
                  <td>
                    <devtools-button .iconName=${'bin'}
                                    ...
                                    @click=${__classPrivateFieldGet(this, _TrustTokensView_instances, "m", _TrustTokensView_deleteClickHandler).bind(this, removeTrailingSlash(token.issuerOrigin))}></devtools-button>
                  </td>
                </tr>
              `)}
          </table>
