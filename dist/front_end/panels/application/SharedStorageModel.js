...
export class SharedStorageForOrigin extends Common.ObjectWrapper.ObjectWrapper {
    ...
    async getMetadata() {
        return await __classPrivateFieldGet(this, _SharedStorageForOrigin_model, "f").storageAgent.invoke_getSharedStorageMetadata({ ownerOrigin: this.securityOrigin })
            .then(({ metadata }) => metadata);
    }
    async getEntries() {
        return await __classPrivateFieldGet(this, _SharedStorageForOrigin_model, "f").storageAgent.invoke_getSharedStorageEntries({ ownerOrigin: this.securityOrigin })
...
(function (SharedStorageForOrigin) {
    let Events;
    (function (Events) {
        Events["SHARED_STORAGE_CHANGED"] = "SharedStorageChanged";
...
export class SharedStorageModel extends SDK.SDKModel.SDKModel {
    constructor(target) {
        ...
        __classPrivateFieldSet(this, _SharedStorageModel_securityOriginManager, target.model(SDK.SecurityOriginManager.SecurityOriginManager), "f");
    ...
    async enable() {
        ...
        __classPrivateFieldGet(this, _SharedStorageModel_securityOriginManager, "f").addEventListener(SDK.SecurityOriginManager.Events.SecurityOriginAdded, __classPrivateFieldGet(this, _SharedStorageModel_instances, "m", _SharedStorageModel_securityOriginAdded), this);
        __classPrivateFieldGet(this, _SharedStorageModel_securityOriginManager, "f").addEventListener(SDK.SecurityOriginManager.Events.SecurityOriginRemoved, __classPrivateFieldGet(this, _SharedStorageModel_instances, "m", _SharedStorageModel_securityOriginRemoved), this);
    ...
    disable() {
        ...
        __classPrivateFieldGet(this, _SharedStorageModel_securityOriginManager, "f").removeEventListener(SDK.SecurityOriginManager.Events.SecurityOriginAdded, __classPrivateFieldGet(this, _SharedStorageModel_instances, "m", _SharedStorageModel_securityOriginAdded), this);
        __classPrivateFieldGet(this, _SharedStorageModel_securityOriginManager, "f").removeEventListener(SDK.SecurityOriginManager.Events.SecurityOriginRemoved, __classPrivateFieldGet(this, _SharedStorageModel_instances, "m", _SharedStorageModel_securityOriginRemoved), this);
...
export var Events;
(function (Events) {
    Events["SHARED_STORAGE_ACCESS"] = "SharedStorageAccess";
    Events["SHARED_STORAGE_ADDED"] = "SharedStorageAdded";
    Events["SHARED_STORAGE_REMOVED"] = "SharedStorageRemoved";
})(Events || (Events = {}));
