...
var _MismatchedPreloadingGrid_instances, _MismatchedPreloadingGrid_shadow, _MismatchedPreloadingGrid_data, _MismatchedPreloadingGrid_render;
...
_MismatchedPreloadingGrid_shadow = new WeakMap(), _MismatchedPreloadingGrid_data = new WeakMap(), _MismatchedPreloadingGrid_instances = new WeakSet(), _MismatchedPreloadingGrid_render = function _MismatchedPreloadingGrid_render() {
    if (!__classPrivateFieldGet(this, _MismatchedPreloadingGrid_data, "f")) {
        return;
    }
    const { pageURL } = __classPrivateFieldGet(this, _MismatchedPreloadingGrid_data, "f");
    render(html `<devtools-data-grid striped inline>
          <table>
            ...
            ${__classPrivateFieldGet(this, _MismatchedPreloadingGrid_data, "f").rows
        .map(row => ({
        row,
        ...
        </devtools-data-grid>`, __classPrivateFieldGet(this, _MismatchedPreloadingGrid_shadow, "f"), { host: this });
};
