...
var _PreloadingDetailsReportView_instances, _PreloadingDetailsReportView_shadow, _PreloadingDetailsReportView_data, _PreloadingDetailsReportView_render, _PreloadingDetailsReportView_url, _PreloadingDetailsReportView_action, _PreloadingDetailsReportView_status, _PreloadingDetailsReportView_maybePrefetchFailureReason, _PreloadingDetailsReportView_targetHint, _PreloadingDetailsReportView_maybePrerenderFailureReason, _PreloadingDetailsReportView_renderRuleSet;
...
_PreloadingDetailsReportView_shadow = new WeakMap(), _PreloadingDetailsReportView_data = new WeakMap(), _PreloadingDetailsReportView_instances = new WeakSet(), _PreloadingDetailsReportView_render = async function _PreloadingDetailsReportView_render() {
    await RenderCoordinator.write('PreloadingDetailsReportView render', () => {
        ...
        const pipeline = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline;
        ...
        <devtools-report
          ...
          ${__classPrivateFieldGet(this, _PreloadingDetailsReportView_instances, "m", _PreloadingDetailsReportView_action).call(this, isFallbackToPrefetch)}
          ${__classPrivateFieldGet(this, _PreloadingDetailsReportView_instances, "m", _PreloadingDetailsReportView_status).call(this, isFallbackToPrefetch)}
          ${__classPrivateFieldGet(this, _PreloadingDetailsReportView_instances, "m", _PreloadingDetailsReportView_targetHint).call(this)}
    ...
    assertNotNullOrUndefined(__classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f"));
    const attempt = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline.getOriginallyTriggered();
    const prefetchStatus = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline.getPrefetch()?.status;
    let value;
    if (attempt.action === "Prefetch" /* Protocol.Preload.SpeculationAction.Prefetch */ && attempt.requestId !== undefined &&
        ...
        value = html `
          <devtools-request-link-icon
            .data=${{
            affectedRequest,
            requestResolver: __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").requestResolver || new Logs.RequestResolver.RequestResolver(),
            displayURL: true,
            urlToDisplay: url,
        }}
          >
    ...
    `;
    // clang-format on
}, _PreloadingDetailsReportView_action = function _PreloadingDetailsReportView_action(isFallbackToPrefetch) {
    assertNotNullOrUndefined(__classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f"));
    const attempt = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline.getOriginallyTriggered();
    ...
    `;
    // clang-format on
}, _PreloadingDetailsReportView_status = function _PreloadingDetailsReportView_status(isFallbackToPrefetch) {
    assertNotNullOrUndefined(__classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f"));
    const attempt = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline.getOriginallyTriggered();
    ...
    `;
}, _PreloadingDetailsReportView_targetHint = function _PreloadingDetailsReportView_targetHint() {
    assertNotNullOrUndefined(__classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f"));
    const attempt = __classPrivateFieldGet(this, _PreloadingDetailsReportView_data, "f").pipeline.getOriginallyTriggered();
