...
export class PreloadingRuleSetView extends UI.Widget.VBox {
    constructor(model) {
        ...
        this.warningsView = new PreloadingWarningsView();
        this.ruleSetGrid = new PreloadingComponents.RuleSetGrid.RuleSetGrid();
        this.ruleSetDetails = new PreloadingComponents.RuleSetDetailsView.RuleSetDetailsView();
...
export class PreloadingAttemptView extends UI.Widget.VBox {
    constructor(model) {
        ...
        this.focusedPreloadingAttemptId = null;
        this.warningsView = new PreloadingWarningsView();
        this.preloadingGrid = new PreloadingComponents.PreloadingGrid.PreloadingGrid();
        this.preloadingDetails = new PreloadingComponents.PreloadingDetailsReportView.PreloadingDetailsReportView();
        this.registerRequiredCSS(emptyWidgetStyles, preloadingViewStyles);
...
export class PreloadingSummaryView extends UI.Widget.VBox {
    constructor(model) {
        super(/* isWebComponent */ true, /* delegatesFocus */ false);
        this.warningsView = new PreloadingWarningsView();
        this.usedPreloading = new PreloadingComponents.UsedPreloadingView.UsedPreloadingView();
        this.registerRequiredCSS(emptyWidgetStyles, preloadingViewStyles);
...
export class PreloadingWarningsView extends UI.Widget.VBox {
    constructor() {
        ...
        this.infobar = new PreloadingComponents.PreloadingDisabledInfobar.PreloadingDisabledInfobar();
