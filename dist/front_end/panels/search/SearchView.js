...
var _SearchView_instances, _SearchView_throttler, _SearchView_pendingSearchResults, _SearchView_emptyStartView, _SearchView_addPendingSearchResults;
...
export class SearchView extends UI.Widget.VBox {
    constructor(settingKey, throttler) {
        ...
        _SearchView_emptyStartView.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _SearchView_emptyStartView, new UI.EmptyWidget.EmptyWidget(i18nString(UIStrings.noSearchResult), i18nString(UIStrings.typeAndPressSToSearch, {
            PH1: UI.KeyboardShortcut.KeyboardShortcut.shortcutToString(UI.KeyboardShortcut.Keys.Enter)
        })), "f");
        this.showPane(__classPrivateFieldGet(this, _SearchView_emptyStartView, "f"));
    }
    regexButtonToggled() {
...
_SearchView_throttler = new WeakMap(), _SearchView_pendingSearchResults = new WeakMap(), _SearchView_emptyStartView = new WeakMap(), _SearchView_instances = new WeakSet(), _SearchView_addPendingSearchResults = function _SearchView_addPendingSearchResults() {
