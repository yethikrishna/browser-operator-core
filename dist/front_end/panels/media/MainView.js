...
export class MainView extends UI.Panel.PanelWithSidebar {
    constructor(downloadStore = new PlayerDataDownloadManager()) {
        super('media');
        _MainView_placeholder.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _MainView_placeholder, new UI.EmptyWidget.EmptyWidget(i18nString(UIStrings.noMediaPlayer), UIStrings.mediaPlayerDescription), "f");
        __classPrivateFieldGet(this, _MainView_placeholder, "f").show(this.mainElement());
        __classPrivateFieldGet(this, _MainView_placeholder, "f").link = MEDIA_PLAYER_EXPLANATION_URL;
    ...
    onPlayerCreated(playerID) {
        ...
        if (this.detailPanels.size === 1) {
            __classPrivateFieldGet(this, _MainView_placeholder, "f").header = i18nString(UIStrings.noPlayerDetailsSelected);
            __classPrivateFieldGet(this, _MainView_placeholder, "f").text = i18nString(UIStrings.selectToViewDetails);
        }
    }
    ...
    markPlayerForDeletion(playerID) {
        ...
        if (this.detailPanels.size === 0) {
            __classPrivateFieldGet(this, _MainView_placeholder, "f").header = i18nString(UIStrings.noMediaPlayer);
            __classPrivateFieldGet(this, _MainView_placeholder, "f").text = i18nString(UIStrings.mediaPlayerDescription);
            this.splitWidget().hideSidebar();
            const mainWidget = this.splitWidget().mainWidget();
            if (mainWidget) {
                mainWidget.detachChildWidgets();
...
_MainView_placeholder = new WeakMap();
