...
var _PromiseQueue_promise, _ThrottlingManager_instances, _ThrottlingManager_hardwareConcurrencyOverrideEnabled, _ThrottlingManager_emulationQueue, _ThrottlingManager_getCurrentNetworkConditions;
...
class PromiseQueue {
    constructor() {
        _PromiseQueue_promise.set(this, Promise.resolve());
    }
    push(promise) {
        return new Promise(r => {
            __classPrivateFieldSet(this, _PromiseQueue_promise, __classPrivateFieldGet(this, _PromiseQueue_promise, "f").then(async () => r(await promise)), "f");
        });
    }
}
_PromiseQueue_promise = new WeakMap();
export class ThrottlingManager extends Common.ObjectWrapper.ObjectWrapper {
    get hardwareConcurrencyOverrideEnabled() {
        return __classPrivateFieldGet(this, _ThrottlingManager_hardwareConcurrencyOverrideEnabled, "f");
    }
    constructor() {
        super();
        _ThrottlingManager_instances.add(this);
        _ThrottlingManager_hardwareConcurrencyOverrideEnabled.set(this, false);
        _ThrottlingManager_emulationQueue.set(this, new PromiseQueue());
        ...
        SDK.NetworkManager.MultitargetNetworkManager.instance().addEventListener("ConditionsChanged" /* SDK.NetworkManager.MultitargetNetworkManager.Events.CONDITIONS_CHANGED */, () => {
            this.lastNetworkThrottlingConditions = __classPrivateFieldGet(this, _ThrottlingManager_instances, "m", _ThrottlingManager_getCurrentNetworkConditions).call(this);
        ...
        if (this.isDirty()) {
            SDK.NetworkManager.MultitargetNetworkManager.instance().setNetworkConditions(__classPrivateFieldGet(this, _ThrottlingManager_instances, "m", _ThrottlingManager_getCurrentNetworkConditions).call(this));
        }
    }
            ...
            switch (select.selectedOptions.item(0)) {
                case reset:
                    for (const emulationModel of SDK.TargetManager.TargetManager.instance().models(SDK.EmulationModel.EmulationModel)) {
                        void __classPrivateFieldGet(this, _ThrottlingManager_emulationQueue, "f").push(emulationModel.setDataSaverOverride("unset" /* SDK.EmulationModel.DataSaverOverride.UNSET */));
                    }
                    break;
                case enable:
                    for (const emulationModel of SDK.TargetManager.TargetManager.instance().models(SDK.EmulationModel.EmulationModel)) {
                        void __classPrivateFieldGet(this, _ThrottlingManager_emulationQueue, "f").push(emulationModel.setDataSaverOverride("enabled" /* SDK.EmulationModel.DataSaverOverride.ENABLED */));
                    }
                    break;
                case disable:
                    for (const emulationModel of SDK.TargetManager.TargetManager.instance().models(SDK.EmulationModel.EmulationModel)) {
                        void __classPrivateFieldGet(this, _ThrottlingManager_emulationQueue, "f").push(emulationModel.setDataSaverOverride("disabled" /* SDK.EmulationModel.DataSaverOverride.DISABLED */));
                    }
                    break;
            }
    ...
    createHardwareConcurrencySelector() {
        ...
        void this.cpuThrottlingManager.getHardwareConcurrency().then(defaultValue => {
            ...
            checkbox.addEventListener('change', () => {
                __classPrivateFieldSet(this, _ThrottlingManager_hardwareConcurrencyOverrideEnabled, checkbox.checked, "f");
    ...
    isDirty() {
        ...
        const knownCurrentConditions = __classPrivateFieldGet(this, _ThrottlingManager_instances, "m", _ThrottlingManager_getCurrentNetworkConditions).call(this);
        return !SDK.NetworkManager.networkConditionsEqual(networkConditions, knownCurrentConditions);
    }
}
_ThrottlingManager_hardwareConcurrencyOverrideEnabled = new WeakMap(), _ThrottlingManager_emulationQueue = new WeakMap(), _ThrottlingManager_instances = new WeakSet(), _ThrottlingManager_getCurrentNetworkConditions = function _ThrottlingManager_getCurrentNetworkConditions() {
