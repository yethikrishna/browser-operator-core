...
var _ThrottlingSettingsTab_customUserConditionsCount;
...
export class ThrottlingSettingsTab extends UI.Widget.VBox {
    constructor() {
         ...
         */
        _ThrottlingSettingsTab_customUserConditionsCount.set(this, void 0);
        ...
        if (key && SDK.NetworkManager.keyIsCustomUser(key)) {
            ...
            __classPrivateFieldSet(this, _ThrottlingSettingsTab_customUserConditionsCount, maxIndex, "f");
        }
        else {
            __classPrivateFieldSet(this, _ThrottlingSettingsTab_customUserConditionsCount, 0, "f");
        }
    }
    wasShown() {
        super.wasShown();
    ...
    addButtonClicked() {
        var _a;
        __classPrivateFieldSet(this, _ThrottlingSettingsTab_customUserConditionsCount, (_a = __classPrivateFieldGet(this, _ThrottlingSettingsTab_customUserConditionsCount, "f"), _a++, _a), "f");
        this.list.addNewItem(this.customUserConditions.get().length, {
            key: `USER_CUSTOM_SETTING_${__classPrivateFieldGet(this, _ThrottlingSettingsTab_customUserConditionsCount, "f")}`,
            title: () => '',
            download: -1,
            upload: -1,
            latency: 0,
...
_ThrottlingSettingsTab_customUserConditionsCount = new WeakMap();
