...
var _CalibrationController_instances, _CalibrationController_runtimeModel, _CalibrationController_emulationModel, _CalibrationController_originalUrl, _CalibrationController_result, _CalibrationController_state, _CalibrationController_throttle, _CalibrationController_benchmark;
...
export class CalibrationController {
    constructor() {
        _CalibrationController_instances.add(this);
        _CalibrationController_runtimeModel.set(this, void 0);
        _CalibrationController_emulationModel.set(this, void 0);
        _CalibrationController_originalUrl.set(this, void 0);
        _CalibrationController_result.set(this, void 0);
        _CalibrationController_state.set(this, 'idle');
    }
    /**
    ...
    async start() {
        ...
        __classPrivateFieldSet(this, _CalibrationController_state, 'running', "f");
        __classPrivateFieldSet(this, _CalibrationController_runtimeModel, runtimeModel, "f");
        __classPrivateFieldSet(this, _CalibrationController_emulationModel, emulationModel, "f");
        __classPrivateFieldSet(this, _CalibrationController_originalUrl, primaryPageTarget.inspectedURL(), "f");
      ...
      `;
        ...
        await __classPrivateFieldGet(this, _CalibrationController_instances, "m", _CalibrationController_benchmark).call(this);
        return true;
    }
    async *iterator() {
        ...
        async function run(rate) {
            ...
            await __classPrivateFieldGet(controller, _CalibrationController_instances, "m", _CalibrationController_throttle).call(controller, rate);
            const score = await __classPrivateFieldGet(controller, _CalibrationController_instances, "m", _CalibrationController_benchmark).call(controller);
        ...
        __classPrivateFieldSet(this, _CalibrationController_result, {}, "f");
        ...
        if (actualScore < midScore) {
            ...
            if (actualScore < midScore) {
                if (actualScore < lowScore) {
                    __classPrivateFieldSet(this, _CalibrationController_result, {
                ...
                __classPrivateFieldSet(this, _CalibrationController_result, { mid: SDK.CPUThrottlingManager.CalibrationError.DEVICE_TOO_WEAK }, "f");
                isHalfwayDone = true;
            }
        }
        ...
        __classPrivateFieldGet(this, _CalibrationController_result, "f").low = low;
        if (!__classPrivateFieldGet(this, _CalibrationController_result, "f").mid) {
            isHalfwayDone = true;
            yield { progress: 0.5 };
            ...
            __classPrivateFieldGet(this, _CalibrationController_result, "f").mid = mid;
        }
        yield { progress: 1 };
    }
    abort() {
        if (__classPrivateFieldGet(this, _CalibrationController_state, "f") === 'running') {
            __classPrivateFieldSet(this, _CalibrationController_state, 'aborting', "f");
        }
    }
    result() {
        return __classPrivateFieldGet(this, _CalibrationController_result, "f");
    }
    async end() {
        if (__classPrivateFieldGet(this, _CalibrationController_state, "f") === 'idle') {
            return;
        }
        __classPrivateFieldSet(this, _CalibrationController_state, 'idle', "f");
        if (__classPrivateFieldGet(this, _CalibrationController_originalUrl, "f").startsWith('chrome://')) {
            await __classPrivateFieldGet(this, _CalibrationController_runtimeModel, "f").agent.invoke_evaluate({
                expression: 'history.back()',
            });
        }
        else {
            await __classPrivateFieldGet(this, _CalibrationController_runtimeModel, "f").agent.invoke_evaluate({
                expression: `window.location.href = ${JSON.stringify(__classPrivateFieldGet(this, _CalibrationController_originalUrl, "f"))}`,
            });
        }
    }
}
_CalibrationController_runtimeModel = new WeakMap(), _CalibrationController_emulationModel = new WeakMap(), _CalibrationController_originalUrl = new WeakMap(), _CalibrationController_result = new WeakMap(), _CalibrationController_state = new WeakMap(), _CalibrationController_instances = new WeakSet(), _CalibrationController_throttle = async function _CalibrationController_throttle(rate) {
    if (__classPrivateFieldGet(this, _CalibrationController_state, "f") !== 'running') {
        __classPrivateFieldSet(this, _CalibrationController_result, undefined, "f");
        throw new Error('Calibration has been canceled');
    }
    await __classPrivateFieldGet(this, _CalibrationController_emulationModel, "f").setCPUThrottlingRate(rate);
}, _CalibrationController_benchmark = async function _CalibrationController_benchmark() {
    if (__classPrivateFieldGet(this, _CalibrationController_state, "f") !== 'running') {
        __classPrivateFieldSet(this, _CalibrationController_result, undefined, "f");
        throw new Error('Calibration has been canceled');
    }
    const { result } = await __classPrivateFieldGet(this, _CalibrationController_runtimeModel, "f").agent.invoke_evaluate({
