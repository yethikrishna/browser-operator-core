...
export class SensorsView extends UI.Widget.VBox {
    constructor() {
        ...
        __classPrivateFieldSet(this, _SensorsView_locationSetting, Common.Settings.Settings.instance().createSetting('emulation.location-override', ''), "f");
        __classPrivateFieldSet(this, _SensorsView_location, SDK.EmulationModel.Location.parseSetting(__classPrivateFieldGet(this, _SensorsView_locationSetting, "f").get()), "f");
...
_SensorsView_locationSetting = new WeakMap(), _SensorsView_location = new WeakMap(), _SensorsView_locationOverrideEnabled = new WeakMap(), _SensorsView_instances = new WeakSet(), _SensorsView_locationSelectChanged = function _SensorsView_locationSelectChanged() {
    ...
    if (value === NonPresetOptions.NoOverride) {
        ...
        __classPrivateFieldSet(this, _SensorsView_locationOverrideEnabled, true, "f");
        __classPrivateFieldSet(this, _SensorsView_location, new SDK.EmulationModel.Location(0, 0, '', '', SDK.EmulationModel.Location.DEFAULT_ACCURACY, true), "f");
    }
    else {
        __classPrivateFieldSet(this, _SensorsView_locationOverrideEnabled, true, "f");
        const coordinates = JSON.parse(value);
        __classPrivateFieldSet(this, _SensorsView_location, new SDK.EmulationModel.Location(coordinates.lat, coordinates.long, coordinates.timezoneId, coordinates.locale, coordinates.accuracy || SDK.EmulationModel.Location.DEFAULT_ACCURACY, false), "f");
