...
export class LinearMemoryInspectorController extends SDK.TargetManager.SDKModelObserver {
    constructor() {
        ...
        _LinearMemoryInspectorController_paneInstance.set(this, LinearMemoryInspectorPane.instance());
        ...
        SDK.TargetManager.TargetManager.instance().addModelListener(SDK.DebuggerModel.DebuggerModel, SDK.DebuggerModel.Events.GlobalObjectCleared, __classPrivateFieldGet(this, _LinearMemoryInspectorController_instances, "m", _LinearMemoryInspectorController_onGlobalObjectClear), this);
        __classPrivateFieldGet(this, _LinearMemoryInspectorController_paneInstance, "f").addEventListener("ViewClosed" /* LmiEvents.VIEW_CLOSED */, __classPrivateFieldGet(this, _LinearMemoryInspectorController_instances, "m", _LinearMemoryInspectorController_viewClosed).bind(this));
        SDK.TargetManager.TargetManager.instance().addModelListener(SDK.DebuggerModel.DebuggerModel, SDK.DebuggerModel.Events.DebuggerPaused, __classPrivateFieldGet(this, _LinearMemoryInspectorController_instances, "m", _LinearMemoryInspectorController_onDebuggerPause), this);
        ...
        __classPrivateFieldSet(this, _LinearMemoryInspectorController_settings, Common.Settings.Settings.instance().createSetting('lmi-interpreter-settings', defaultSettings), "f");
    }
    static instance() {
