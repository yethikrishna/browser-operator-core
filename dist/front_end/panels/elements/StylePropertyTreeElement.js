...
var _FlexGridRenderer_treeElement, _FlexGridRenderer_stylesPane, _CSSWideKeywordRenderer_treeElement, _CSSWideKeywordRenderer_stylesPane, _VariableRenderer_instances, _VariableRenderer_stylesPane, _VariableRenderer_treeElement, _VariableRenderer_matchedStyles, _VariableRenderer_computedStyles, _VariableRenderer_handleVarDefinitionActivate, _RelativeColorChannelRenderer_treeElement, _ColorRenderer_instances, _ColorRenderer_treeElement, _ColorRenderer_stylesPane, _ColorRenderer_getValueChild, _ColorRenderer_addColorContrastInfo, _LightDarkColorRenderer_instances, _LightDarkColorRenderer_treeElement, _LightDarkColorRenderer_stylesPane, _LightDarkColorRenderer_matchedStyles, _LightDarkColorRenderer_activeColor, _ColorMixRenderer_pane, _ColorMixRenderer_matchedStyles, _ColorMixRenderer_computedStyles, _ColorMixRenderer_treeElement, _AngleRenderer_treeElement, _LinkableNameRenderer_instances, _LinkableNameRenderer_matchedStyles, _LinkableNameRenderer_stylesPane, _LinkableNameRenderer_getLinkData, _BezierRenderer_treeElement, _AutoBaseRenderer_computedStyle, _ShadowModel_instances, _ShadowModel_properties, _ShadowModel_shadowType, _ShadowModel_context, _ShadowModel_length, _ShadowModel_needsExpansion, _ShadowModel_expandPropertyIfNeeded, _ShadowModel_expandOrGetProperty, _ShadowModel_setLength, _ShadowRenderer_treeElement, _LengthRenderer_instances, _LengthRenderer_stylesPane, _LengthRenderer_treeElement, _LengthRenderer_propertyName, _LengthRenderer_applyEvaluation, _LengthRenderer_attachPopover, _MathFunctionRenderer_stylesPane, _MathFunctionRenderer_matchedStyles, _MathFunctionRenderer_computedStyles, _MathFunctionRenderer_treeElement, _MathFunctionRenderer_propertyName, _AnchorFunctionRenderer_stylesPane, _PositionAnchorRenderer_stylesPane, _PositionTryRenderer_matchedStyles, _StylePropertyTreeElement_instances, _a, _StylePropertyTreeElement_parentSection, _StylePropertyTreeElement_gridNames, _StylePropertyTreeElement_tooltipKeyCounts, _StylePropertyTreeElement_getLonghandProperties, _StylePropertyTreeElement_computeCSSExpression, _StylePropertyTreeElement_startEditing, _StylePropertyTreeElement_selectionLeftOffset;
...
export class FlexGridRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.FlexGridMatch) {
    constructor(stylesPane, treeElement) {
        super();
        // clang-format on
        _FlexGridRenderer_treeElement.set(this, void 0);
        _FlexGridRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _FlexGridRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _FlexGridRenderer_stylesPane, stylesPane, "f");
    }
    render(match, context) {
        const children = Renderer.render(ASTUtils.siblings(ASTUtils.declValue(match.node)), context).nodes;
        if (!__classPrivateFieldGet(this, _FlexGridRenderer_treeElement, "f")?.editable()) {
            return children;
        }
        const key = `${__classPrivateFieldGet(this, _FlexGridRenderer_treeElement, "f").section().getSectionIdx()}_${__classPrivateFieldGet(this, _FlexGridRenderer_treeElement, "f").section().nextEditorTriggerButtonIdx}`;
        const button = StyleEditorWidget.createTriggerButton(__classPrivateFieldGet(this, _FlexGridRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _FlexGridRenderer_treeElement, "f").section(), match.isFlex ? FlexboxEditor : GridEditor, match.isFlex ? i18nString(UIStrings.flexboxEditorButton) : i18nString(UIStrings.gridEditorButton), key);
        button.tabIndex = -1;
        button.setAttribute('jslog', `${VisualLogging.showStyleEditor().track({ click: true }).context(match.isFlex ? 'flex' : 'grid')}`);
        __classPrivateFieldGet(this, _FlexGridRenderer_treeElement, "f").section().nextEditorTriggerButtonIdx++;
        button.addEventListener('click', () => {
            Host.userMetrics.swatchActivated(match.isFlex ? 6 /* Host.UserMetrics.SwatchType.FLEX */ : 5 /* Host.UserMetrics.SwatchType.GRID */);
        });
        const helper = __classPrivateFieldGet(this, _FlexGridRenderer_stylesPane, "f").swatchPopoverHelper();
...
_FlexGridRenderer_treeElement = new WeakMap(), _FlexGridRenderer_stylesPane = new WeakMap();
// clang-format off
export class CSSWideKeywordRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.CSSWideKeywordMatch) {
    constructor(stylesPane, treeElement) {
        super();
        // clang-format on
        _CSSWideKeywordRenderer_treeElement.set(this, void 0);
        _CSSWideKeywordRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _CSSWideKeywordRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _CSSWideKeywordRenderer_stylesPane, stylesPane, "f");
    }
    render(match, context) {
        ...
        swatch.data = {
            ...
            onLinkActivate: () => resolvedProperty && __classPrivateFieldGet(this, _CSSWideKeywordRenderer_stylesPane, "f").jumpToDeclaration(resolvedProperty),
        ...
        if (SDK.CSSMetadata.cssMetadata().isColorAwareProperty(resolvedProperty.name) ||
            ...
            if (color) {
                return [new ColorRenderer(__classPrivateFieldGet(this, _CSSWideKeywordRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _CSSWideKeywordRenderer_treeElement, "f")).renderColorSwatch(color, swatch), swatch];
            }
        }
        return [swatch];
    }
}
_CSSWideKeywordRenderer_treeElement = new WeakMap(), _CSSWideKeywordRenderer_stylesPane = new WeakMap();
// clang-format off
export class VariableRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.VariableMatch) {
    constructor(stylesPane, treeElement, matchedStyles, computedStyles) {
        ...
        // clang-format on
        _VariableRenderer_stylesPane.set(this, void 0);
        _VariableRenderer_treeElement.set(this, void 0);
        _VariableRenderer_matchedStyles.set(this, void 0);
        _VariableRenderer_computedStyles.set(this, void 0);
        __classPrivateFieldSet(this, _VariableRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _VariableRenderer_stylesPane, stylesPane, "f");
        __classPrivateFieldSet(this, _VariableRenderer_matchedStyles, matchedStyles, "f");
        __classPrivateFieldSet(this, _VariableRenderer_computedStyles, computedStyles, "f");
    }
    render(match, context) {
        if (__classPrivateFieldGet(this, _VariableRenderer_treeElement, "f")?.property.ownerStyle.parentRule instanceof SDK.CSSRule.CSSFunctionRule) {
        ...
        const onLinkActivate = (name) => __classPrivateFieldGet(this, _VariableRenderer_instances, "m", _VariableRenderer_handleVarDefinitionActivate).call(this, declaration ?? name);
        const varSwatch = document.createElement('span');
        const substitution = context.tracing?.substitution({ match, context });
        if (substitution) {
            if (declaration?.declaration) {
                const { nodes, cssControls } = Renderer.renderValueNodes({ name: declaration.name, value: declaration.value ?? '' }, substitution.cachedParsedValue(declaration.declaration, __classPrivateFieldGet(this, _VariableRenderer_matchedStyles, "f"), __classPrivateFieldGet(this, _VariableRenderer_computedStyles, "f")), getPropertyRenderers(declaration.name, declaration.style, __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _VariableRenderer_matchedStyles, "f"), null, __classPrivateFieldGet(this, _VariableRenderer_computedStyles, "f")), substitution);
        ...
        const varCall = __classPrivateFieldGet(this, _VariableRenderer_treeElement, "f")?.getTracingTooltip('var', match.node, __classPrivateFieldGet(this, _VariableRenderer_matchedStyles, "f"), __classPrivateFieldGet(this, _VariableRenderer_computedStyles, "f"), context);
        const tooltipContents = __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f").getVariablePopoverContents(__classPrivateFieldGet(this, _VariableRenderer_matchedStyles, "f"), match.name, variableValue ?? null);
        const tooltipId = __classPrivateFieldGet(this, _VariableRenderer_treeElement, "f")?.getTooltipId('custom-property-var');
    ...
    `, varSwatch);
        ...
        const colorSwatch = new ColorRenderer(__classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _VariableRenderer_treeElement, "f")).renderColorSwatch(color, varSwatch);
...
_VariableRenderer_stylesPane = new WeakMap(), _VariableRenderer_treeElement = new WeakMap(), _VariableRenderer_matchedStyles = new WeakMap(), _VariableRenderer_computedStyles = new WeakMap(), _VariableRenderer_instances = new WeakSet(), _VariableRenderer_handleVarDefinitionActivate = function _VariableRenderer_handleVarDefinitionActivate(variable) {
    Host.userMetrics.actionTaken(Host.UserMetrics.Action.CustomPropertyLinkClicked);
    Host.userMetrics.swatchActivated(0 /* Host.UserMetrics.SwatchType.VAR_LINK */);
    if (typeof variable === 'string') {
        __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f").jumpToProperty(variable) ||
            __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f").jumpToProperty('initial-value', variable, REGISTERED_PROPERTY_SECTION_NAME);
    }
    else if (variable.declaration instanceof SDK.CSSProperty.CSSProperty) {
        __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f").revealProperty(variable.declaration);
    }
    else if (variable.declaration instanceof SDK.CSSMatchedStyles.CSSRegisteredProperty) {
        __classPrivateFieldGet(this, _VariableRenderer_stylesPane, "f").jumpToProperty('initial-value', variable.name, REGISTERED_PROPERTY_SECTION_NAME);
    }
};
// clang-format off
...
export class RelativeColorChannelRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.RelativeColorChannelMatch) {
    constructor(treeElement) {
        super();
        // clang-format on
        _RelativeColorChannelRenderer_treeElement.set(this, void 0);
        __classPrivateFieldSet(this, _RelativeColorChannelRenderer_treeElement, treeElement, "f");
    }
    render(match, context) {
        ...
        const tooltipId = __classPrivateFieldGet(this, _RelativeColorChannelRenderer_treeElement, "f")?.getTooltipId('relative-color-channel');
        if (!tooltipId) {
            return [span];
        }
...
_RelativeColorChannelRenderer_treeElement = new WeakMap();
// clang-format off
export class ColorRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.ColorMatch) {
    constructor(stylesPane, treeElement) {
        ...
        // clang-format on
        _ColorRenderer_treeElement.set(this, void 0);
        _ColorRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _ColorRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _ColorRenderer_stylesPane, stylesPane, "f");
    }
    render(match, context) {
        const { valueChild, cssControls, childTracingContexts } = __classPrivateFieldGet(this, _ColorRenderer_instances, "m", _ColorRenderer_getValueChild).call(this, match, context);
        ...
        if (match.node.name === 'CallExpression' && childTracingContexts) {
            const evaluation = context.tracing?.applyEvaluation(childTracingContexts, () => {
                ...
                const swatch = new ColorRenderer(__classPrivateFieldGet(this, _ColorRenderer_stylesPane, "f"), null)
    ...
    renderColorSwatch(color, valueChild) {
        const editable = __classPrivateFieldGet(this, _ColorRenderer_treeElement, "f")?.editable();
        ...
        if (__classPrivateFieldGet(this, _ColorRenderer_treeElement, "f")?.editable()) {
            const treeElement = __classPrivateFieldGet(this, _ColorRenderer_treeElement, "f");
...
_ColorRenderer_treeElement = new WeakMap(), _ColorRenderer_stylesPane = new WeakMap(), _ColorRenderer_instances = new WeakSet(), _ColorRenderer_getValueChild = function _ColorRenderer_getValueChild(match, context) {
    ...
    render(html `${__classPrivateFieldGet(this, _ColorRenderer_treeElement, "f")?.getTracingTooltip(func, match.node, __classPrivateFieldGet(this, _ColorRenderer_treeElement, "f").matchedStyles(), __classPrivateFieldGet(this, _ColorRenderer_treeElement, "f").getComputedStyles() ?? new Map(), renderingContext) ??
    ...
    const cssModel = __classPrivateFieldGet(this, _ColorRenderer_stylesPane, "f").cssModel();
    const node = __classPrivateFieldGet(this, _ColorRenderer_stylesPane, "f").node();
...
export class LightDarkColorRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.LightDarkColorMatch) {
    constructor(stylesPane, matchedStyles, treeElement) {
        ...
        _LightDarkColorRenderer_stylesPane.set(this, void 0);
        _LightDarkColorRenderer_matchedStyles.set(this, void 0);
        __classPrivateFieldSet(this, _LightDarkColorRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _LightDarkColorRenderer_stylesPane, stylesPane, "f");
        __classPrivateFieldSet(this, _LightDarkColorRenderer_matchedStyles, matchedStyles, "f");
    }
    render(match, context) {
        ...
        const colorSwatch = new ColorRenderer(__classPrivateFieldGet(this, _LightDarkColorRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _LightDarkColorRenderer_treeElement, "f")).renderColorSwatch(undefined, content);
        context.addControl('color', colorSwatch);
...
_LightDarkColorRenderer_treeElement = new WeakMap(), _LightDarkColorRenderer_stylesPane = new WeakMap(), _LightDarkColorRenderer_matchedStyles = new WeakMap(), _LightDarkColorRenderer_instances = new WeakSet(), _LightDarkColorRenderer_activeColor = 
...
async function _LightDarkColorRenderer_activeColor(match) {
    const activeColorSchemes = __classPrivateFieldGet(this, _LightDarkColorRenderer_matchedStyles, "f").resolveProperty('color-scheme', match.style)
        ?.parseValue(__classPrivateFieldGet(this, _LightDarkColorRenderer_matchedStyles, "f"), new Map())
    ...
    switch (await __classPrivateFieldGet(this, _LightDarkColorRenderer_stylesPane, "f").cssModel()?.colorScheme()) {
...
export class ColorMixRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.ColorMixMatch) {
    constructor(pane, matchedStyles, computedStyles, treeElement) {
        ...
        _ColorMixRenderer_matchedStyles.set(this, void 0);
        _ColorMixRenderer_computedStyles.set(this, void 0);
        _ColorMixRenderer_treeElement.set(this, void 0);
        __classPrivateFieldSet(this, _ColorMixRenderer_pane, pane, "f");
        __classPrivateFieldSet(this, _ColorMixRenderer_matchedStyles, matchedStyles, "f");
        __classPrivateFieldSet(this, _ColorMixRenderer_computedStyles, computedStyles, "f");
        __classPrivateFieldSet(this, _ColorMixRenderer_treeElement, treeElement, "f");
    }
    render(match, context) {
        ...
        render(html `${__classPrivateFieldGet(this, _ColorMixRenderer_treeElement, "f")?.getTracingTooltip('color-mix', match.node, __classPrivateFieldGet(this, _ColorMixRenderer_matchedStyles, "f"), __classPrivateFieldGet(this, _ColorMixRenderer_computedStyles, "f"), context) ??
        ...
        const nodeId = __classPrivateFieldGet(this, _ColorMixRenderer_pane, "f").node()?.id;
        if (nodeId !== undefined && childTracingContexts) {
            const evaluation = context.tracing?.applyEvaluation(childTracingContexts, () => {
                ...
                const swatch = new ColorRenderer(__classPrivateFieldGet(this, _ColorMixRenderer_pane, "f"), null).renderColorSwatch(initialColor, colorText);
                swatch.addEventListener(InlineEditor.ColorSwatch.ColorChangedEvent.eventName, ev => {
                    colorText.textContent = ev.data.color.asString();
                });
                context.addControl('color', swatch);
                const asyncEvalCallback = async () => {
                    const results = await __classPrivateFieldGet(this, _ColorMixRenderer_pane, "f").cssModel()?.resolveValues(undefined, nodeId, colorMixText);
                    if (results) {
        ...
        const tooltipId = __classPrivateFieldGet(this, _ColorMixRenderer_treeElement, "f")?.getTooltipId('color-mix');
        if (!tooltipId) {
            return [swatch, contentChild];
        }
...
_ColorMixRenderer_pane = new WeakMap(), _ColorMixRenderer_matchedStyles = new WeakMap(), _ColorMixRenderer_computedStyles = new WeakMap(), _ColorMixRenderer_treeElement = new WeakMap();
// clang-format off
export class AngleRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.AngleMatch) {
    ...
    render(match, context) {
        ...
        const treeElement = __classPrivateFieldGet(this, _AngleRenderer_treeElement, "f");
...
export class LinkableNameRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.LinkableNameMatch) {
    constructor(matchedStyles, stylesSidebarPane) {
        ...
        // clang-format on
        _LinkableNameRenderer_matchedStyles.set(this, void 0);
        _LinkableNameRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _LinkableNameRenderer_matchedStyles, matchedStyles, "f");
        __classPrivateFieldSet(this, _LinkableNameRenderer_stylesPane, stylesSidebarPane, "f");
    }
    render(match) {
        const swatch = new InlineEditor.LinkSwatch.LinkSwatch();
        ...
        swatch.data = {
            ...
            onLinkActivate: () => {
                ...
                if (match.propertyName === "function" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.FUNCTION */) {
                    const functionName = __classPrivateFieldGet(this, _LinkableNameRenderer_matchedStyles, "f").getRegisteredFunction(match.text);
                    if (!functionName) {
                        return;
                    }
                    __classPrivateFieldGet(this, _LinkableNameRenderer_stylesPane, "f").jumpToFunctionDefinition(functionName);
                }
                else {
                    __classPrivateFieldGet(this, _LinkableNameRenderer_stylesPane, "f").jumpToSectionBlock(`${ruleBlock} ${match.text}`);
                }
            },
            jslogContext,
        };
        if (match.propertyName === "animation" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.ANIMATION */ ||
            ...
            const node = __classPrivateFieldGet(this, _LinkableNameRenderer_stylesPane, "f").node();
            if (node) {
...
_LinkableNameRenderer_matchedStyles = new WeakMap(), _LinkableNameRenderer_stylesPane = new WeakMap(), _LinkableNameRenderer_instances = new WeakSet(), _LinkableNameRenderer_getLinkData = function _LinkableNameRenderer_getLinkData(match) {
    switch (match.propertyName) {
        ...
        case "animation-name" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.ANIMATION_NAME */:
            return {
                ...
                ruleBlock: '@keyframes',
                isDefined: Boolean(__classPrivateFieldGet(this, _LinkableNameRenderer_matchedStyles, "f").keyframes().find(kf => kf.name().text === match.text)),
            };
        case "font-palette" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.FONT_PALETTE */:
            return {
                ...
                isDefined: __classPrivateFieldGet(this, _LinkableNameRenderer_matchedStyles, "f").fontPaletteValuesRule()?.name().text === match.text,
            };
        ...
        case "position-try-fallbacks" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.POSITION_TRY_FALLBACKS */:
            return {
                ...
                isDefined: Boolean(__classPrivateFieldGet(this, _LinkableNameRenderer_matchedStyles, "f").positionTryRules().find(pt => pt.name().text === match.text)),
            };
        case "function" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.FUNCTION */:
            return {
                ...
                metric: null,
                ruleBlock: '@function',
                isDefined: Boolean(__classPrivateFieldGet(this, _LinkableNameRenderer_matchedStyles, "f").getRegisteredFunction(match.text)),
            };
    }
};
// clang-format off
export class BezierRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.BezierMatch) {
    ...
    render(match, context) {
        ...
        new BezierPopoverIcon({ treeElement: __classPrivateFieldGet(this, _BezierRenderer_treeElement, "f"), swatchPopoverHelper, swatch: icon, bezierText });
...
export class AutoBaseRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.AutoBaseMatch) {
    ...
    constructor(computedStyle) {
        super();
        _AutoBaseRenderer_computedStyle.set(this, void 0);
        __classPrivateFieldSet(this, _AutoBaseRenderer_computedStyle, computedStyle, "f");
    }
    render(match, context) {
        const content = document.createElement('span');
        ...
        const activeAppearance = __classPrivateFieldGet(this, _AutoBaseRenderer_computedStyle, "f").get('appearance');
...
_AutoBaseRenderer_computedStyle = new WeakMap();
...
export class ShadowModel {
    ...
    isBoxShadow() {
        return __classPrivateFieldGet(this, _ShadowModel_shadowType, "f") === "boxShadow" /* SDK.CSSPropertyParserMatchers.ShadowType.BOX_SHADOW */;
    }
    inset() {
        return Boolean(__classPrivateFieldGet(this, _ShadowModel_properties, "f").find(property => property.propertyType === "inset" /* ShadowPropertyType.INSET */));
    }
    offsetX() {
        return __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_length).call(this, "x" /* ShadowPropertyType.X */);
    }
    offsetY() {
        return __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_length).call(this, "y" /* ShadowPropertyType.Y */);
    }
    blurRadius() {
        return __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_length).call(this, "blur" /* ShadowPropertyType.BLUR */);
    }
    spreadRadius() {
        return __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_length).call(this, "spread" /* ShadowPropertyType.SPREAD */);
    }
    setInset(inset) {
        if (!this.isBoxShadow()) {
            return;
        }
        const { property, index } = __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_expandOrGetProperty).call(this, "inset" /* ShadowPropertyType.INSET */);
        if (property) {
            ...
            __classPrivateFieldGet(this, _ShadowModel_properties, "f").unshift({ value: 'inset', source: null, expansionContext: null, propertyType: "inset" /* ShadowPropertyType.INSET */ });
        }
    }
    setOffsetX(value) {
        __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_setLength).call(this, value, "x" /* ShadowPropertyType.X */);
    }
    setOffsetY(value) {
        __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_setLength).call(this, value, "y" /* ShadowPropertyType.Y */);
    }
    setBlurRadius(value) {
        __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_setLength).call(this, value, "blur" /* ShadowPropertyType.BLUR */);
    }
    setSpreadRadius(value) {
        if (this.isBoxShadow()) {
            __classPrivateFieldGet(this, _ShadowModel_instances, "m", _ShadowModel_setLength).call(this, value, "spread" /* ShadowPropertyType.SPREAD */);
        }
    }
    renderContents(span) {
        span.removeChildren();
        ...
        for (const property of __classPrivateFieldGet(this, _ShadowModel_properties, "f")) {
            if (!property.source || property.source !== previousSource) {
                ...
                if (property.source) {
                    span.append(...Renderer.render(property.source, __classPrivateFieldGet(this, _ShadowModel_context, "f")).nodes);
                }
                else if (typeof property.value === 'string') {
                    span.append(property.value);
                }
                else {
                    span.append(...Renderer.render(property.value, property.expansionContext ?? __classPrivateFieldGet(this, _ShadowModel_context, "f")).nodes);
                }
            }
...
_ShadowModel_properties = new WeakMap(), _ShadowModel_shadowType = new WeakMap(), _ShadowModel_context = new WeakMap(), _ShadowModel_instances = new WeakSet(), _ShadowModel_length = function _ShadowModel_length(lengthType) {
    ...
    if (property) {
        ...
        const insertionIdx = 1 +
            __classPrivateFieldGet(this, _ShadowModel_properties, "f").findLastIndex(property => property.propertyType === "y" /* ShadowPropertyType.Y */ ||
...
export class ShadowRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.ShadowMatch) {
    ...
    render(match, context) {
        ...
        for (const shadow of shadows) {
            ...
            if (!model || !__classPrivateFieldGet(this, _ShadowRenderer_treeElement, "f")?.editable()) {
            ...
            const popoverHelper = new ShadowSwatchPopoverHelper(__classPrivateFieldGet(this, _ShadowRenderer_treeElement, "f"), __classPrivateFieldGet(this, _ShadowRenderer_treeElement, "f").parentPane().swatchPopoverHelper(), swatch);
            const treeElement = __classPrivateFieldGet(this, _ShadowRenderer_treeElement, "f");
...
export class LengthRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.LengthMatch) {
    constructor(stylesPane, propertyName, treeElement) {
        super();
        _LengthRenderer_instances.add(this);
        // clang-format on
        _LengthRenderer_stylesPane.set(this, void 0);
        _LengthRenderer_treeElement.set(this, void 0);
        _LengthRenderer_propertyName.set(this, void 0);
        __classPrivateFieldSet(this, _LengthRenderer_stylesPane, stylesPane, "f");
        __classPrivateFieldSet(this, _LengthRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _LengthRenderer_propertyName, propertyName, "f");
    }
    render(match, context) {
        const valueElement = document.createElement('span');
        ...
        if (!context.tracing) {
            void __classPrivateFieldGet(this, _LengthRenderer_instances, "m", _LengthRenderer_attachPopover).call(this, valueElement, match, context);
        }
        const evaluation = context.tracing?.applyEvaluation([], () => {
            return {
                placeholder: [valueElement],
                asyncEvalCallback: () => __classPrivateFieldGet(this, _LengthRenderer_instances, "m", _LengthRenderer_applyEvaluation).call(this, valueElement, match, context)
            };
        });
...
_LengthRenderer_stylesPane = new WeakMap(), _LengthRenderer_treeElement = new WeakMap(), _LengthRenderer_propertyName = new WeakMap(), _LengthRenderer_instances = new WeakSet(), _LengthRenderer_applyEvaluation = async function _LengthRenderer_applyEvaluation(valueElement, match, context) {
    const pixelValue = await resolveValues(__classPrivateFieldGet(this, _LengthRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _LengthRenderer_propertyName, "f"), match, context, match.text);
    if (pixelValue?.[0] && pixelValue?.[0] !== match.text) {
        valueElement.textContent = pixelValue[0];
        return true;
    }
    return false;
}, _LengthRenderer_attachPopover = async function _LengthRenderer_attachPopover(valueElement, match, context) {
    const pixelValue = await resolveValues(__classPrivateFieldGet(this, _LengthRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _LengthRenderer_propertyName, "f"), match, context, match.text);
    if (!pixelValue) {
        return;
    }
    const tooltipId = __classPrivateFieldGet(this, _LengthRenderer_treeElement, "f")?.getTooltipId('length');
    if (tooltipId) {
...
export class MathFunctionRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.MathFunctionMatch) {
    constructor(stylesPane, matchedStyles, computedStyles, propertyName, treeElement) {
        super();
        // clang-format on
        _MathFunctionRenderer_stylesPane.set(this, void 0);
        _MathFunctionRenderer_matchedStyles.set(this, void 0);
        _MathFunctionRenderer_computedStyles.set(this, void 0);
        _MathFunctionRenderer_treeElement.set(this, void 0);
        _MathFunctionRenderer_propertyName.set(this, void 0);
        __classPrivateFieldSet(this, _MathFunctionRenderer_matchedStyles, matchedStyles, "f");
        __classPrivateFieldSet(this, _MathFunctionRenderer_computedStyles, computedStyles, "f");
        __classPrivateFieldSet(this, _MathFunctionRenderer_stylesPane, stylesPane, "f");
        __classPrivateFieldSet(this, _MathFunctionRenderer_treeElement, treeElement, "f");
        __classPrivateFieldSet(this, _MathFunctionRenderer_propertyName, propertyName, "f");
    }
    render(match, context) {
        ...
        const span = document.createElement('span');
        render(html `${__classPrivateFieldGet(this, _MathFunctionRenderer_treeElement, "f")?.getTracingTooltip(match.func, match.node, __classPrivateFieldGet(this, _MathFunctionRenderer_matchedStyles, "f"), __classPrivateFieldGet(this, _MathFunctionRenderer_computedStyles, "f"), context) ??
    ...
    async applyEvaluation(span, match, context) {
        ...
        const evaled = await resolveValues(__classPrivateFieldGet(this, _MathFunctionRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _MathFunctionRenderer_propertyName, "f"), match, context, value);
    ...
    async applyMathFunction(renderedArgs, match, context) {
        ...
        const evaledArgs = await resolveValues(__classPrivateFieldGet(this, _MathFunctionRenderer_stylesPane, "f"), __classPrivateFieldGet(this, _MathFunctionRenderer_propertyName, "f"), match, context, ...values);
        if (!evaledArgs) {
            return;
        }
...
_MathFunctionRenderer_stylesPane = new WeakMap(), _MathFunctionRenderer_matchedStyles = new WeakMap(), _MathFunctionRenderer_computedStyles = new WeakMap(), _MathFunctionRenderer_treeElement = new WeakMap(), _MathFunctionRenderer_propertyName = new WeakMap();
// clang-format off
export class AnchorFunctionRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.AnchorFunctionMatch) {
    ...
    constructor(stylesPane) {
        super();
        // clang-format on
        _AnchorFunctionRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _AnchorFunctionRenderer_stylesPane, stylesPane, "f");
    }
    render(match, context) {
        const content = document.createElement('span');
        if (match.node.name === 'VariableName') {
            // Link an anchor double-dashed ident to its matching anchor element.
            void AnchorFunctionRenderer.decorateAnchorForAnchorLink(__classPrivateFieldGet(this, _AnchorFunctionRenderer_stylesPane, "f"), content, { identifier: match.text });
        }
        else {
            ...
            void AnchorFunctionRenderer.decorateAnchorForAnchorLink(__classPrivateFieldGet(this, _AnchorFunctionRenderer_stylesPane, "f"), swatchContainer, { needsSpace: remainingArgs.length > 1 });
            Renderer.renderInto(remainingArgs, context, content);
        }
        return [content];
    }
}
_AnchorFunctionRenderer_stylesPane = new WeakMap();
// clang-format off
export class PositionAnchorRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.PositionAnchorMatch) {
    // clang-format on
    constructor(stylesPane) {
        super();
        _PositionAnchorRenderer_stylesPane.set(this, void 0);
        __classPrivateFieldSet(this, _PositionAnchorRenderer_stylesPane, stylesPane, "f");
    }
    render(match) {
        const content = document.createElement('span');
        void AnchorFunctionRenderer.decorateAnchorForAnchorLink(__classPrivateFieldGet(this, _PositionAnchorRenderer_stylesPane, "f"), content, { identifier: match.text });
        return [content];
    }
}
_PositionAnchorRenderer_stylesPane = new WeakMap();
// clang-format off
export class PositionTryRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.PositionTryMatch) {
    ...
    constructor(matchedStyles) {
        super();
        _PositionTryRenderer_matchedStyles.set(this, void 0);
        __classPrivateFieldSet(this, _PositionTryRenderer_matchedStyles, matchedStyles, "f");
    }
    render(match, context) {
        const content = [];
        ...
        for (const [i, fallback] of match.fallbacks.entries()) {
            ...
            if (i !== __classPrivateFieldGet(this, _PositionTryRenderer_matchedStyles, "f").activePositionFallbackIndex()) {
...
_PositionTryRenderer_matchedStyles = new WeakMap();
...
export class StylePropertyTreeElement extends UI.TreeOutline.TreeElement {
    constructor({ stylesPane, section, matchedStyles, property, isShorthand, inherited, overloaded, newProperty }) {
        ...
        this.parentsComputedStyles = null;
        _StylePropertyTreeElement_gridNames.set(this, undefined);
        _StylePropertyTreeElement_tooltipKeyCounts.set(this, new Map());
    ...
    async onpopulate() {
        if (!__classPrivateFieldGet(this, _StylePropertyTreeElement_gridNames, "f")) {
            __classPrivateFieldSet(this, _StylePropertyTreeElement_gridNames, await this.gridNames(), "f");
        }
        // Only populate once and if this property is a shorthand.
        if (this.childCount() || !this.isShorthand) {
            return;
        }
        const longhandProperties = await __classPrivateFieldGet(this, _StylePropertyTreeElement_instances, "m", _StylePropertyTreeElement_getLonghandProperties).call(this);
    ...
    refreshIfComputedValueChanged() {
        __classPrivateFieldSet(this, _StylePropertyTreeElement_gridNames, undefined, "f");
    ...
    innerUpdateTitle() {
        __classPrivateFieldGet(this, _StylePropertyTreeElement_tooltipKeyCounts, "f").clear();
        this.updateState();
    ...
    getTooltipId(key) {
        ...
        const tooltipKeyCount = __classPrivateFieldGet(this, _StylePropertyTreeElement_tooltipKeyCounts, "f").get(key) ?? 0;
        __classPrivateFieldGet(this, _StylePropertyTreeElement_tooltipKeyCounts, "f").set(key, tooltipKeyCount + 1);
    ...
    mouseUp(event) {
        ...
        if (UI.KeyboardShortcut.KeyboardShortcut.eventHasCtrlEquivalentKey(event) && __classPrivateFieldGet(this, _StylePropertyTreeElement_parentSection, "f").navigable) {
    ...
    createCopyContextMenu(event) {
        ...
        contextMenu.headerSection().appendItem(i18nString(UIStrings.copyRule), () => {
            const ruleText = StylesSidebarPane.formatLeadingProperties(__classPrivateFieldGet(this, _StylePropertyTreeElement_parentSection, "f")).ruleText;
        ...
        contextMenu.clipboardSection().appendItem(i18nString(UIStrings.copyAllDeclarations), () => {
            const allDeclarationText = StylesSidebarPane.formatLeadingProperties(__classPrivateFieldGet(this, _StylePropertyTreeElement_parentSection, "f")).allDeclarationText;
...
_a = StylePropertyTreeElement, _StylePropertyTreeElement_parentSection = new WeakMap(), _StylePropertyTreeElement_gridNames = new WeakMap(), _StylePropertyTreeElement_tooltipKeyCounts = new WeakMap(), _StylePropertyTreeElement_instances = new WeakSet(), _StylePropertyTreeElement_getLonghandProperties = async function _StylePropertyTreeElement_getLonghandProperties() {
    ...
    const parsedProperty = __classPrivateFieldGet(this, _StylePropertyTreeElement_instances, "m", _StylePropertyTreeElement_computeCSSExpression).call(this, this.style, this.property.value);
    ...
    this.prompt = new CSSPropertyPrompt(this, context.isEditingName, Array.from(__classPrivateFieldGet(this, _StylePropertyTreeElement_gridNames, "f") ?? []));
