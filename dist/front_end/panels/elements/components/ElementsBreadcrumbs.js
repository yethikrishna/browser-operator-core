...
NodeSelectedEvent.eventName = 'breadcrumbsnodeselected';
export class ElementsBreadcrumbs extends HTMLElement {
    ...
    set data(data) {
        ...
        void ComponentHelpers.ScheduledRender.scheduleRender(this, __classPrivateFieldGet(this, _ElementsBreadcrumbs_instances, "m", _ElementsBreadcrumbs_render));
    }
...
_ElementsBreadcrumbs_shadow = new WeakMap(), _ElementsBreadcrumbs_resizeObserver = new WeakMap(), _ElementsBreadcrumbs_crumbsData = new WeakMap(), _ElementsBreadcrumbs_selectedDOMNode = new WeakMap(), _ElementsBreadcrumbs_overflowing = new WeakMap(), _ElementsBreadcrumbs_userScrollPosition = new WeakMap(), _ElementsBreadcrumbs_isObservingResize = new WeakMap(), _ElementsBreadcrumbs_userHasManuallyScrolled = new WeakMap(), _ElementsBreadcrumbs_instances = new WeakSet(), _ElementsBreadcrumbs_onCrumbClick = function _ElementsBreadcrumbs_onCrumbClick(node) {
    return (event) => {
...
async function _ElementsBreadcrumbs_checkForOverflow() {
    ...
    const crumbs = crumbsToRender(__classPrivateFieldGet(this, _ElementsBreadcrumbs_crumbsData, "f"), __classPrivateFieldGet(this, _ElementsBreadcrumbs_selectedDOMNode, "f"));
