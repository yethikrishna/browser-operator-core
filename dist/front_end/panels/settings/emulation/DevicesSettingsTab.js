...
var _DevicesSettingsTab_customDeviceList, _DevicesSettingsTab_defaultDeviceList;
...
export class DevicesSettingsTab extends UI.Widget.VBox {
    constructor() {
        super();
        _DevicesSettingsTab_customDeviceList.set(this, void 0);
        _DevicesSettingsTab_defaultDeviceList.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _DevicesSettingsTab_defaultDeviceList, new UI.ListWidget.ListWidget(this, false /* delegatesFocus */), "f");
        __classPrivateFieldGet(this, _DevicesSettingsTab_defaultDeviceList, "f").registerRequiredCSS(devicesSettingsTabStyles);
        __classPrivateFieldGet(this, _DevicesSettingsTab_defaultDeviceList, "f").element.classList.add('devices-list', 'device-card-content');
        ...
        __classPrivateFieldSet(this, _DevicesSettingsTab_customDeviceList, new UI.ListWidget.ListWidget(this, false /* delegatesFocus */), "f");
        __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").registerRequiredCSS(devicesSettingsTabStyles);
        __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").element.classList.add('devices-list');
        __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").show(deviceList);
        ...
        defaultDevicesCard.append(__classPrivateFieldGet(this, _DevicesSettingsTab_defaultDeviceList, "f").element);
    }
    wasShown() {
        super.wasShown();
        this.devicesUpdated();
    ...
    devicesUpdated() {
        ...
        __classPrivateFieldGet(this, _DevicesSettingsTab_defaultDeviceList, "f").clear();
        __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").clear();
        let devices = this.emulatedDevicesList.custom().slice();
        for (let i = 0; i < devices.length; ++i) {
            __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").appendItem(devices[i], true);
        }
        ...
        for (let i = 0; i < devices.length; ++i) {
            __classPrivateFieldGet(this, _DevicesSettingsTab_defaultDeviceList, "f").appendItem(devices[i], false);
        }
    }
    ...
    addCustomDevice() {
        ...
        __classPrivateFieldGet(this, _DevicesSettingsTab_customDeviceList, "f").addNewItem(this.emulatedDevicesList.custom().length, device);
    }
...
_DevicesSettingsTab_customDeviceList = new WeakMap(), _DevicesSettingsTab_defaultDeviceList = new WeakMap();
