...
import { waitForPageLoad } from './Tools.js';
...
export class HTMLToMarkdownTool {
    constructor() {
        this.name = 'html_to_markdown';
        this.description = 'Extracts the main article content from a webpage and converts it to well-formatted Markdown, removing ads, navigation, and other distracting elements.';
        this.schema = {
            type: 'object',
            properties: {
                instruction: {
...
- Accessibility information is leveraged to enhance the quality of extraction
     ...
     */
    createUserPrompt(content, instruction) {
...
`;
     ...
     */
    async callExtractionLLM(params) {
...
//# sourceMappingURL=HTMLToMarkdownTool.js.map