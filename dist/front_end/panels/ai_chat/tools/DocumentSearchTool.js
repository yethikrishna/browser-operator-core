...
export class DocumentSearchTool {
    constructor() {
        ...
        this.description = 'Searches through previously bookmarked documents using semantic similarity. Finds relevant content based on natural language queries, not just keyword matching.';
        this.schema = {
            type: 'object',
            properties: {
                query: {
    ...
    async execute(args) {
        ...
        try {
            ...
            const searchResult = await vectorClient.searchDocuments(args.query, limit, filter);
     ...
     */
    generateSearchMessage(query, resultCount) {
        if (resultCount === 0) {
...
//# sourceMappingURL=DocumentSearchTool.js.map