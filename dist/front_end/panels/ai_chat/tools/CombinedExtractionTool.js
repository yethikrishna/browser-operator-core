 ...
 */
export class CombinedExtractionTool {
    constructor() {
        this.name = 'navigate_url_and_extraction';
        this.description = 'Navigates to a URL and optionally extracts structured data based on a schema and/or converts the page content to Markdown.';
        this.schema = {
            type: 'object',
            properties: {
                url: {
...
//# sourceMappingURL=CombinedExtractionTool.js.map