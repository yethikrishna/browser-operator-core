...
export class CritiqueTool {
    constructor() {
        this.name = 'critique_tool';
        this.description = 'Evaluates if finalresponse satisfies the user\'s requirements and provides feedback if needed.';
        this.schema = {
            type: 'object',
            properties: {
                userInput: {
    ...
    async execute(args) {
        ...
        try {
            ...
            const evaluationResult = await this.evaluateResponse(userInput, finalResponse, requirementsResult.requirements, apiKey);
     ...
     */
    async extractRequirements(userInput, apiKey) {
...
["Requirement 1", "Requirement 2", ...]`;
     ...
     */
    async evaluateResponse(userInput, finalResponse, requirements, apiKey) {
...
${JSON.stringify(evaluationSchema, null, 2)}`;
     ...
     */
    async generateFeedback(criteria, userInput, finalResponse, apiKey) {
...
//# sourceMappingURL=CritiqueTool.js.map