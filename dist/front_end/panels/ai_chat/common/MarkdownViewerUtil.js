...
export class MarkdownViewerUtil {
     ...
     */
    static async openInAIAssistantViewer(markdownContent) {
        try {
     ...
     */
    static showErrorFallback(errorMessage) {
     ...
     */
    static generateSimpleTextReport(results, title) {
        const lines = [];
        lines.push(`${title}\n${'='.repeat(title.length)}\n`);
...
//# sourceMappingURL=MarkdownViewerUtil.js.map