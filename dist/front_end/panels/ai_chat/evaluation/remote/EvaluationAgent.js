...
export class EvaluationAgent {
    ...
    async handleEvaluationRequest(request) {
        ...
        try {
            ...
            if (params.tool === 'chat') {
                ...
                toolResult = await this.executeChatEvaluation(mergedInput, params.timeout || 300000, // Default 5 minutes for chat
                tracingContext);
            }
            else {
                // Execute regular tool evaluation
                this.sendStatus(params.evaluationId, 'running', 0.5, `Executing ${params.tool}...`);
                toolResult = await this.executeToolWithTimeout(tool, params.input, params.timeout || 30000, tracingContext, params.tool);
            }
    ...
    async executeChatEvaluation(input, timeout, tracingContext) {
        // Validate input
        if (!input.message) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                const finalMessage = tracingContext
