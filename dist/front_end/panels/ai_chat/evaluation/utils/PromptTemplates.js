...
export class PromptTemplates {
     ...
     */
    static buildBaseContext(testCase, output) {
        return `
...
\`\`\``;
     ...
     */
    static buildCriteriaSection(criteria) {
...
${criteria.map((criterion, index) => `${index + 1}. ${criterion}`).join('\n')}`;
     ...
     */
    static buildLLMEvaluationPrompt(testCase, output, criteria) {
        return `
...
Required JSON format:
{
  ...
  "confidence": number (0-100, your confidence in this evaluation)
     ...
     */
    static buildVisionEvaluationPrompt(testCase, output, beforeScreenshot, afterScreenshot) {
...
Respond in this JSON format:
{
  ...
  "visualEvidence": "<description of visual confirmation if screenshots provided>"
     ...
     */
    static buildSystemPrompt(capabilities = {}) {
     ...
     */
    static buildDefaultCriteria(testCase) {
        const criteria = [
     ...
     */
    static extractObjective(testCase) {
