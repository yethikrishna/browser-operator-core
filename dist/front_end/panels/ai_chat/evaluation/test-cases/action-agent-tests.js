...
export const navigationClickTest = {
...
export const ecommerceActionTest = {
...
export const checkboxActionTest = {
...
export const toggleCheckboxTest = {
...
export const dropdownActionTest = {
...
export const multiStepFormTest = {
...
export const dynamicContentTest = {
...
export const accessibilityActionTest = {
...
export const videoControlsTest = {
...
export const videoPlayButtonTest = {
...
export function getBasicActionTests() {
    return [
        basicClickTest,
        formFillTest,
        navigationClickTest
...
export function getActionTestsByType(actionType) {
    return actionAgentTests.filter(test => test.metadata.tags.includes(actionType));
}
//# sourceMappingURL=action-agent-tests.js.map