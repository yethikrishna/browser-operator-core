 ...
 */
export const basicResearchTest = {
 ...
 */
export const currentEventsTest = {
 ...
 */
export const comparativeResearchTest = {
 ...
 */
export const technicalDeepDiveTest = {
 ...
 */
export const businessResearchTest = {
 ...
 */
export const edgeCaseNoResultsTest = {
 ...
 */
export const toolOrchestrationTest = {
 ...
 */
export const researchAgentTests = [
 ...
 */
export function getResearchTestById(id) {
    return researchAgentTests.find(test => test.id === id);
}
/**
 * Get tests by tag
 */
export function getResearchTestsByTag(tag) {
    return researchAgentTests.filter(test => test.metadata.tags.includes(tag));
}
/**
 * Get basic tests for quick validation
 */
export function getBasicResearchTests() {
    return researchAgentTests.filter(test => test.metadata.tags.includes('basic') ||
 ...
 */
export function getComprehensiveResearchTests() {
    return researchAgentTests.filter(test => !test.metadata.tags.includes('edge-case') // Exclude edge cases for standard evaluation
    );
}
//# sourceMappingURL=research-agent-tests.js.map