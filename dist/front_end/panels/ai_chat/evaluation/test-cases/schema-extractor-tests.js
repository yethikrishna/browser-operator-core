 ...
 */
function createSchemaTest(baseConfig, useStreamlined = false) {
    return {
        ...baseConfig,
 ...
 */
export const wikipediaTest = createSchemaTest(wikipediaTestBase, false);
/**
 * Wikipedia test for streamlined tool
 */
export const wikipediaStreamlinedTest = createSchemaTest({
    ...wikipediaTestBase,
 ...
 */
export const simpleStreamlinedTest = createSchemaTest({
 ...
 */
export const schemaExtractorTests = [
 ...
 */
export const allSchemaExtractorTests = [
 ...
 */
export function getComparisonTestPairs() {
    const pairs = [];
...
//# sourceMappingURL=schema-extractor-tests.js.map