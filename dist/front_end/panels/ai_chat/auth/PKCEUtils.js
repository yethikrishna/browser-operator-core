...
export class PKCEUtils {
     ...
     */
    static isValidCodeVerifier(verifier) {
        if (!verifier ||
     ...
     */
    static async verifyChallenge(verifier, challenge) {
        try {
...
PKCEUtils.MIN_VERIFIER_LENGTH = 43;
PKCEUtils.MAX_VERIFIER_LENGTH = 128;
// Characters allowed in code verifier
PKCEUtils.VERIFIER_CHARSET = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~';
