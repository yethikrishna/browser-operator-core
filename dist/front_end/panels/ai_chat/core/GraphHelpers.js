...
export function createSystemPrompt(state) {
...
export async function createSystemPromptAsync(state) {
    const { selectedAgentType } = state;
    // Get base prompt
    const basePrompt = selectedAgentType ?
        BaseOrchestratorAgent.getSystemPrompt(selectedAgentType) :
...
export function getAgentToolsFromState(state) {
...
export function routeNextNode(state) {
