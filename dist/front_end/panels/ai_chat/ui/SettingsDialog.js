...
var _a, _SettingsDialog_openaiMiniModelSelect, _SettingsDialog_openaiNanoModelSelect, _SettingsDialog_litellmMiniModelSelect, _SettingsDialog_litellmNanoModelSelect, _SettingsDialog_groqMiniModelSelect, _SettingsDialog_groqNanoModelSelect, _SettingsDialog_openrouterMiniModelSelect, _SettingsDialog_openrouterNanoModelSelect;
...
export function isVectorDBEnabled() {
    return localStorage.getItem(VECTOR_DB_ENABLED_KEY) === 'true';
}
export class SettingsDialog {
    static async show(selectedModel, miniModel, nanoModel, onSettingsSaved, fetchLiteLLMModels, updateModelOptions, getModelOptions, addCustomModelOption, removeCustomModelOption) {
        ...
        __classPrivateFieldSet(_a, _a, null, "f", _SettingsDialog_openaiMiniModelSelect);
        __classPrivateFieldSet(_a, _a, null, "f", _SettingsDialog_openaiNanoModelSelect);
        __classPrivateFieldSet(_a, _a, null, "f", _SettingsDialog_litellmMiniModelSelect);
        __classPrivateFieldSet(_a, _a, null, "f", _SettingsDialog_litellmNanoModelSelect);
            ...
            if (selectedProvider === 'litellm') {
                ...
                if (groqApiKey) {
                    try {
                        ...
                        const modelOptions = groqModels.map(model => ({
                            value: model.id,
                            label: model.id,
                            type: 'groq'
                        }));
        ...
        function updateOpenAIModelSelectors() {
            ...
            __classPrivateFieldSet(_a, _a, createModelSelector(openaiModelSection, i18nString(UIStrings.miniModelLabel), i18nString(UIStrings.miniModelDescription), 'mini-model-select', openaiModels, validMiniModel, i18nString(UIStrings.defaultMiniOption), undefined // No focus handler for OpenAI
            ), "f", _SettingsDialog_openaiMiniModelSelect);
            logger.debug('Created OpenAI Mini Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiMiniModelSelect));
            // Create OpenAI Nano Model selection and store reference
            __classPrivateFieldSet(_a, _a, createModelSelector(openaiModelSection, i18nString(UIStrings.nanoModelLabel), i18nString(UIStrings.nanoModelDescription), 'nano-model-select', openaiModels, validNanoModel, i18nString(UIStrings.defaultNanoOption), undefined // No focus handler for OpenAI
            ), "f", _SettingsDialog_openaiNanoModelSelect);
            logger.debug('Created OpenAI Nano Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiNanoModelSelect));
        }
        ...
        fetchModelsButton.addEventListener('click', async () => {
            ...
            try {
                ...
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmMiniModelSelect)) {
                    refreshModelSelectOptions(__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmMiniModelSelect), allLiteLLMModels, miniModel);
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmNanoModelSelect)) {
                    refreshModelSelectOptions(__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmNanoModelSelect), allLiteLLMModels, nanoModel);
                }
        ...
        function refreshModelSelectOptions(select, models, currentValue) {
        ...
        function updateLiteLLMModelSelectors() {
            ...
            __classPrivateFieldSet(_a, _a, createModelSelector(litellmModelSection, i18nString(UIStrings.miniModelLabel), i18nString(UIStrings.miniModelDescription), 'litellm-mini-model-select', litellmModels, validMiniModel, i18nString(UIStrings.defaultMiniOption), onLiteLLMSelectorFocus), "f", _SettingsDialog_litellmMiniModelSelect);
            logger.debug('Created LiteLLM Mini Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmMiniModelSelect));
            // Create LiteLLM Nano Model selection and store reference
            __classPrivateFieldSet(_a, _a, createModelSelector(litellmModelSection, i18nString(UIStrings.nanoModelLabel), i18nString(UIStrings.nanoModelDescription), 'litellm-nano-model-select', litellmModels, validNanoModel, i18nString(UIStrings.defaultNanoOption), onLiteLLMSelectorFocus), "f", _SettingsDialog_litellmNanoModelSelect);
            logger.debug('Created LiteLLM Nano Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmNanoModelSelect));
        }
        ...
        function getValidModelForProvider(currentModel, providerModels, provider, modelType) {
        ...
        function updateGroqModelSelectors() {
            ...
            __classPrivateFieldSet(_a, _a, createModelSelector(groqModelSection, i18nString(UIStrings.miniModelLabel), i18nString(UIStrings.miniModelDescription), 'groq-mini-model-select', groqModels, validMiniModel, i18nString(UIStrings.defaultMiniOption), undefined // No focus handler needed for Groq
            ), "f", _SettingsDialog_groqMiniModelSelect);
            logger.debug('Created Groq Mini Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqMiniModelSelect));
            // Create Groq Nano Model selection and store reference
            __classPrivateFieldSet(_a, _a, createModelSelector(groqModelSection, i18nString(UIStrings.nanoModelLabel), i18nString(UIStrings.nanoModelDescription), 'groq-nano-model-select', groqModels, validNanoModel, i18nString(UIStrings.defaultNanoOption), undefined // No focus handler needed for Groq
            ), "f", _SettingsDialog_groqNanoModelSelect);
            logger.debug('Created Groq Nano Model Select:', __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqNanoModelSelect));
        }
        ...
        fetchGroqModelsButton.addEventListener('click', async () => {
            ...
            try {
                ...
                // Refresh existing model selectors with new options if they exist
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqMiniModelSelect)) {
                    refreshModelSelectOptions(__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqMiniModelSelect), allGroqModels, miniModel);
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqNanoModelSelect)) {
                    refreshModelSelectOptions(__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqNanoModelSelect), allGroqModels, nanoModel);
                }
    ...
    `;
        ...
        function updateOpenRouterModelSelectors() {
            ...
            __classPrivateFieldSet(_a, _a, createModelSelector(openrouterModelSection, i18nString(UIStrings.miniModelLabel), i18nString(UIStrings.miniModelDescription), 'openrouter-mini-model-select', openrouterModels, validMiniModel, i18nString(UIStrings.defaultMiniOption), undefined // No focus handler needed for OpenRouter
            ), "f", _SettingsDialog_openrouterMiniModelSelect);
            // Create Nano Model selection for OpenRouter and store reference
            __classPrivateFieldSet(_a, _a, createModelSelector(openrouterModelSection, i18nString(UIStrings.nanoModelLabel), i18nString(UIStrings.nanoModelDescription), 'openrouter-nano-model-select', openrouterModels, validNanoModel, i18nString(UIStrings.defaultNanoOption), undefined // No focus handler needed for OpenRouter
            ), "f", _SettingsDialog_openrouterNanoModelSelect);
        }
    ...
    `;
        ...
        saveButton.addEventListener('click', async () => {
            ...
            if (selectedProvider === 'openai') {
                ...
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiMiniModelSelect)) {
                    miniModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiMiniModelSelect).value;
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiNanoModelSelect)) {
                    nanoModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openaiNanoModelSelect).value;
                }
            }
            else if (selectedProvider === 'litellm') {
                // Get values from LiteLLM selectors
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmMiniModelSelect)) {
                    miniModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmMiniModelSelect).value;
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmNanoModelSelect)) {
                    nanoModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_litellmNanoModelSelect).value;
                }
            }
            else if (selectedProvider === 'groq') {
                // Get values from Groq selectors
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqMiniModelSelect)) {
                    miniModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqMiniModelSelect).value;
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqNanoModelSelect)) {
                    nanoModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_groqNanoModelSelect).value;
                }
            }
            else if (selectedProvider === 'openrouter') {
                // Get values from OpenRouter selectors
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openrouterMiniModelSelect)) {
                    miniModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openrouterMiniModelSelect).value;
                }
                if (__classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openrouterNanoModelSelect)) {
                    nanoModelValue = __classPrivateFieldGet(_a, _a, "f", _SettingsDialog_openrouterNanoModelSelect).value;
                }
            }
        ...
        function toggleAdvancedSections(show) {
...
_SettingsDialog_openaiMiniModelSelect = { value: null };
_SettingsDialog_openaiNanoModelSelect = { value: null };
_SettingsDialog_litellmMiniModelSelect = { value: null };
_SettingsDialog_litellmNanoModelSelect = { value: null };
_SettingsDialog_groqMiniModelSelect = { value: null };
_SettingsDialog_groqNanoModelSelect = { value: null };
_SettingsDialog_openrouterMiniModelSelect = { value: null };
_SettingsDialog_openrouterNanoModelSelect = { value: null };
// Helper function to create a model selector
function createModelSelector(container, labelText, description, selectorType, // renamed from className for clarity
modelOptions, selectedModel, defaultOptionText, onFocus // Optional callback for when the selector is focused
) {
