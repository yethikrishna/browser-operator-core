...
var _WritableProfileHeader_profileReceivedPromise;
...
export class WritableProfileHeader extends ProfileHeader {
    constructor(debuggerModel, type, title) {
        ...
        _WritableProfileHeader_profileReceivedPromise.set(this, Promise.withResolvers());
    ...
    async saveToFile() {
        await __classPrivateFieldGet(this, _WritableProfileHeader_profileReceivedPromise, "f").promise;
    ...
    setProtocolProfile(profile) {
        ...
        __classPrivateFieldGet(this, _WritableProfileHeader_profileReceivedPromise, "f").resolve();
    }
}
_WritableProfileHeader_profileReceivedPromise = new WeakMap();
