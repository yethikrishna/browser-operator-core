...
var _HeapDetachedElementsDataGridNode_instances, _HeapDetachedElementsDataGridNode_getNodeSize, _HeapDetachedElementsDataGridNode_nodeRenderer;
...
export class HeapDetachedElementsDataGridNode extends DataGrid.DataGrid.DataGridNode {
    constructor(detachedElementInfo, domModel) {
        super(null);
        _HeapDetachedElementsDataGridNode_instances.add(this);
        this.retainedNodeIds = new Set();
    ...
    createCell(columnId) {
        ...
        switch (columnId) {
            case 'detached-node': {
                ...
                cell.appendChild(__classPrivateFieldGet(this, _HeapDetachedElementsDataGridNode_instances, "m", _HeapDetachedElementsDataGridNode_nodeRenderer).call(this, DOMNode));
                return cell;
            }
            case 'detached-node-count': {
                const size = __classPrivateFieldGet(this, _HeapDetachedElementsDataGridNode_instances, "m", _HeapDetachedElementsDataGridNode_getNodeSize).call(this, this.detachedElementInfo);
...
_HeapDetachedElementsDataGridNode_instances = new WeakSet(), _HeapDetachedElementsDataGridNode_getNodeSize = function _HeapDetachedElementsDataGridNode_getNodeSize(detachedElementInfo) {
    let count = 1;
    const queue = [];
    let node;
    ...
    return count;
}, _HeapDetachedElementsDataGridNode_nodeRenderer = function _HeapDetachedElementsDataGridNode_nodeRenderer(node) {
