...
var _CookieReportView_instances, _CookieReportView_issuesManager, _CookieReportView_cookieRows, _CookieReportView_view, _CookieReportView_onPrimaryPageChanged, _CookieReportView_onIssueEventReceived, _CookieReportView_onIssueAdded, _CookieReportView_buildFilterItems;
...
export class CookieReportView extends UI.Widget.VBox {
    ...
    `, target, { host: this });
        ...
        _CookieReportView_instances.add(this);
        _CookieReportView_issuesManager.set(this, void 0);
        _CookieReportView_cookieRows.set(this, new Map());
        _CookieReportView_view.set(this, void 0);
        this.filterItems = [];
        __classPrivateFieldSet(this, _CookieReportView_view, view, "f");
        ...
        SDK.TargetManager.TargetManager.instance().addModelListener(SDK.ResourceTreeModel.ResourceTreeModel, SDK.ResourceTreeModel.Events.PrimaryPageChanged, __classPrivateFieldGet(this, _CookieReportView_instances, "m", _CookieReportView_onPrimaryPageChanged), this);
        __classPrivateFieldSet(this, _CookieReportView_issuesManager, IssuesManager.IssuesManager.IssuesManager.instance(), "f");
        __classPrivateFieldGet(this, _CookieReportView_issuesManager, "f").addEventListener("IssueAdded" /* IssuesManager.IssuesManager.Events.ISSUE_ADDED */, __classPrivateFieldGet(this, _CookieReportView_instances, "m", _CookieReportView_onIssueEventReceived), this);
        for (const issue of __classPrivateFieldGet(this, _CookieReportView_issuesManager, "f").issues()) {
            if (issue instanceof IssuesManager.CookieIssue.CookieIssue) {
                __classPrivateFieldGet(this, _CookieReportView_instances, "m", _CookieReportView_onIssueAdded).call(this, issue);
            }
        }
        this.requestUpdate();
    }
    performUpdate() {
        this.filterItems = __classPrivateFieldGet(this, _CookieReportView_instances, "m", _CookieReportView_buildFilterItems).call(this);
        const viewInput = {
            cookieRows: [...__classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").values()].filter(row => {
        ...
        __classPrivateFieldGet(this, _CookieReportView_view, "f").call(this, viewInput, this, this.contentElement);
    }
...
_CookieReportView_issuesManager = new WeakMap(), _CookieReportView_cookieRows = new WeakMap(), _CookieReportView_view = new WeakMap(), _CookieReportView_instances = new WeakSet(), _CookieReportView_onPrimaryPageChanged = function _CookieReportView_onPrimaryPageChanged() {
    __classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").clear();
    this.namedBitSetFilterUI = undefined;
    this.requestUpdate();
}, _CookieReportView_onIssueEventReceived = function _CookieReportView_onIssueEventReceived(event) {
    if (event.data.issue instanceof IssuesManager.CookieIssue.CookieIssue) {
        if (__classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").has(event.data.issue.cookieId())) {
            return;
        }
        __classPrivateFieldGet(this, _CookieReportView_instances, "m", _CookieReportView_onIssueAdded).call(this, event.data.issue);
        this.requestUpdate();
    }
}, _CookieReportView_onIssueAdded = function _CookieReportView_onIssueAdded(issue) {
    const info = issue.makeCookieReportEntry();
    if (info) {
        __classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").set(issue.cookieId(), info);
    }
}, _CookieReportView_buildFilterItems = function _CookieReportView_buildFilterItems() {
    const filterItems = [];
    if (__classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").values().some(n => n.status === 0 /* IssuesManager.CookieIssue.CookieStatus.BLOCKED */)) {
        filterItems.push({
    ...
    if (__classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").values().some(n => n.status === 1 /* IssuesManager.CookieIssue.CookieStatus.ALLOWED */)) {
        filterItems.push({
    ...
    if (__classPrivateFieldGet(this, _CookieReportView_cookieRows, "f").values().some(n => n.status === 2 /* IssuesManager.CookieIssue.CookieStatus.ALLOWED_BY_GRACE_PERIOD */ ||
