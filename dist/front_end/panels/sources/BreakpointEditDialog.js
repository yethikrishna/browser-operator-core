...
export class BreakpointEditDialog extends UI.Widget.Widget {
    constructor(editorLineNumber, oldCondition, isLogpoint, onFinish) {
        ...
        const keymap = [
            { key: 'ArrowUp', run: () => __classPrivateFieldGet(this, _BreakpointEditDialog_editorHistory, "f").moveHistory(-1 /* Direction.BACKWARD */) },
            { key: 'ArrowDown', run: () => __classPrivateFieldGet(this, _BreakpointEditDialog_editorHistory, "f").moveHistory(1 /* Direction.FORWARD */) },
            { mac: 'Ctrl-p', run: () => __classPrivateFieldGet(this, _BreakpointEditDialog_editorHistory, "f").moveHistory(-1 /* Direction.BACKWARD */, true) },
            { mac: 'Ctrl-n', run: () => __classPrivateFieldGet(this, _BreakpointEditDialog_editorHistory, "f").moveHistory(1 /* Direction.FORWARD */, true) },
            {
                key: 'Mod-Enter',
        ...
        __classPrivateFieldSet(this, _BreakpointEditDialog_history, new TextEditor.AutocompleteHistory.AutocompleteHistory(Common.Settings.Settings.instance().createLocalSetting('breakpoint-condition-history', [])), "f");
        __classPrivateFieldSet(this, _BreakpointEditDialog_editorHistory, new TextEditor.TextEditorHistory.TextEditorHistory(this.editor, __classPrivateFieldGet(this, _BreakpointEditDialog_history, "f")), "f");
