...
export class ScopeChainSidebarPane extends UI.Widget.VBox {
    ...
    flavorChanged(callFrame) {
        ...
        if (callFrame) {
            ...
            __classPrivateFieldSet(this, _ScopeChainSidebarPane_scopeChainModel, new SourceMapScopes.ScopeChainModel.ScopeChainModel(callFrame), "f");
            __classPrivateFieldGet(this, _ScopeChainSidebarPane_scopeChainModel, "f").addEventListener("ScopeChainUpdated" /* SourceMapScopes.ScopeChainModel.Events.SCOPE_CHAIN_UPDATED */, event => this.buildScopeTreeOutline(event.data), this);
        }
        else {
