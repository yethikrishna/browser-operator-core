...
var _SourcesView_instances, _SourcesView_scriptViewToolbar, _SourcesView_onScopeChange, _SourcesView_sourceViewTypeForWidget, _SourcesView_sourceViewTypeForUISourceCode, _SourcesView_uiSourceCodeTitleChanged;
...
export class SourcesView extends Common.ObjectWrapper.eventMixin(UI.Widget.VBox) {
    constructor() {
        ...
        _SourcesView_scriptViewToolbar.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _SourcesView_scriptViewToolbar, toolbarContainerElementInternal.createChild('devtools-toolbar'), "f");
        __classPrivateFieldGet(this, _SourcesView_scriptViewToolbar, "f").style.flex = 'auto';
        ...
        SDK.TargetManager.TargetManager.instance().addScopeChangeListener(__classPrivateFieldGet(this, _SourcesView_instances, "m", _SourcesView_onScopeChange).bind(this));
    ...
    scriptViewToolbar() {
        return __classPrivateFieldGet(this, _SourcesView_scriptViewToolbar, "f");
    }
    wasShown() {
        super.wasShown();
    ...
    updateScriptViewToolbarItems() {
        ...
        if (view instanceof UI.View.SimpleView) {
            void view.toolbarItems().then(items => {
                __classPrivateFieldGet(this, _SourcesView_scriptViewToolbar, "f").removeToolbarItems();
                for (const action of getRegisteredEditorActions()) {
                    __classPrivateFieldGet(this, _SourcesView_scriptViewToolbar, "f").appendToolbarItem(action.getOrCreateButton(this));
                }
                items.map(item => __classPrivateFieldGet(this, _SourcesView_scriptViewToolbar, "f").appendToolbarItem(item));
            });
        }
    }
    ...
    createSourceView(uiSourceCode) {
        ...
        uiSourceCode.addEventListener(Workspace.UISourceCode.Events.TitleChanged, __classPrivateFieldGet(this, _SourcesView_instances, "m", _SourcesView_uiSourceCodeTitleChanged), this);
    ...
    recycleUISourceCodeFrame(sourceFrame, uiSourceCode) {
        sourceFrame.uiSourceCode().removeEventListener(Workspace.UISourceCode.Events.TitleChanged, __classPrivateFieldGet(this, _SourcesView_instances, "m", _SourcesView_uiSourceCodeTitleChanged), this);
    ...
    removeSourceFrame(uiSourceCode) {
        ...
        uiSourceCode.removeEventListener(Workspace.UISourceCode.Events.TitleChanged, __classPrivateFieldGet(this, _SourcesView_instances, "m", _SourcesView_uiSourceCodeTitleChanged), this);
    }
    editorClosed(event) {
        const uiSourceCode = event.data;
...
_SourcesView_scriptViewToolbar = new WeakMap(), _SourcesView_instances = new WeakSet(), _SourcesView_onScopeChange = function _SourcesView_onScopeChange() {
    const workspace = Workspace.Workspace.WorkspaceImpl.instance();
