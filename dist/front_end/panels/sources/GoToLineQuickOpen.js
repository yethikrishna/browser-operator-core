...
export class GoToLineQuickOpen extends QuickOpen.FilteredListWidget.Provider {
    ...
    renderItem(itemIndex, _query, titleElement, _subtitleElement) {
        ...
        UI.UIUtils.createTextChild(titleElement, __classPrivateFieldGet(this, _GoToLineQuickOpen_goToLineStrings, "f")[itemIndex]);
    }
    rewriteQuery(_query) {
    ...
    queryChanged(query) {
        ...
        if (!position) {
            ...
            __classPrivateFieldGet(this, _GoToLineQuickOpen_goToLineStrings, "f").push(i18nString(UIStrings.currentLineSTypeALineNumber, { PH1: linesCount }));
            return;
        }
