...
var _ConsolePrompt_instances, _ConsolePrompt_argumentHintsState, _ConsolePrompt_editorHistory, _ConsolePrompt_selfXssWarningShown, _ConsolePrompt_javaScriptCompletionCompartment, _ConsolePrompt_getJavaScriptCompletionExtensions, _ConsolePrompt_updateJavaScriptCompletionCompartment;
...
export class ConsolePrompt extends Common.ObjectWrapper.eventMixin(UI.Widget.Widget) {
    constructor() {
        super();
        _ConsolePrompt_instances.add(this);
        this.requestPreviewCurrent = 0;
        ...
        _ConsolePrompt_argumentHintsState.set(this, void 0);
        _ConsolePrompt_editorHistory.set(this, void 0);
        _ConsolePrompt_selfXssWarningShown.set(this, false);
        _ConsolePrompt_javaScriptCompletionCompartment.set(this, new CodeMirror.Compartment());
        ...
        __classPrivateFieldSet(this, _ConsolePrompt_argumentHintsState, argumentHints[0], "f");
        ...
        const extensions = [
            ...
            CodeMirror.javascript.javascriptLanguage.data.of({
                autocomplete: (context) => this.addCompletionsFromHistory ? __classPrivateFieldGet(this, _ConsolePrompt_editorHistory, "f").historyCompletions(context) : null,
            }),
            ...
            __classPrivateFieldGet(this, _ConsolePrompt_javaScriptCompletionCompartment, "f").of(__classPrivateFieldGet(this, _ConsolePrompt_instances, "m", _ConsolePrompt_getJavaScriptCompletionExtensions).call(this)),
        ];
        ...
        __classPrivateFieldSet(this, _ConsolePrompt_editorHistory, new TextEditor.TextEditorHistory.TextEditorHistory(this.editor, this.historyInternal), "f");
        if (this.hasFocus()) {
            this.focus();
        }
    ...
    editorKeymap() {
        return [
            { key: 'ArrowUp', run: () => __classPrivateFieldGet(this, _ConsolePrompt_editorHistory, "f").moveHistory(-1 /* Direction.BACKWARD */) },
            { key: 'ArrowDown', run: () => __classPrivateFieldGet(this, _ConsolePrompt_editorHistory, "f").moveHistory(1 /* Direction.FORWARD */) },
            { mac: 'Ctrl-p', run: () => __classPrivateFieldGet(this, _ConsolePrompt_editorHistory, "f").moveHistory(-1 /* Direction.BACKWARD */, true) },
            { mac: 'Ctrl-n', run: () => __classPrivateFieldGet(this, _ConsolePrompt_editorHistory, "f").moveHistory(1 /* Direction.FORWARD */, true) },
            {
                key: 'Escape',
                run: () => {
                    return TextEditor.JavaScript.closeArgumentsHintsTooltip(this.editor.editor, __classPrivateFieldGet(this, _ConsolePrompt_argumentHintsState, "f"));
                },
            },
            {
                key: 'Ctrl-Enter',
    ...
    showSelfXssWarning() {
        ...
        __classPrivateFieldSet(this, _ConsolePrompt_selfXssWarningShown, true, "f");
        Host.userMetrics.actionTaken(Host.UserMetrics.Action.SelfXssWarningConsoleMessageShown);
        __classPrivateFieldGet(this, _ConsolePrompt_instances, "m", _ConsolePrompt_updateJavaScriptCompletionCompartment).call(this);
    }
    async handleEnter(forceEvaluate) {
        if (__classPrivateFieldGet(this, _ConsolePrompt_selfXssWarningShown, "f") && this.text() === i18nString(UIStrings.allowPasting)) {
            ...
            Common.Settings.Settings.instance()
                ...
                .set(true);
            __classPrivateFieldSet(this, _ConsolePrompt_selfXssWarningShown, false, "f");
        ...
        if (await this.enterWillEvaluate(forceEvaluate)) {
            ...
            TextEditor.JavaScript.closeArgumentsHintsTooltip(this.editor.editor, __classPrivateFieldGet(this, _ConsolePrompt_argumentHintsState, "f"));
            this.editor.dispatch({
                changes: { from: 0, to: this.editor.state.doc.length },
                scrollIntoView: true,
            });
...
_ConsolePrompt_argumentHintsState = new WeakMap(), _ConsolePrompt_editorHistory = new WeakMap(), _ConsolePrompt_selfXssWarningShown = new WeakMap(), _ConsolePrompt_javaScriptCompletionCompartment = new WeakMap(), _ConsolePrompt_instances = new WeakSet(), _ConsolePrompt_getJavaScriptCompletionExtensions = function _ConsolePrompt_getJavaScriptCompletionExtensions() {
    if (__classPrivateFieldGet(this, _ConsolePrompt_selfXssWarningShown, "f")) {
...
}, _ConsolePrompt_updateJavaScriptCompletionCompartment = function _ConsolePrompt_updateJavaScriptCompletionCompartment() {
    const extensions = __classPrivateFieldGet(this, _ConsolePrompt_instances, "m", _ConsolePrompt_getJavaScriptCompletionExtensions).call(this);
    const effects = __classPrivateFieldGet(this, _ConsolePrompt_javaScriptCompletionCompartment, "f").reconfigure(extensions);
