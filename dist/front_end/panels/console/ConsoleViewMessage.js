...
var _ConsoleViewMessage_instances, _a, _ConsoleViewMessage_adjacentUserCommandResult, _ConsoleViewMessage_formatErrorStackPromiseForTest, _ConsoleViewMessage_appendCookieReportButtonToElem, _ConsoleViewMessage_getLinkifierMetric, _ConsoleViewMessage_getExplainAriaLabel, _ConsoleViewMessage_createHoverButton;
...
export class ConsoleViewMessage {
    constructor(consoleMessage, linkifier, requestResolver, issueResolver, onResize) {
        _ConsoleViewMessage_instances.add(this);
        // The element that wraps console message elements in a row.
        this.consoleRowWrapper = null;
        _ConsoleViewMessage_adjacentUserCommandResult.set(this, false);
        /** Formatting Error#stack is asynchronous. Allow tests to wait for the result */
        _ConsoleViewMessage_formatErrorStackPromiseForTest.set(this, Promise.resolve());
    ...
    formatErrorStackPromiseForTest() {
        return __classPrivateFieldGet(this, _ConsoleViewMessage_formatErrorStackPromiseForTest, "f");
    }
    buildMessage() {
        let messageElement;
    ...
    buildMessageAnchor() {
        ...
        const linkify = ({ stackFrameWithBreakpoint, scriptId, stackTrace, url, line, column }) => {
            const userMetric = __classPrivateFieldGet(this, _ConsoleViewMessage_instances, "m", _ConsoleViewMessage_getLinkifierMetric).call(this);
        ...
        if (this.message.isCookieReportIssue && Root.Runtime.hostConfig.devToolsPrivacyUI?.enabled) {
            ...
            __classPrivateFieldGet(this, _ConsoleViewMessage_instances, "m", _ConsoleViewMessage_appendCookieReportButtonToElem).call(this, anchorWrapperElement);
    ...
    formatParameterAsError(output) {
        ...
        __classPrivateFieldSet(this, _ConsoleViewMessage_formatErrorStackPromiseForTest, formatErrorStack(output, /* includeCausedByPrefix */ false), "f");
        return result;
    }
    ...
    toMessageElement() {
        ...
        this.elementInternal.classList.toggle('console-adjacent-user-command-result', __classPrivateFieldGet(this, _ConsoleViewMessage_adjacentUserCommandResult, "f"));
        return this.elementInternal;
    }
    updateMessageElement() {
        ...
        if (UI.ActionRegistry.ActionRegistry.instance().hasAction(EXPLAIN_HOVER_ACTION_ID) && this.shouldShowInsights()) {
            ...
            this.consoleRowWrapper.append(__classPrivateFieldGet(this, _ConsoleViewMessage_instances, "m", _ConsoleViewMessage_createHoverButton).call(this));
        }
    ...
    setAdjacentUserCommandResult(adjacentUserCommandResult) {
        __classPrivateFieldSet(this, _ConsoleViewMessage_adjacentUserCommandResult, adjacentUserCommandResult, "f");
        this.elementInternal?.classList.toggle('console-adjacent-user-command-result', __classPrivateFieldGet(this, _ConsoleViewMessage_adjacentUserCommandResult, "f"));
    }
    repeatCount() {
...
_a = ConsoleViewMessage, _ConsoleViewMessage_adjacentUserCommandResult = new WeakMap(), _ConsoleViewMessage_formatErrorStackPromiseForTest = new WeakMap(), _ConsoleViewMessage_instances = new WeakSet(), _ConsoleViewMessage_appendCookieReportButtonToElem = function _ConsoleViewMessage_appendCookieReportButtonToElem(elem) {
...
}, _ConsoleViewMessage_getLinkifierMetric = function _ConsoleViewMessage_getLinkifierMetric() {
    const request = Logs.NetworkLog.NetworkLog.requestForConsoleMessage(this.message);
    if (request?.resourceType().isStyleSheet()) {
        return Host.UserMetrics.Action.StyleSheetInitiatorLinkClicked;
    }
    return undefined;
}, _ConsoleViewMessage_getExplainAriaLabel = function _ConsoleViewMessage_getExplainAriaLabel() {
    if (this.message.level === "error" /* Protocol.Log.LogEntryLevel.Error */) {
...
}, _ConsoleViewMessage_createHoverButton = function _ConsoleViewMessage_createHoverButton() {
    ...
    button.ariaLabel = __classPrivateFieldGet(this, _ConsoleViewMessage_instances, "m", _ConsoleViewMessage_getExplainAriaLabel).call(this);
    button.tabIndex = 0;
