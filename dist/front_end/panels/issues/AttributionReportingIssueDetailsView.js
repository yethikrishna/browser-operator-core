...
export class AttributionReportingIssueDetailsView extends AffectedResourcesView {
    ...
    update() {
        ...
        if (issue.done) {
            ...
            __classPrivateFieldGet(this, _AttributionReportingIssueDetailsView_instances, "m", _AttributionReportingIssueDetailsView_appendDetails).call(this, issue.value.code(), issues);
        }
    }
}
